...
public partial class V1alpha2ClusterPolicyReportList : IKubernetesObject<V1ListMeta>, IItems<V1alpha2ClusterPolicyReport>
{
    ...
    public const string KubeKind = "ClusterPolicyReportList";
    public const string KubeGroup = "wgpolicyk8s.io";
    public const string KubePluralName = "clusterpolicyreports";
    ...
    public string Kind { get; set; } = "ClusterPolicyReportList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha2ClusterPolicyReport objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha2ClusterPolicyReport> Items { get; set; }
}
...
public partial class V1alpha2ClusterPolicyReportResultsResourceSelector
{
    ...
    public IList<V1alpha2ClusterPolicyReportResultsResourceSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V1alpha2ClusterPolicyReportResults
{
    ...
    public V1alpha2ClusterPolicyReportResultsResourceSelector? ResourceSelector { get; set; }

    /// <summary>Subjects is an optional reference to the checked Kubernetes resources</summary>
    [JsonPropertyName("resources")]
    public IList<V1alpha2ClusterPolicyReportResultsResources>? Resources { get; set; }

    /// <summary>Result indicates the outcome of the policy rule execution</summary>
    [JsonPropertyName("result")]
    public V1alpha2ClusterPolicyReportResultsResultEnum? Result { get; set; }
    ...
    public V1alpha2ClusterPolicyReportResultsSeverityEnum? Severity { get; set; }
    ...
    public V1alpha2ClusterPolicyReportResultsTimestamp? Timestamp { get; set; }
}
...
public partial class V1alpha2ClusterPolicyReportScopeSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V1alpha2ClusterPolicyReportScopeSelectorMatchExpressions>? MatchExpressions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha2";
    public const string KubeKind = "ClusterPolicyReport";
    public const string KubeGroup = "wgpolicyk8s.io";
    public const string KubePluralName = "clusterpolicyreports";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ClusterPolicyReport";
    ...
    public IList<V1alpha2ClusterPolicyReportResults>? Results { get; set; }

    /// <summary>Scope is an optional reference to the report scope (e.g. a Deployment, Namespace, or Node)</summary>
    [JsonPropertyName("scope")]
    public V1alpha2ClusterPolicyReportScope? Scope { get; set; }
    ...
    public V1alpha2ClusterPolicyReportScopeSelector? ScopeSelector { get; set; }

    /// <summary>PolicyReportSummary provides a summary of results</summary>
    [JsonPropertyName("summary")]
    public V1alpha2ClusterPolicyReportSummary? Summary { get; set; }
}