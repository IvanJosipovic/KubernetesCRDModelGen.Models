...
public partial class V1ClusterEphemeralReportList : IKubernetesObject<V1ListMeta>, IItems<V1ClusterEphemeralReport>
{
    ...
    public const string KubeKind = "ClusterEphemeralReportList";
    public const string KubeGroup = "reports.kyverno.io";
    public const string KubePluralName = "clusterephemeralreports";
    ...
    public string Kind { get; set; } = "ClusterEphemeralReportList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1ClusterEphemeralReport objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1ClusterEphemeralReport> Items { get; set; }
}
...
public partial class V1ClusterEphemeralReportSpecResultsResourceSelector
{
    ...
    public IList<V1ClusterEphemeralReportSpecResultsResourceSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V1ClusterEphemeralReportSpecResults
{
    ...
    public V1ClusterEphemeralReportSpecResultsResourceSelector? ResourceSelector { get; set; }

    /// <summary>Subjects is an optional reference to the checked Kubernetes resources</summary>
    [JsonPropertyName("resources")]
    public IList<V1ClusterEphemeralReportSpecResultsResources>? Resources { get; set; }

    /// <summary>Result indicates the outcome of the policy rule execution</summary>
    [JsonPropertyName("result")]
    public V1ClusterEphemeralReportSpecResultsResultEnum? Result { get; set; }
    ...
    public V1ClusterEphemeralReportSpecResultsSeverityEnum? Severity { get; set; }
    ...
    public V1ClusterEphemeralReportSpecResultsTimestamp? Timestamp { get; set; }
}
...
public partial class V1ClusterEphemeralReportSpec
{
    ...
    public required V1ClusterEphemeralReportSpecOwner Owner { get; set; }

    /// <summary>PolicyReportResult provides result details</summary>
    [JsonPropertyName("results")]
    public IList<V1ClusterEphemeralReportSpecResults>? Results { get; set; }

    /// <summary>PolicyReportSummary provides a summary of results</summary>
    [JsonPropertyName("summary")]
    public V1ClusterEphemeralReportSpecSummary? Summary { get; set; }
}
...
{
    public const string KubeApiVersion = "v1";
    public const string KubeKind = "ClusterEphemeralReport";
    public const string KubeGroup = "reports.kyverno.io";
    public const string KubePluralName = "clusterephemeralreports";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ClusterEphemeralReport";
    ...
    public required V1ClusterEphemeralReportSpec Spec { get; set; }
}