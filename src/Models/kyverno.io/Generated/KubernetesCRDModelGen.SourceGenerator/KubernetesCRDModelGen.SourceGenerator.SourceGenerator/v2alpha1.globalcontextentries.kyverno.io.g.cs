...
public partial class V2alpha1GlobalContextEntryList : IKubernetesObject<V1ListMeta>, IItems<V2alpha1GlobalContextEntry>
{
    ...
    public string ApiVersion { get; set; } = "kyverno.io/v2alpha1";
    ...
    /// <summary>List of V2alpha1GlobalContextEntry objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V2alpha1GlobalContextEntry> Items { get; set; }
}
...
public partial class V2alpha1GlobalContextEntrySpecApiCallService
{
    ...
    public IList<V2alpha1GlobalContextEntrySpecApiCallServiceHeaders>? Headers { get; set; }
...
public partial class V2alpha1GlobalContextEntrySpecApiCall
{
    ...
    public IList<V2alpha1GlobalContextEntrySpecApiCallData>? Data { get; set; }

    /// <summary>Method is the HTTP request type (GET or POST). Defaults to GET.</summary>
    [JsonPropertyName("method")]
    public V2alpha1GlobalContextEntrySpecApiCallMethodEnum? Method { get; set; }
    ...
    public V2alpha1GlobalContextEntrySpecApiCallService? Service { get; set; }
...
public partial class V2alpha1GlobalContextEntrySpec
{
    ...
    public V2alpha1GlobalContextEntrySpecApiCall? ApiCall { get; set; }
    ...
    public V2alpha1GlobalContextEntrySpecKubernetesResource? KubernetesResource { get; set; }
    ...
    public IList<V2alpha1GlobalContextEntrySpecProjections>? Projections { get; set; }
}
...
public partial class V2alpha1GlobalContextEntryStatusConditions
{
    ...
    public required V2alpha1GlobalContextEntryStatusConditionsStatusEnum Status { get; set; }
...
public partial class V2alpha1GlobalContextEntryStatus
{
    ...
    public IList<V2alpha1GlobalContextEntryStatusConditions>? Conditions { get; set; }
...
public partial class V2alpha1GlobalContextEntry : IKubernetesObject<V1ObjectMeta>, ISpec<V2alpha1GlobalContextEntrySpec>, IStatus<V2alpha1GlobalContextEntryStatus?>
{
    ...
    public required V2alpha1GlobalContextEntrySpec Spec { get; set; }

    /// <summary>Status contains globalcontextentry runtime data.</summary>
    [JsonPropertyName("status")]
    public V2alpha1GlobalContextEntryStatus? Status { get; set; }
}