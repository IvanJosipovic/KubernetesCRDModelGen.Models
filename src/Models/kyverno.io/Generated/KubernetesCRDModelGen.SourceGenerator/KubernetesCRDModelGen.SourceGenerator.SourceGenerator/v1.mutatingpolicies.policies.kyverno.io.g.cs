...
public partial class V1MutatingPolicyList : IKubernetesObject<V1ListMeta>, IItems<V1MutatingPolicy>
{
    ...
    /// <summary>List of V1MutatingPolicy objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1MutatingPolicy> Items { get; set; }
}

/// <summary>AuditAnnotation describes how to produce an audit annotation for an API request.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1MutatingPolicySpecAuditAnnotations
{
    /// <summary>
...
public partial class V1MutatingPolicySpecAutogen
{
    ...
    public V1MutatingPolicySpecAutogenMutatingAdmissionPolicy? MutatingAdmissionPolicy { get; set; }

    /// <summary>PodControllers specifies whether to generate a pod controllers rules.</summary>
    [JsonPropertyName("podControllers")]
    public V1MutatingPolicySpecAutogenPodControllers? PodControllers { get; set; }
}
...
public partial class V1MutatingPolicySpecEvaluation
{
    ...
    public V1MutatingPolicySpecEvaluationAdmission? Admission { get; set; }

    /// <summary>Background controls policy evaluation during background scan.</summary>
    [JsonPropertyName("background")]
    public V1MutatingPolicySpecEvaluationBackground? Background { get; set; }
    ...
    public V1MutatingPolicySpecEvaluationMutateExisting? MutateExisting { get; set; }
...
public partial class V1MutatingPolicySpecMatchConstraintsNamespaceSelector
{
    ...
    public IList<V1MutatingPolicySpecMatchConstraintsNamespaceSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V1MutatingPolicySpecMatchConstraintsObjectSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V1MutatingPolicySpecMatchConstraintsObjectSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V1MutatingPolicySpecMatchConstraints
{
    ...
    public IList<V1MutatingPolicySpecMatchConstraintsExcludeResourceRules>? ExcludeResourceRules { get; set; }
    ...
    public V1MutatingPolicySpecMatchConstraintsNamespaceSelector? NamespaceSelector { get; set; }
    ...
    public V1MutatingPolicySpecMatchConstraintsObjectSelector? ObjectSelector { get; set; }
    ...
    public IList<V1MutatingPolicySpecMatchConstraintsResourceRules>? ResourceRules { get; set; }
}
...
public partial class V1MutatingPolicySpecMutations
{
    ...
    public V1MutatingPolicySpecMutationsApplyConfiguration? ApplyConfiguration { get; set; }
    ...
    public V1MutatingPolicySpecMutationsJsonPatch? JsonPatch { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1MutatingPolicySpecTargetMatchConditions
{
    /// <summary>
    /// Expression represents the expression which will be evaluated by CEL. Must evaluate to bool.
    /// CEL expressions have access to the contents of the AdmissionRequest and Authorizer, organized into CEL variables:
...
public partial class V1MutatingPolicySpecTargetMatchConstraintsNamespaceSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V1MutatingPolicySpecTargetMatchConstraintsNamespaceSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V1MutatingPolicySpecTargetMatchConstraintsObjectSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V1MutatingPolicySpecTargetMatchConstraintsObjectSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V1MutatingPolicySpecTargetMatchConstraints
{
    ...
    /// </summary>
    [JsonPropertyName("excludeResourceRules")]
    public IList<V1MutatingPolicySpecTargetMatchConstraintsExcludeResourceRules>? ExcludeResourceRules { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("namespaceSelector")]
    public V1MutatingPolicySpecTargetMatchConstraintsNamespaceSelector? NamespaceSelector { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("objectSelector")]
    public V1MutatingPolicySpecTargetMatchConstraintsObjectSelector? ObjectSelector { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resourceRules")]
    public IList<V1MutatingPolicySpecTargetMatchConstraintsResourceRules>? ResourceRules { get; set; }
}
...
public partial class V1MutatingPolicySpec
{
    ...
    public IList<V1MutatingPolicySpecAuditAnnotations>? AuditAnnotations { get; set; }

    /// <summary>AutogenConfiguration defines the configuration for the generation controller.</summary>
    [JsonPropertyName("autogen")]
    public V1MutatingPolicySpecAutogen? Autogen { get; set; }

    /// <summary>EvaluationConfiguration defines the configuration for mutating policy evaluation.</summary>
    [JsonPropertyName("evaluation")]
    public V1MutatingPolicySpecEvaluation? Evaluation { get; set; }
    ...
    public V1MutatingPolicySpecFailurePolicyEnum? FailurePolicy { get; set; }
    ...
    public IList<V1MutatingPolicySpecMatchConditions>? MatchConditions { get; set; }
    ...
    public V1MutatingPolicySpecMatchConstraints? MatchConstraints { get; set; }
    ...
    public IList<V1MutatingPolicySpecMutations>? Mutations { get; set; }
    ...
    public IList<V1MutatingPolicySpecTargetMatchConditions>? TargetMatchConditions { get; set; }

    /// <summary>TargetMatchConstraints resolves the resources to mutate after Variables are evaluated.</summary>
    [JsonPropertyName("targetMatchConstraints")]
    public V1MutatingPolicySpecTargetMatchConstraints? TargetMatchConstraints { get; set; }
    ...
    public IList<V1MutatingPolicySpecVariables>? Variables { get; set; }

    /// <summary>WebhookConfiguration defines the configuration for the webhook.</summary>
    [JsonPropertyName("webhookConfiguration")]
    public V1MutatingPolicySpecWebhookConfiguration? WebhookConfiguration { get; set; }
}

/// <summary>AuditAnnotation describes how to produce an audit annotation for an API request.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1MutatingPolicyStatusAutogenConfigsSpecAuditAnnotations
{
    /// <summary>
    /// key specifies the audit annotation key. The audit annotation keys of
    /// a ValidatingAdmissionPolicy must be unique. The key must be a qualified
...
public partial class V1MutatingPolicyStatusAutogenConfigsSpecAutogen
{
    /// <summary>MutatingAdmissionPolicy specifies whether to generate a Kubernetes MutatingAdmissionPolicy.</summary>
    [JsonPropertyName("mutatingAdmissionPolicy")]
    public V1MutatingPolicyStatusAutogenConfigsSpecAutogenMutatingAdmissionPolicy? MutatingAdmissionPolicy { get; set; }

    /// <summary>PodControllers specifies whether to generate a pod controllers rules.</summary>
    [JsonPropertyName("podControllers")]
    public V1MutatingPolicyStatusAutogenConfigsSpecAutogenPodControllers? PodControllers { get; set; }
}
...
public partial class V1MutatingPolicyStatusAutogenConfigsSpecEvaluation
{
    /// <summary>Admission controls policy evaluation during admission.</summary>
    [JsonPropertyName("admission")]
    public V1MutatingPolicyStatusAutogenConfigsSpecEvaluationAdmission? Admission { get; set; }

    /// <summary>Background controls policy evaluation during background scan.</summary>
    [JsonPropertyName("background")]
    public V1MutatingPolicyStatusAutogenConfigsSpecEvaluationBackground? Background { get; set; }
    ...
    /// <summary>MutateExisting controls whether existing resources are mutated.</summary>
    [JsonPropertyName("mutateExisting")]
    public V1MutatingPolicyStatusAutogenConfigsSpecEvaluationMutateExisting? MutateExisting { get; set; }
...
public partial class V1MutatingPolicyStatusAutogenConfigsSpecMatchConstraintsNamespaceSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecMatchConstraintsNamespaceSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V1MutatingPolicyStatusAutogenConfigsSpecMatchConstraintsObjectSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecMatchConstraintsObjectSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V1MutatingPolicyStatusAutogenConfigsSpecMatchConstraints
{
    ...
    /// </summary>
    [JsonPropertyName("excludeResourceRules")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecMatchConstraintsExcludeResourceRules>? ExcludeResourceRules { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("namespaceSelector")]
    public V1MutatingPolicyStatusAutogenConfigsSpecMatchConstraintsNamespaceSelector? NamespaceSelector { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("objectSelector")]
    public V1MutatingPolicyStatusAutogenConfigsSpecMatchConstraintsObjectSelector? ObjectSelector { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resourceRules")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecMatchConstraintsResourceRules>? ResourceRules { get; set; }
}
...
public partial class V1MutatingPolicyStatusAutogenConfigsSpecMutations
{
    ...
    /// </summary>
    [JsonPropertyName("applyConfiguration")]
    public V1MutatingPolicyStatusAutogenConfigsSpecMutationsApplyConfiguration? ApplyConfiguration { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("jsonPatch")]
    public V1MutatingPolicyStatusAutogenConfigsSpecMutationsJsonPatch? JsonPatch { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConditions
{
    /// <summary>
    /// Expression represents the expression which will be evaluated by CEL. Must evaluate to bool.
    /// CEL expressions have access to the contents of the AdmissionRequest and Authorizer, organized into CEL variables:
...
public partial class V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConstraintsNamespaceSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConstraintsNamespaceSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConstraintsObjectSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConstraintsObjectSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConstraints
{
    ...
    /// </summary>
    [JsonPropertyName("excludeResourceRules")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConstraintsExcludeResourceRules>? ExcludeResourceRules { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("namespaceSelector")]
    public V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConstraintsNamespaceSelector? NamespaceSelector { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("objectSelector")]
    public V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConstraintsObjectSelector? ObjectSelector { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resourceRules")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConstraintsResourceRules>? ResourceRules { get; set; }
}
...
public partial class V1MutatingPolicyStatusAutogenConfigsSpec
{
    ...
    /// </summary>
    [JsonPropertyName("auditAnnotations")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecAuditAnnotations>? AuditAnnotations { get; set; }

    /// <summary>AutogenConfiguration defines the configuration for the generation controller.</summary>
    [JsonPropertyName("autogen")]
    public V1MutatingPolicyStatusAutogenConfigsSpecAutogen? Autogen { get; set; }

    /// <summary>EvaluationConfiguration defines the configuration for mutating policy evaluation.</summary>
    [JsonPropertyName("evaluation")]
    public V1MutatingPolicyStatusAutogenConfigsSpecEvaluation? Evaluation { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("failurePolicy")]
    public V1MutatingPolicyStatusAutogenConfigsSpecFailurePolicyEnum? FailurePolicy { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("matchConditions")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecMatchConditions>? MatchConditions { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("matchConstraints")]
    public V1MutatingPolicyStatusAutogenConfigsSpecMatchConstraints? MatchConstraints { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("mutations")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecMutations>? Mutations { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("targetMatchConditions")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConditions>? TargetMatchConditions { get; set; }

    /// <summary>TargetMatchConstraints resolves the resources to mutate after Variables are evaluated.</summary>
    [JsonPropertyName("targetMatchConstraints")]
    public V1MutatingPolicyStatusAutogenConfigsSpecTargetMatchConstraints? TargetMatchConstraints { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("variables")]
    public IList<V1MutatingPolicyStatusAutogenConfigsSpecVariables>? Variables { get; set; }
...
public partial class V1MutatingPolicyStatusAutogenConfigs
{
    ...
    public required V1MutatingPolicyStatusAutogenConfigsSpec Spec { get; set; }
...
public partial class V1MutatingPolicyStatusAutogen
{
    ...
    public IDictionary<string, V1MutatingPolicyStatusAutogenConfigs>? Configs { get; set; }
}
...
public partial class V1MutatingPolicyStatusConditionStatusConditions
{
    ...
    public required V1MutatingPolicyStatusConditionStatusConditionsStatusEnum Status { get; set; }
...
public partial class V1MutatingPolicyStatusConditionStatus
{
    ...
    public IList<V1MutatingPolicyStatusConditionStatusConditions>? Conditions { get; set; }
...
{
    [JsonPropertyName("autogen")]
    public V1MutatingPolicyStatusAutogen? Autogen { get; set; }

    /// <summary>ConditionStatus is the shared status across all policy types</summary>
    [JsonPropertyName("conditionStatus")]
    public V1MutatingPolicyStatusConditionStatus? ConditionStatus { get; set; }
...
public partial class V1MutatingPolicy : IKubernetesObject<V1ObjectMeta>, ISpec<V1MutatingPolicySpec>, IStatus<V1MutatingPolicyStatus?>
{
    ...
    /// <summary>MutatingPolicySpec is the specification of the desired behavior of the MutatingPolicy.</summary>
    [JsonPropertyName("spec")]
    public required V1MutatingPolicySpec Spec { get; set; }

    /// <summary>Status contains policy runtime data.</summary>
    [JsonPropertyName("status")]
    public V1MutatingPolicyStatus? Status { get; set; }
}