...
public partial class V2PolicyExceptionList : IKubernetesObject<V1ListMeta>, IItems<V2PolicyException>
{
    ...
    /// <summary>List of V2PolicyException objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V2PolicyException> Items { get; set; }
}
...
public partial class V2PolicyExceptionSpecConditionsAll
{
    ...
    public V2PolicyExceptionSpecConditionsAllOperatorEnum? Operator { get; set; }
...
public partial class V2PolicyExceptionSpecConditionsAny
{
    ...
    /// </summary>
    [JsonPropertyName("operator")]
    public V2PolicyExceptionSpecConditionsAnyOperatorEnum? Operator { get; set; }
...
public partial class V2PolicyExceptionSpecConditions
{
    ...
    public IList<V2PolicyExceptionSpecConditionsAll>? All { get; set; }
    ...
    public IList<V2PolicyExceptionSpecConditionsAny>? Any { get; set; }
}
...
public partial class V2PolicyExceptionSpecMatchAllResourcesNamespaceSelector
{
    ...
    public IList<V2PolicyExceptionSpecMatchAllResourcesNamespaceSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V2PolicyExceptionSpecMatchAllResourcesSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V2PolicyExceptionSpecMatchAllResourcesSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V2PolicyExceptionSpecMatchAllResources
{
    ...
    public V2PolicyExceptionSpecMatchAllResourcesNamespaceSelector? NamespaceSelector { get; set; }
    ...
    public IList<V2PolicyExceptionSpecMatchAllResourcesOperationsEnum>? Operations { get; set; }
    ...
    public V2PolicyExceptionSpecMatchAllResourcesSelector? Selector { get; set; }
}
...
public partial class V2PolicyExceptionSpecMatchAll
{
    ...
    public V2PolicyExceptionSpecMatchAllResources? Resources { get; set; }
    ...
    public IList<V2PolicyExceptionSpecMatchAllSubjects>? Subjects { get; set; }
}
...
public partial class V2PolicyExceptionSpecMatchAnyResourcesNamespaceSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V2PolicyExceptionSpecMatchAnyResourcesNamespaceSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V2PolicyExceptionSpecMatchAnyResourcesSelector
{
    /// <summary>matchExpressions is a list of label selector requirements. The requirements are ANDed.</summary>
    [JsonPropertyName("matchExpressions")]
    public IList<V2PolicyExceptionSpecMatchAnyResourcesSelectorMatchExpressions>? MatchExpressions { get; set; }
...
public partial class V2PolicyExceptionSpecMatchAnyResources
{
    ...
    /// </summary>
    [JsonPropertyName("namespaceSelector")]
    public V2PolicyExceptionSpecMatchAnyResourcesNamespaceSelector? NamespaceSelector { get; set; }
    ...
    /// <summary>Operations can contain values [&quot;CREATE, &quot;UPDATE&quot;, &quot;CONNECT&quot;, &quot;DELETE&quot;], which are used to match a specific action.</summary>
    [JsonPropertyName("operations")]
    public IList<V2PolicyExceptionSpecMatchAnyResourcesOperationsEnum>? Operations { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("selector")]
    public V2PolicyExceptionSpecMatchAnyResourcesSelector? Selector { get; set; }
}
...
public partial class V2PolicyExceptionSpecMatchAny
{
    ...
    /// <summary>ResourceDescription contains information about the resource being created or modified.</summary>
    [JsonPropertyName("resources")]
    public V2PolicyExceptionSpecMatchAnyResources? Resources { get; set; }
    ...
    /// <summary>Subjects is the list of subject names like users, user groups, and service accounts.</summary>
    [JsonPropertyName("subjects")]
    public IList<V2PolicyExceptionSpecMatchAnySubjects>? Subjects { get; set; }
}
...
public partial class V2PolicyExceptionSpecMatch
{
    ...
    [JsonPropertyName("all")]
    public IList<V2PolicyExceptionSpecMatchAll>? All { get; set; }

    /// <summary>Any allows specifying resources which will be ORed</summary>
    [JsonPropertyName("any")]
    public IList<V2PolicyExceptionSpecMatchAny>? Any { get; set; }
}
...
public partial class V2PolicyExceptionSpecPodSecurity
{
    ...
    public required V2PolicyExceptionSpecPodSecurityControlNameEnum ControlName { get; set; }
...
public partial class V2PolicyExceptionSpec
{
    ...
    public V2PolicyExceptionSpecConditions? Conditions { get; set; }

    /// <summary>Exceptions is a list policy/rules to be excluded</summary>
    [JsonPropertyName("exceptions")]
    public required IList<V2PolicyExceptionSpecExceptions> Exceptions { get; set; }

    /// <summary>Match defines match clause used to check if a resource applies to the exception</summary>
    [JsonPropertyName("match")]
    public required V2PolicyExceptionSpecMatch Match { get; set; }
    ...
    public IList<V2PolicyExceptionSpecPodSecurity>? PodSecurity { get; set; }
}
...
public partial class V2PolicyException : IKubernetesObject<V1ObjectMeta>, ISpec<V2PolicyExceptionSpec>
{
    ...
    public required V2PolicyExceptionSpec Spec { get; set; }
}