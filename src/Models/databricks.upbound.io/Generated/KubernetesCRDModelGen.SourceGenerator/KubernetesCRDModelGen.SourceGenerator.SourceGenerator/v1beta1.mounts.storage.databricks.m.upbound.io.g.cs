...
namespace KubernetesCRDModelGen.Models.storage.databricks.m.upbound.io;
...
public partial class V1beta1MountList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Mount>
{
    ...
    public const string KubeGroup = "storage.databricks.m.upbound.io";
    public const string KubePluralName = "mounts";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    public string ApiVersion { get; set; } = "storage.databricks.m.upbound.io/v1beta1";
