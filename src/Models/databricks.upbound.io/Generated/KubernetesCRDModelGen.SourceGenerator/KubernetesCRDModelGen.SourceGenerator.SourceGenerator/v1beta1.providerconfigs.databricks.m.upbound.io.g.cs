...
namespace KubernetesCRDModelGen.Models.databricks.m.upbound.io;
...
public partial class V1beta1ProviderConfigList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ProviderConfig>
{
    ...
    public const string KubeGroup = "databricks.m.upbound.io";
    public const string KubePluralName = "providerconfigs";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    public string ApiVersion { get; set; } = "databricks.m.upbound.io/v1beta1";
