...
public partial class V1beta1SingleGrantList : IKubernetesObject<V1ListMeta>, IItems<V1beta1SingleGrant>
{
    ...
    public const string KubeKind = "SingleGrantList";
    public const string KubeGroup = "unitycatalog.databricks.upbound.io";
    public const string KubePluralName = "singlegrants";
    ...
    public string Kind { get; set; } = "SingleGrantList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1SingleGrant objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1SingleGrant> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1SingleGrantSpecDeletionPolicyEnum>))]
public enum V1beta1SingleGrantSpecDeletionPolicyEnum
{
...
public partial class V1beta1SingleGrantSpecForProviderCatalogRefPolicy
{
    ...
    public V1beta1SingleGrantSpecForProviderCatalogRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1SingleGrantSpecForProviderCatalogRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderCatalogRef
{
    ...
    public V1beta1SingleGrantSpecForProviderCatalogRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderCatalogSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecForProviderCatalogSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecForProviderCatalogSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderCatalogSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecForProviderCatalogSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderExternalLocationRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecForProviderExternalLocationRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecForProviderExternalLocationRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderExternalLocationRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecForProviderExternalLocationRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderExternalLocationSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecForProviderExternalLocationSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecForProviderExternalLocationSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderExternalLocationSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecForProviderExternalLocationSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderMetastoreRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecForProviderMetastoreRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecForProviderMetastoreRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderMetastoreRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecForProviderMetastoreRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderMetastoreSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecForProviderMetastoreSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecForProviderMetastoreSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderMetastoreSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecForProviderMetastoreSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderStorageCredentialRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecForProviderStorageCredentialRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecForProviderStorageCredentialRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderStorageCredentialRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecForProviderStorageCredentialRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProviderStorageCredentialSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecForProviderStorageCredentialSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecForProviderStorageCredentialSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecForProvider
{
    ...
    public V1beta1SingleGrantSpecForProviderCatalogRef? CatalogRef { get; set; }

    /// <summary>Selector for a Catalog in unitycatalog to populate catalog.</summary>
    [JsonPropertyName("catalogSelector")]
    public V1beta1SingleGrantSpecForProviderCatalogSelector? CatalogSelector { get; set; }
    ...
    public V1beta1SingleGrantSpecForProviderExternalLocationRef? ExternalLocationRef { get; set; }

    /// <summary>Selector for a ExternalLocation in unitycatalog to populate externalLocation.</summary>
    [JsonPropertyName("externalLocationSelector")]
    public V1beta1SingleGrantSpecForProviderExternalLocationSelector? ExternalLocationSelector { get; set; }
    ...
    public V1beta1SingleGrantSpecForProviderMetastoreRef? MetastoreRef { get; set; }

    /// <summary>Selector for a Metastore in unitycatalog to populate metastore.</summary>
    [JsonPropertyName("metastoreSelector")]
    public V1beta1SingleGrantSpecForProviderMetastoreSelector? MetastoreSelector { get; set; }
    ...
    public V1beta1SingleGrantSpecForProviderStorageCredentialRef? StorageCredentialRef { get; set; }

    /// <summary>Selector for a StorageCredential in unitycatalog to populate storageCredential.</summary>
    [JsonPropertyName("storageCredentialSelector")]
    public V1beta1SingleGrantSpecForProviderStorageCredentialSelector? StorageCredentialSelector { get; set; }
...
public partial class V1beta1SingleGrantSpecInitProviderCatalogRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecInitProviderCatalogRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecInitProviderCatalogRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderCatalogRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecInitProviderCatalogRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderCatalogSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecInitProviderCatalogSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecInitProviderCatalogSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderCatalogSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecInitProviderCatalogSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderExternalLocationRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecInitProviderExternalLocationRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecInitProviderExternalLocationRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderExternalLocationRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecInitProviderExternalLocationRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderExternalLocationSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecInitProviderExternalLocationSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecInitProviderExternalLocationSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderExternalLocationSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecInitProviderExternalLocationSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderMetastoreRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecInitProviderMetastoreRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecInitProviderMetastoreRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderMetastoreRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecInitProviderMetastoreRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderMetastoreSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecInitProviderMetastoreSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecInitProviderMetastoreSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderMetastoreSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecInitProviderMetastoreSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderStorageCredentialRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecInitProviderStorageCredentialRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecInitProviderStorageCredentialRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderStorageCredentialRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecInitProviderStorageCredentialRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderStorageCredentialSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecInitProviderStorageCredentialSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecInitProviderStorageCredentialSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProviderStorageCredentialSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecInitProviderStorageCredentialSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpecInitProvider
{
    ...
    /// <summary>Reference to a Catalog in unitycatalog to populate catalog.</summary>
    [JsonPropertyName("catalogRef")]
    public V1beta1SingleGrantSpecInitProviderCatalogRef? CatalogRef { get; set; }

    /// <summary>Selector for a Catalog in unitycatalog to populate catalog.</summary>
    [JsonPropertyName("catalogSelector")]
    public V1beta1SingleGrantSpecInitProviderCatalogSelector? CatalogSelector { get; set; }
    ...
    /// <summary>Reference to a ExternalLocation in unitycatalog to populate externalLocation.</summary>
    [JsonPropertyName("externalLocationRef")]
    public V1beta1SingleGrantSpecInitProviderExternalLocationRef? ExternalLocationRef { get; set; }

    /// <summary>Selector for a ExternalLocation in unitycatalog to populate externalLocation.</summary>
    [JsonPropertyName("externalLocationSelector")]
    public V1beta1SingleGrantSpecInitProviderExternalLocationSelector? ExternalLocationSelector { get; set; }
    ...
    /// <summary>Reference to a Metastore in unitycatalog to populate metastore.</summary>
    [JsonPropertyName("metastoreRef")]
    public V1beta1SingleGrantSpecInitProviderMetastoreRef? MetastoreRef { get; set; }

    /// <summary>Selector for a Metastore in unitycatalog to populate metastore.</summary>
    [JsonPropertyName("metastoreSelector")]
    public V1beta1SingleGrantSpecInitProviderMetastoreSelector? MetastoreSelector { get; set; }
    ...
    /// <summary>Reference to a StorageCredential in unitycatalog to populate storageCredential.</summary>
    [JsonPropertyName("storageCredentialRef")]
    public V1beta1SingleGrantSpecInitProviderStorageCredentialRef? StorageCredentialRef { get; set; }

    /// <summary>Selector for a StorageCredential in unitycatalog to populate storageCredential.</summary>
    [JsonPropertyName("storageCredentialSelector")]
    public V1beta1SingleGrantSpecInitProviderStorageCredentialSelector? StorageCredentialSelector { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1SingleGrantSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1SingleGrantSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1SingleGrantSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1SingleGrantSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1SingleGrantSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SingleGrantSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SingleGrantSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SingleGrantSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleGrantSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleGrantSpec
{
    ...
    public V1beta1SingleGrantSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1SingleGrantSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1SingleGrantSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1SingleGrantSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1SingleGrantSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1SingleGrantStatus
{
    ...
    public V1beta1SingleGrantStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1SingleGrantStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "SingleGrant";
    public const string KubeGroup = "unitycatalog.databricks.upbound.io";
    public const string KubePluralName = "singlegrants";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "SingleGrant";
    ...
    public required V1beta1SingleGrantSpec Spec { get; set; }

    /// <summary>SingleGrantStatus defines the observed state of SingleGrant.</summary>
    [JsonPropertyName("status")]
    public V1beta1SingleGrantStatus? Status { get; set; }
}