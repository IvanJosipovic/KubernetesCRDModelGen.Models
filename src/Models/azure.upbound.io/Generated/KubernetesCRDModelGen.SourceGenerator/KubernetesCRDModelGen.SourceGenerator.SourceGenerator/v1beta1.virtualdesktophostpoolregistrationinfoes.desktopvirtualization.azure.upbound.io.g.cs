...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoList : IKubernetesObject<V1ListMeta>, IItems<V1beta1VirtualDesktopHostPoolRegistrationInfo>
{
    ...
    public const string KubeKind = "VirtualDesktopHostPoolRegistrationInfoList";
    public const string KubeGroup = "desktopvirtualization.azure.upbound.io";
    public const string KubePluralName = "virtualdesktophostpoolregistrationinfoes";
    ...
    public string Kind { get; set; } = "VirtualDesktopHostPoolRegistrationInfoList";
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProviderHostpoolIdRefPolicy
{
    ...
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProviderHostpoolIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProviderHostpoolIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProviderHostpoolIdRef
{
    ...
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProviderHostpoolIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProviderHostpoolIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProviderHostpoolIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProviderHostpoolIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>A valid RFC3339Time for the expiration of the token..</summary>
    [JsonPropertyName("expirationDate")]
    public string? ExpirationDate { get; set; }

    /// <summary>The ID of the Virtual Desktop Host Pool to link the Registration Info to. Changing this forces a new Registration Info resource to be created. Only a single virtual_desktop_host_pool_registration_info resource should be associated with a given hostpool. Assigning multiple resources will produce inconsistent results.</summary>
    [JsonPropertyName("hostpoolId")]
    public string? HostpoolId { get; set; }

    /// <summary>Reference to a VirtualDesktopHostPool in desktopvirtualization to populate hostpoolId.</summary>
    [JsonPropertyName("hostpoolIdRef")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProviderHostpoolIdRef? HostpoolIdRef { get; set; }

    /// <summary>Selector for a VirtualDesktopHostPool in desktopvirtualization to populate hostpoolId.</summary>
    [JsonPropertyName("hostpoolIdSelector")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProviderHostpoolIdSelector? HostpoolIdSelector { get; set; }
}
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProvider
{
    ...
    /// <summary>Reference to a VirtualDesktopHostPool in desktopvirtualization to populate hostpoolId.</summary>
    [JsonPropertyName("hostpoolIdRef")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdRef? HostpoolIdRef { get; set; }

    /// <summary>Selector for a VirtualDesktopHostPool in desktopvirtualization to populate hostpoolId.</summary>
    [JsonPropertyName("hostpoolIdSelector")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProviderHostpoolIdSelector? HostpoolIdSelector { get; set; }
}
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoSpec
{
    ...
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1VirtualDesktopHostPoolRegistrationInfoSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1VirtualDesktopHostPoolRegistrationInfoSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1VirtualDesktopHostPoolRegistrationInfoSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoStatusAtProvider
{
    ...
    /// <summary>The ID of the Virtual Desktop Host Pool Registration Info resource.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1VirtualDesktopHostPoolRegistrationInfoStatus
{
    ...
    public V1beta1VirtualDesktopHostPoolRegistrationInfoStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1VirtualDesktopHostPoolRegistrationInfoStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "VirtualDesktopHostPoolRegistrationInfo";
    public const string KubeGroup = "desktopvirtualization.azure.upbound.io";
    public const string KubePluralName = "virtualdesktophostpoolregistrationinfoes";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "VirtualDesktopHostPoolRegistrationInfo";
    ...
    public required V1beta1VirtualDesktopHostPoolRegistrationInfoSpec Spec { get; set; }

    /// <summary>VirtualDesktopHostPoolRegistrationInfoStatus defines the observed state of VirtualDesktopHostPoolRegistrationInfo.</summary>
    [JsonPropertyName("status")]
    public V1beta1VirtualDesktopHostPoolRegistrationInfoStatus? Status { get; set; }
}