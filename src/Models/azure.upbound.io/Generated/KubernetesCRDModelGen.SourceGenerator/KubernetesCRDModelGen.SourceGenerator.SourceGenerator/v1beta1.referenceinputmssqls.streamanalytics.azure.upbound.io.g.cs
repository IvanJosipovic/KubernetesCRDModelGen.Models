...
public partial class V1beta1ReferenceInputMSSQLList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ReferenceInputMSSQL>
{
    ...
    public string Kind { get; set; } = "ReferenceInputMSSQLList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ReferenceInputMSSQL objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ReferenceInputMSSQL> Items { get; set; }
}
...
public partial class V1beta1ReferenceInputMSSQLSpecInitProvider
{
    ...
    /// <summary>The password to connect to the MS SQL database.</summary>
    [JsonPropertyName("passwordSecretRef")]
    public required V1beta1ReferenceInputMSSQLSpecInitProviderPasswordSecretRef PasswordSecretRef { get; set; }
...
public partial class V1beta1ReferenceInputMSSQLSpec
{
    ...
    public required V1beta1ReferenceInputMSSQLSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1ReferenceInputMSSQL : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ReferenceInputMSSQLSpec>, IStatus<V1beta1ReferenceInputMSSQLStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ReferenceInputMSSQL";
    ...
    public required V1beta1ReferenceInputMSSQLSpec Spec { get; set; }
