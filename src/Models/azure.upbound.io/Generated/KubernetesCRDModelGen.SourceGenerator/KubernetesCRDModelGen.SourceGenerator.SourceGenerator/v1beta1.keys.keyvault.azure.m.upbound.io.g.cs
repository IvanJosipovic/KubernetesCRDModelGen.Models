...
public partial class V1beta1KeySpecForProvider
{
    ...
    public V1beta1KeySpecForProviderReleasePolicy? ReleasePolicy { get; set; }
...
public partial class V1beta1KeySpecInitProvider
{
    ...
    /// <summary>A release_policy block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("releasePolicy")]
    public V1beta1KeySpecInitProviderReleasePolicy? ReleasePolicy { get; set; }
...
public partial class V1beta1KeyStatusAtProvider
{
    ...
    /// <summary>A release_policy block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("releasePolicy")]
    public V1beta1KeyStatusAtProviderReleasePolicy? ReleasePolicy { get; set; }
