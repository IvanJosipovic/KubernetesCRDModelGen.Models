...
public partial class V1beta1FrontdoorSecretList : IKubernetesObject<V1ListMeta>, IItems<V1beta1FrontdoorSecret>
{
    ...
    public const string KubeKind = "FrontdoorSecretList";
    public const string KubeGroup = "cdn.azure.upbound.io";
    public const string KubePluralName = "frontdoorsecrets";
    ...
    public string Kind { get; set; } = "FrontdoorSecretList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1FrontdoorSecret objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1FrontdoorSecret> Items { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdRefPolicy
{
    ...
    public V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdRef
{
    ...
    public V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecForProviderSecretCustomerCertificateKeyVaultCertificateIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1FrontdoorSecretSpecForProviderSecretCustomerCertificateKeyVaultCertificateIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1FrontdoorSecretSpecForProviderSecretCustomerCertificateKeyVaultCertificateIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecForProviderSecretCustomerCertificateKeyVaultCertificateIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1FrontdoorSecretSpecForProviderSecretCustomerCertificateKeyVaultCertificateIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecForProviderSecretCustomerCertificateKeyVaultCertificateIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1FrontdoorSecretSpecForProviderSecretCustomerCertificateKeyVaultCertificateIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1FrontdoorSecretSpecForProviderSecretCustomerCertificateKeyVaultCertificateIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>The ID of the Key Vault certificate resource to use. Changing this forces a new Front Door Secret to be created.</summary>
    ...
    public V1beta1FrontdoorSecretSpecForProviderSecretCustomerCertificateKeyVaultCertificateIdRef? KeyVaultCertificateIdRef { get; set; }

    /// <summary>Selector for a Certificate in keyvault to populate keyVaultCertificateId.</summary>
    [JsonPropertyName("keyVaultCertificateIdSelector")]
    public V1beta1FrontdoorSecretSpecForProviderSecretCustomerCertificateKeyVaultCertificateIdSelector? KeyVaultCertificateIdSelector { get; set; }
}
...
{
    /// <summary>A customer_certificate block as defined below. Changing this forces a new Front Door Secret to be created.</summary>
...
{
    /// <summary>The Resource ID of the Front Door Profile. Changing this forces a new Front Door Secret to be created.</summary>
    ...
    public V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdRef? CdnFrontdoorProfileIdRef { get; set; }

    /// <summary>Selector for a FrontdoorProfile in cdn to populate cdnFrontdoorProfileId.</summary>
    [JsonPropertyName("cdnFrontdoorProfileIdSelector")]
    public V1beta1FrontdoorSecretSpecForProviderCdnFrontdoorProfileIdSelector? CdnFrontdoorProfileIdSelector { get; set; }

    /// <summary>A secret block as defined below. Changing this forces a new Front Door Secret to be created.</summary>
    [JsonPropertyName("secret")]
    public V1beta1FrontdoorSecretSpecForProviderSecret? Secret { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificateKeyVaultCertificateIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificateKeyVaultCertificateIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificateKeyVaultCertificateIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificateKeyVaultCertificateIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificateKeyVaultCertificateIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificateKeyVaultCertificateIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificateKeyVaultCertificateIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificateKeyVaultCertificateIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificate
{
    ...
    /// <summary>Reference to a Certificate in keyvault to populate keyVaultCertificateId.</summary>
    [JsonPropertyName("keyVaultCertificateIdRef")]
    public V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificateKeyVaultCertificateIdRef? KeyVaultCertificateIdRef { get; set; }

    /// <summary>Selector for a Certificate in keyvault to populate keyVaultCertificateId.</summary>
    [JsonPropertyName("keyVaultCertificateIdSelector")]
    public V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificateKeyVaultCertificateIdSelector? KeyVaultCertificateIdSelector { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecInitProviderSecret
{
    /// <summary>A customer_certificate block as defined below. Changing this forces a new Front Door Secret to be created.</summary>
    [JsonPropertyName("customerCertificate")]
    public IList<V1beta1FrontdoorSecretSpecInitProviderSecretCustomerCertificate>? CustomerCertificate { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecInitProvider
{
    /// <summary>A secret block as defined below. Changing this forces a new Front Door Secret to be created.</summary>
    [JsonPropertyName("secret")]
    public V1beta1FrontdoorSecretSpecInitProviderSecret? Secret { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1FrontdoorSecretSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1FrontdoorSecretSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1FrontdoorSecretSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1FrontdoorSecretSpec
{
    ...
    public V1beta1FrontdoorSecretSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1FrontdoorSecretSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1FrontdoorSecretSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1FrontdoorSecretSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1FrontdoorSecretSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1FrontdoorSecretStatusAtProviderSecretCustomerCertificate
{
    ...
    /// <summary>(Computed) One or more subject alternative names contained within the key vault certificate.</summary>
...
public partial class V1beta1FrontdoorSecretStatusAtProvider
{
    ...
    /// <summary>The name of the Front Door Profile containing this Front Door Secret.</summary>
    [JsonPropertyName("cdnFrontdoorProfileName")]
    public string? CdnFrontdoorProfileName { get; set; }

    /// <summary>The ID of the Front Door Secret.</summary>
    [JsonPropertyName("id")]
    public string? Id { get; set; }

    /// <summary>A secret block as defined below. Changing this forces a new Front Door Secret to be created.</summary>
    [JsonPropertyName("secret")]
    public V1beta1FrontdoorSecretStatusAtProviderSecret? Secret { get; set; }
}
...
public partial class V1beta1FrontdoorSecretStatus
{
    ...
    public V1beta1FrontdoorSecretStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1FrontdoorSecretStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "FrontdoorSecret";
    public const string KubeGroup = "cdn.azure.upbound.io";
    public const string KubePluralName = "frontdoorsecrets";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "FrontdoorSecret";
    ...
    public required V1beta1FrontdoorSecretSpec Spec { get; set; }

    /// <summary>FrontdoorSecretStatus defines the observed state of FrontdoorSecret.</summary>
    [JsonPropertyName("status")]
    public V1beta1FrontdoorSecretStatus? Status { get; set; }
}