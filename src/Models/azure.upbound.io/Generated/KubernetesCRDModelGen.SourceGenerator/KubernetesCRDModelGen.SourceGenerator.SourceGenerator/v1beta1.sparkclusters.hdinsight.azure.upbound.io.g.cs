...
public partial class V1beta1SparkClusterList : IKubernetesObject<V1ListMeta>, IItems<V1beta1SparkCluster>
{
    ...
    /// <summary>List of V1beta1SparkCluster objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1SparkCluster> Items { get; set; }
}
...
public partial class V1beta1SparkClusterSpecForProviderPrivateLinkConfigurationIpConfigurationSubnetIdRefPolicy
{
    ...
    public V1beta1SparkClusterSpecForProviderPrivateLinkConfigurationIpConfigurationSubnetIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1SparkClusterSpecForProviderPrivateLinkConfigurationIpConfigurationSubnetIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SparkClusterSpecForProviderPrivateLinkConfigurationIpConfigurationSubnetIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SparkClusterSpecForProviderPrivateLinkConfigurationIpConfigurationSubnetIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SparkClusterSpecForProviderPrivateLinkConfigurationIpConfigurationSubnetIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SparkClusterSpecInitProviderExtension
{
    ...
    /// <summary>The workspace key of the log analytics extension.</summary>
    [JsonPropertyName("primaryKeySecretRef")]
    public required V1beta1SparkClusterSpecInitProviderExtensionPrimaryKeySecretRef PrimaryKeySecretRef { get; set; }
}
...
public partial class V1beta1SparkClusterSpecInitProviderGateway
{
    /// <summary>The password used for the Ambari Portal.</summary>
    [JsonPropertyName("passwordSecretRef")]
    public required V1beta1SparkClusterSpecInitProviderGatewayPasswordSecretRef PasswordSecretRef { get; set; }
...
public partial class V1beta1SparkClusterSpecInitProviderMetastoresAmbari
{
    ...
    /// <summary>The Password associated with the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("passwordSecretRef")]
    public required V1beta1SparkClusterSpecInitProviderMetastoresAmbariPasswordSecretRef PasswordSecretRef { get; set; }
...
public partial class V1beta1SparkClusterSpecInitProviderMetastoresHive
{
    ...
    /// <summary>The Password associated with the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("passwordSecretRef")]
    public required V1beta1SparkClusterSpecInitProviderMetastoresHivePasswordSecretRef PasswordSecretRef { get; set; }
...
public partial class V1beta1SparkClusterSpecInitProviderMetastoresOozie
{
    ...
    /// <summary>The Password associated with the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("passwordSecretRef")]
    public required V1beta1SparkClusterSpecInitProviderMetastoresOoziePasswordSecretRef PasswordSecretRef { get; set; }
...
public partial class V1beta1SparkClusterSpecInitProviderMonitor
{
    ...
    /// <summary>The Operations Management Suite (OMS) workspace key.</summary>
    [JsonPropertyName("primaryKeySecretRef")]
    public required V1beta1SparkClusterSpecInitProviderMonitorPrimaryKeySecretRef PrimaryKeySecretRef { get; set; }
}
...
public partial class V1beta1SparkClusterSpecInitProviderPrivateLinkConfigurationIpConfigurationSubnetIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SparkClusterSpecInitProviderPrivateLinkConfigurationIpConfigurationSubnetIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SparkClusterSpecInitProviderPrivateLinkConfigurationIpConfigurationSubnetIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SparkClusterSpecInitProviderPrivateLinkConfigurationIpConfigurationSubnetIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1SparkClusterSpecInitProviderPrivateLinkConfigurationIpConfigurationSubnetIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1SparkClusterSpecInitProviderPrivateLinkConfigurationIpConfigurationSubnetIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SparkClusterSpecInitProviderSecurityProfile
{
    ...
    /// <summary>The user password of the Azure Active Directory Domain. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("domainUserPasswordSecretRef")]
    public required V1beta1SparkClusterSpecInitProviderSecurityProfileDomainUserPasswordSecretRef DomainUserPasswordSecretRef { get; set; }
...
public partial class V1beta1SparkClusterSpecInitProviderStorageAccount
{
    ...
    /// <summary>The Access Key which should be used to connect to the Storage Account. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("storageAccountKeySecretRef")]
    public required V1beta1SparkClusterSpecInitProviderStorageAccountStorageAccountKeySecretRef StorageAccountKeySecretRef { get; set; }
...
public partial class V1beta1SparkClusterSpec
{
    ...
    public required V1beta1SparkClusterSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1SparkCluster : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1SparkClusterSpec>, IStatus<V1beta1SparkClusterStatus?>
{
    ...
    public required V1beta1SparkClusterSpec Spec { get; set; }
