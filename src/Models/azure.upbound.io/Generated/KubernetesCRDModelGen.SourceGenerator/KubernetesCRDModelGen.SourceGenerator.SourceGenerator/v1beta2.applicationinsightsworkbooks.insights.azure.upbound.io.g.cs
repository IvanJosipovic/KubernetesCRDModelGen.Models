...
public partial class V1beta2ApplicationInsightsWorkbookList : IKubernetesObject<V1ListMeta>, IItems<V1beta2ApplicationInsightsWorkbook>
{
    ...
    public string Kind { get; set; } = "ApplicationInsightsWorkbookList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta2ApplicationInsightsWorkbook objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta2ApplicationInsightsWorkbook> Items { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookSpecForProviderResourceGroupNameRefPolicy
{
    ...
    public V1beta2ApplicationInsightsWorkbookSpecForProviderResourceGroupNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta2ApplicationInsightsWorkbookSpecForProviderResourceGroupNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookSpecForProviderResourceGroupNameRef
{
    ...
    public V1beta2ApplicationInsightsWorkbookSpecForProviderResourceGroupNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookSpecForProviderResourceGroupNameSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2ApplicationInsightsWorkbookSpecForProviderResourceGroupNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2ApplicationInsightsWorkbookSpecForProviderResourceGroupNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookSpecForProvider
{
    ...
    public V1beta2ApplicationInsightsWorkbookSpecForProviderIdentity? Identity { get; set; }
    ...
    public V1beta2ApplicationInsightsWorkbookSpecForProviderResourceGroupNameRef? ResourceGroupNameRef { get; set; }

    /// <summary>Selector for a ResourceGroup in azure to populate resourceGroupName.</summary>
    [JsonPropertyName("resourceGroupNameSelector")]
    public V1beta2ApplicationInsightsWorkbookSpecForProviderResourceGroupNameSelector? ResourceGroupNameSelector { get; set; }
...
public partial class V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookSpecInitProvider
{
    ...
    /// <summary>An identity block as defined below. Changing this forces a new Workbook to be created.</summary>
    [JsonPropertyName("identity")]
    public V1beta2ApplicationInsightsWorkbookSpecInitProviderIdentity? Identity { get; set; }
    ...
    /// <summary>Reference to a ResourceGroup in azure to populate resourceGroupName.</summary>
    [JsonPropertyName("resourceGroupNameRef")]
    public V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameRef? ResourceGroupNameRef { get; set; }

    /// <summary>Selector for a ResourceGroup in azure to populate resourceGroupName.</summary>
    [JsonPropertyName("resourceGroupNameSelector")]
    public V1beta2ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameSelector? ResourceGroupNameSelector { get; set; }
...
public partial class V1beta2ApplicationInsightsWorkbookSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2ApplicationInsightsWorkbookSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2ApplicationInsightsWorkbookSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2ApplicationInsightsWorkbookSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookSpec
{
    ...
    public V1beta2ApplicationInsightsWorkbookSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta2ApplicationInsightsWorkbookSpecForProvider ForProvider { get; set; }
    ...
    public V1beta2ApplicationInsightsWorkbookSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta2ApplicationInsightsWorkbookSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta2ApplicationInsightsWorkbookSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1beta2ApplicationInsightsWorkbookSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta2ApplicationInsightsWorkbookStatusAtProvider
{
    ...
    /// <summary>An identity block as defined below. Changing this forces a new Workbook to be created.</summary>
    [JsonPropertyName("identity")]
    public V1beta2ApplicationInsightsWorkbookStatusAtProviderIdentity? Identity { get; set; }
...
public partial class V1beta2ApplicationInsightsWorkbookStatus
{
    ...
    public V1beta2ApplicationInsightsWorkbookStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta2ApplicationInsightsWorkbookStatusConditions>? Conditions { get; set; }
...
public partial class V1beta2ApplicationInsightsWorkbook : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta2ApplicationInsightsWorkbookSpec>, IStatus<V1beta2ApplicationInsightsWorkbookStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ApplicationInsightsWorkbook";
    ...
    public required V1beta2ApplicationInsightsWorkbookSpec Spec { get; set; }

    /// <summary>ApplicationInsightsWorkbookStatus defines the observed state of ApplicationInsightsWorkbook.</summary>
    [JsonPropertyName("status")]
    public V1beta2ApplicationInsightsWorkbookStatus? Status { get; set; }
}