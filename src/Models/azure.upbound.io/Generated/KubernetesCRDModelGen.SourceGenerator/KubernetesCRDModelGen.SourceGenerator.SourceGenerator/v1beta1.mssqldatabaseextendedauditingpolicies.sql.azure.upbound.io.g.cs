...
public partial class V1beta1MSSQLDatabaseExtendedAuditingPolicyList : IKubernetesObject<V1ListMeta>, IItems<V1beta1MSSQLDatabaseExtendedAuditingPolicy>
{
    ...
    public string Kind { get; set; } = "MSSQLDatabaseExtendedAuditingPolicyList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1MSSQLDatabaseExtendedAuditingPolicy objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1MSSQLDatabaseExtendedAuditingPolicy> Items { get; set; }
}
...
public partial class V1beta1MSSQLDatabaseExtendedAuditingPolicySpec
{
    ...
    public required V1beta1MSSQLDatabaseExtendedAuditingPolicySpecForProvider ForProvider { get; set; }
...
public partial class V1beta1MSSQLDatabaseExtendedAuditingPolicy : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1MSSQLDatabaseExtendedAuditingPolicySpec>, IStatus<V1beta1MSSQLDatabaseExtendedAuditingPolicyStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "MSSQLDatabaseExtendedAuditingPolicy";
    ...
    public required V1beta1MSSQLDatabaseExtendedAuditingPolicySpec Spec { get; set; }
