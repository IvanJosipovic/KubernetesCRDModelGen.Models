...
public partial class V1beta1VirtualMachineRunCommandList : IKubernetesObject<V1ListMeta>, IItems<V1beta1VirtualMachineRunCommand>
{
    ...
    /// <summary>List of V1beta1VirtualMachineRunCommand objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1VirtualMachineRunCommand> Items { get; set; }
}
...
public partial class V1beta1VirtualMachineRunCommandSpecForProviderProtectedParameter
{
    ...
    public required V1beta1VirtualMachineRunCommandSpecForProviderProtectedParameterNameSecretRef NameSecretRef { get; set; }

    /// <summary>The run parameter value.</summary>
    [JsonPropertyName("valueSecretRef")]
    public required V1beta1VirtualMachineRunCommandSpecForProviderProtectedParameterValueSecretRef ValueSecretRef { get; set; }
}
...
public partial class V1beta1VirtualMachineRunCommandSpec
{
    ...
    public required V1beta1VirtualMachineRunCommandSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1VirtualMachineRunCommandStatusAtProviderProtectedParameter
{
    /// <summary>The run parameter name.</summary>
    [JsonPropertyName("nameSecretRef")]
    public required V1beta1VirtualMachineRunCommandStatusAtProviderProtectedParameterNameSecretRef NameSecretRef { get; set; }

    /// <summary>The run parameter value.</summary>
    [JsonPropertyName("valueSecretRef")]
    public required V1beta1VirtualMachineRunCommandStatusAtProviderProtectedParameterValueSecretRef ValueSecretRef { get; set; }
}
...
public partial class V1beta1VirtualMachineRunCommand : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1VirtualMachineRunCommandSpec>, IStatus<V1beta1VirtualMachineRunCommandStatus?>
{
    ...
    public required V1beta1VirtualMachineRunCommandSpec Spec { get; set; }
