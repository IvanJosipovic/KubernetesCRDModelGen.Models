...
public partial class V1beta1ManagerVerifierWorkspaceList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ManagerVerifierWorkspace>
{
    ...
    public const string KubeKind = "ManagerVerifierWorkspaceList";
    public const string KubeGroup = "network.azure.upbound.io";
    public const string KubePluralName = "managerverifierworkspaces";
    ...
    public string Kind { get; set; } = "ManagerVerifierWorkspaceList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ManagerVerifierWorkspace objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ManagerVerifierWorkspace> Items { get; set; }
}
...
public partial class V1beta1ManagerVerifierWorkspaceSpecForProviderNetworkManagerIdRefPolicy
{
    ...
    public V1beta1ManagerVerifierWorkspaceSpecForProviderNetworkManagerIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ManagerVerifierWorkspaceSpecForProviderNetworkManagerIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ManagerVerifierWorkspaceSpecForProviderNetworkManagerIdRef
{
    ...
    public V1beta1ManagerVerifierWorkspaceSpecForProviderNetworkManagerIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ManagerVerifierWorkspaceSpecForProviderNetworkManagerIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ManagerVerifierWorkspaceSpecForProviderNetworkManagerIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ManagerVerifierWorkspaceSpecForProviderNetworkManagerIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>The Description of the Network Manager Verifier Workspace.</summary>
    [JsonPropertyName("description")]
    public string? Description { get; set; }

    /// <summary>The Azure Region where the Network Manager Verifier Workspace should exist. Changing this forces a new Network Manager Verifier Workspace to be created.</summary>
    [JsonPropertyName("location")]
    public string? Location { get; set; }

    /// <summary>The ID of the Network Manager. Changing this forces a new Network Manager Verifier Workspace to be created.</summary>
    [JsonPropertyName("networkManagerId")]
    public string? NetworkManagerId { get; set; }

    /// <summary>Reference to a Manager in network to populate networkManagerId.</summary>
    [JsonPropertyName("networkManagerIdRef")]
    public V1beta1ManagerVerifierWorkspaceSpecForProviderNetworkManagerIdRef? NetworkManagerIdRef { get; set; }

    /// <summary>Selector for a Manager in network to populate networkManagerId.</summary>
    [JsonPropertyName("networkManagerIdSelector")]
    public V1beta1ManagerVerifierWorkspaceSpecForProviderNetworkManagerIdSelector? NetworkManagerIdSelector { get; set; }

    /// <summary>A mapping of tags which should be assigned to the Network Manager Verifier Workspace.</summary>
...
public partial class V1beta1ManagerVerifierWorkspaceSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ManagerVerifierWorkspaceSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ManagerVerifierWorkspaceSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ManagerVerifierWorkspaceSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ManagerVerifierWorkspaceSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ManagerVerifierWorkspaceSpec
{
    ...
    public V1beta1ManagerVerifierWorkspaceSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1ManagerVerifierWorkspaceSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1ManagerVerifierWorkspaceSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1ManagerVerifierWorkspaceSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1ManagerVerifierWorkspaceSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1ManagerVerifierWorkspaceStatusAtProvider
{
    ...
    /// <summary>The ID of the Network Manager Verifier Workspace.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1ManagerVerifierWorkspaceStatus
{
    ...
    public V1beta1ManagerVerifierWorkspaceStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1ManagerVerifierWorkspaceStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "ManagerVerifierWorkspace";
    public const string KubeGroup = "network.azure.upbound.io";
    public const string KubePluralName = "managerverifierworkspaces";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ManagerVerifierWorkspace";
    ...
    public required V1beta1ManagerVerifierWorkspaceSpec Spec { get; set; }

    /// <summary>ManagerVerifierWorkspaceStatus defines the observed state of ManagerVerifierWorkspace.</summary>
    [JsonPropertyName("status")]
    public V1beta1ManagerVerifierWorkspaceStatus? Status { get; set; }
}