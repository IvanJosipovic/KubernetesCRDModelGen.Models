...
public partial class V1beta1ManagerStaticMemberList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ManagerStaticMember>
{
    ...
    public string Kind { get; set; } = "ManagerStaticMemberList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ManagerStaticMember objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ManagerStaticMember> Items { get; set; }
}
...
public partial class V1beta1ManagerStaticMemberSpec
{
    ...
    public required V1beta1ManagerStaticMemberSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1ManagerStaticMember : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ManagerStaticMemberSpec>, IStatus<V1beta1ManagerStaticMemberStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ManagerStaticMember";
    ...
    public required V1beta1ManagerStaticMemberSpec Spec { get; set; }
