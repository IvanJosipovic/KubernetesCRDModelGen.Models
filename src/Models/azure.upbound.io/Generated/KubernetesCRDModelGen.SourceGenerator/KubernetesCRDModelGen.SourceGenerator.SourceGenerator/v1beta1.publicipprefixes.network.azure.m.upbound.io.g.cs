...
public partial class V1beta1PublicIPPrefixList : IKubernetesObject<V1ListMeta>, IItems<V1beta1PublicIPPrefix>
{
    ...
    /// <summary>List of V1beta1PublicIPPrefix objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1PublicIPPrefix> Items { get; set; }
}
...
{
    /// <summary>The Custom IP Prefix ID associated with the Public IP Prefix. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("customIpPrefixId")]
    public string? CustomIpPrefixId { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1PublicIPPrefixSpecManagementPoliciesEnum>))]
...
public partial class V1beta1PublicIPPrefixSpec
{
    ...
    public required V1beta1PublicIPPrefixSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1PublicIPPrefix : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1PublicIPPrefixSpec>, IStatus<V1beta1PublicIPPrefixStatus?>
{
    ...
    public required V1beta1PublicIPPrefixSpec Spec { get; set; }
