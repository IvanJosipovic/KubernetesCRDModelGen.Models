...
public partial class V1beta1EventHubList : IKubernetesObject<V1ListMeta>, IItems<V1beta1EventHub>
{
    ...
    public string ApiVersion { get; set; } = "eventhub.azure.m.upbound.io/v1beta1";
...
public partial class V1beta1EventHubSpecForProvider
{
    ...
    public V1beta1EventHubSpecForProviderRetentionDescription? RetentionDescription { get; set; }
...
public partial class V1beta1EventHubSpecInitProvider
{
    ...
    /// <summary>A retention_description block as defined below.</summary>
    [JsonPropertyName("retentionDescription")]
    public V1beta1EventHubSpecInitProviderRetentionDescription? RetentionDescription { get; set; }
...
public partial class V1beta1EventHubStatusAtProvider
{
    ...
    /// <summary>A retention_description block as defined below.</summary>
    [JsonPropertyName("retentionDescription")]
    public V1beta1EventHubStatusAtProviderRetentionDescription? RetentionDescription { get; set; }
