...
public partial class V1beta1AccountRaiPolicyList : IKubernetesObject<V1ListMeta>, IItems<V1beta1AccountRaiPolicy>
{
    ...
    public const string KubeKind = "AccountRaiPolicyList";
    public const string KubeGroup = "cognitiveservices.azure.upbound.io";
    public const string KubePluralName = "accountraipolicies";
    ...
    public string Kind { get; set; } = "AccountRaiPolicyList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1AccountRaiPolicy objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1AccountRaiPolicy> Items { get; set; }
}
...
public partial class V1beta1AccountRaiPolicySpecForProviderCognitiveAccountIdRefPolicy
{
    ...
    public V1beta1AccountRaiPolicySpecForProviderCognitiveAccountIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1AccountRaiPolicySpecForProviderCognitiveAccountIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1AccountRaiPolicySpecForProviderCognitiveAccountIdRef
{
    ...
    public V1beta1AccountRaiPolicySpecForProviderCognitiveAccountIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1AccountRaiPolicySpecForProviderCognitiveAccountIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1AccountRaiPolicySpecForProviderCognitiveAccountIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1AccountRaiPolicySpecForProviderCognitiveAccountIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>Whether the filter should block content. Possible values are true or false.</summary>
    [JsonPropertyName("blockEnabled")]
    public bool? BlockEnabled { get; set; }

    /// <summary>Whether the filter is enabled. Possible values are true or false.</summary>
    ...
    /// <summary>The severity threshold for the filter. Possible values are Low, Medium or High.</summary>
    [JsonPropertyName("severityThreshold")]
    public string? SeverityThreshold { get; set; }

    /// <summary>Content source to apply the content filter. Possible values are Prompt or Completion.</summary>
...
{
    /// <summary>The name of the base policy to use for this RAI Policy. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("basePolicyName")]
    public string? BasePolicyName { get; set; }

    /// <summary>The ID of the Cognitive Service Account to which this RAI Policy should be associated. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("cognitiveAccountId")]
    public string? CognitiveAccountId { get; set; }

    /// <summary>Reference to a Account in cognitiveservices to populate cognitiveAccountId.</summary>
    [JsonPropertyName("cognitiveAccountIdRef")]
    public V1beta1AccountRaiPolicySpecForProviderCognitiveAccountIdRef? CognitiveAccountIdRef { get; set; }

    /// <summary>Selector for a Account in cognitiveservices to populate cognitiveAccountId.</summary>
    [JsonPropertyName("cognitiveAccountIdSelector")]
    public V1beta1AccountRaiPolicySpecForProviderCognitiveAccountIdSelector? CognitiveAccountIdSelector { get; set; }

    /// <summary>A content_filter block as defined below.</summary>
    [JsonPropertyName("contentFilter")]
    public IList<V1beta1AccountRaiPolicySpecForProviderContentFilter>? ContentFilter { get; set; }

    /// <summary>The mode of the RAI Policy. Possible values are Default, Deferred, Blocking or Asynchronous_filter.</summary>
...
public partial class V1beta1AccountRaiPolicySpecInitProvider
{
    ...
    /// <summary>A content_filter block as defined below.</summary>
    [JsonPropertyName("contentFilter")]
    public IList<V1beta1AccountRaiPolicySpecInitProviderContentFilter>? ContentFilter { get; set; }
...
public partial class V1beta1AccountRaiPolicySpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1AccountRaiPolicySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1AccountRaiPolicySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1AccountRaiPolicySpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1AccountRaiPolicySpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1AccountRaiPolicySpec
{
    ...
    public V1beta1AccountRaiPolicySpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1AccountRaiPolicySpecForProvider ForProvider { get; set; }
    ...
    public V1beta1AccountRaiPolicySpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1AccountRaiPolicySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1AccountRaiPolicySpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1AccountRaiPolicyStatusAtProvider
{
    ...
    /// <summary>A content_filter block as defined below.</summary>
    [JsonPropertyName("contentFilter")]
    public IList<V1beta1AccountRaiPolicyStatusAtProviderContentFilter>? ContentFilter { get; set; }

    /// <summary>The ID of the Cognitive Service Account RAI Policy.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1AccountRaiPolicyStatus
{
    ...
    public V1beta1AccountRaiPolicyStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1AccountRaiPolicyStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "AccountRaiPolicy";
    public const string KubeGroup = "cognitiveservices.azure.upbound.io";
    public const string KubePluralName = "accountraipolicies";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "AccountRaiPolicy";
    ...
    public required V1beta1AccountRaiPolicySpec Spec { get; set; }

    /// <summary>AccountRaiPolicyStatus defines the observed state of AccountRaiPolicy.</summary>
    [JsonPropertyName("status")]
    public V1beta1AccountRaiPolicyStatus? Status { get; set; }
}