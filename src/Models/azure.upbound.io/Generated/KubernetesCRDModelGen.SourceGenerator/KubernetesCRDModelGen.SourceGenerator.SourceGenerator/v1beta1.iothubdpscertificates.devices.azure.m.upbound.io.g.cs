...
public partial class V1beta1IOTHubDPSCertificateList : IKubernetesObject<V1ListMeta>, IItems<V1beta1IOTHubDPSCertificate>
{
    ...
    public string Kind { get; set; } = "IOTHubDPSCertificateList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1IOTHubDPSCertificate objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1IOTHubDPSCertificate> Items { get; set; }
}
...
public partial class V1beta1IOTHubDPSCertificateSpecInitProvider
{
    /// <summary>The Base-64 representation of the X509 leaf certificate .cer file or just a .pem file content.</summary>
    [JsonPropertyName("certificateContentSecretRef")]
    public required V1beta1IOTHubDPSCertificateSpecInitProviderCertificateContentSecretRef CertificateContentSecretRef { get; set; }
...
public partial class V1beta1IOTHubDPSCertificateSpec
{
    ...
    public required V1beta1IOTHubDPSCertificateSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1IOTHubDPSCertificate : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1IOTHubDPSCertificateSpec>, IStatus<V1beta1IOTHubDPSCertificateStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "IOTHubDPSCertificate";
    ...
    public required V1beta1IOTHubDPSCertificateSpec Spec { get; set; }
