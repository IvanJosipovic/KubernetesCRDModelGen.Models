...
public partial class V1beta2SynapseSparkList : IKubernetesObject<V1ListMeta>, IItems<V1beta2SynapseSpark>
{
    ...
    public string Kind { get; set; } = "SynapseSparkList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta2SynapseSpark objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta2SynapseSpark> Items { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdRefPolicy
{
    ...
    public V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdRef
{
    ...
    public V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecForProviderSynapseSparkPoolIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2SynapseSparkSpecForProviderSynapseSparkPoolIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2SynapseSparkSpecForProviderSynapseSparkPoolIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecForProviderSynapseSparkPoolIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2SynapseSparkSpecForProviderSynapseSparkPoolIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecForProviderSynapseSparkPoolIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2SynapseSparkSpecForProviderSynapseSparkPoolIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2SynapseSparkSpecForProviderSynapseSparkPoolIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecForProvider
{
    ...
    public V1beta2SynapseSparkSpecForProviderIdentity? Identity { get; set; }
    ...
    public V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdRef? MachineLearningWorkspaceIdRef { get; set; }

    /// <summary>Selector for a Workspace in machinelearningservices to populate machineLearningWorkspaceId.</summary>
    [JsonPropertyName("machineLearningWorkspaceIdSelector")]
    public V1beta2SynapseSparkSpecForProviderMachineLearningWorkspaceIdSelector? MachineLearningWorkspaceIdSelector { get; set; }
    ...
    public V1beta2SynapseSparkSpecForProviderSynapseSparkPoolIdRef? SynapseSparkPoolIdRef { get; set; }

    /// <summary>Selector for a SparkPool in synapse to populate synapseSparkPoolId.</summary>
    [JsonPropertyName("synapseSparkPoolIdSelector")]
    public V1beta2SynapseSparkSpecForProviderSynapseSparkPoolIdSelector? SynapseSparkPoolIdSelector { get; set; }
...
public partial class V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecInitProvider
{
    ...
    /// <summary>An identity block as defined below. Changing this forces a new Machine Learning Synapse Spark to be created.</summary>
    [JsonPropertyName("identity")]
    public V1beta2SynapseSparkSpecInitProviderIdentity? Identity { get; set; }
    ...
    /// <summary>Reference to a SparkPool in synapse to populate synapseSparkPoolId.</summary>
    [JsonPropertyName("synapseSparkPoolIdRef")]
    public V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdRef? SynapseSparkPoolIdRef { get; set; }

    /// <summary>Selector for a SparkPool in synapse to populate synapseSparkPoolId.</summary>
    [JsonPropertyName("synapseSparkPoolIdSelector")]
    public V1beta2SynapseSparkSpecInitProviderSynapseSparkPoolIdSelector? SynapseSparkPoolIdSelector { get; set; }
...
public partial class V1beta2SynapseSparkSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2SynapseSparkSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2SynapseSparkSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2SynapseSparkSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2SynapseSparkSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2SynapseSparkSpec
{
    ...
    public V1beta2SynapseSparkSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta2SynapseSparkSpecForProvider ForProvider { get; set; }
    ...
    public V1beta2SynapseSparkSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta2SynapseSparkSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta2SynapseSparkSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1beta2SynapseSparkSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta2SynapseSparkStatusAtProvider
{
    ...
    /// <summary>An identity block as defined below. Changing this forces a new Machine Learning Synapse Spark to be created.</summary>
    [JsonPropertyName("identity")]
    public V1beta2SynapseSparkStatusAtProviderIdentity? Identity { get; set; }
...
public partial class V1beta2SynapseSparkStatus
{
    ...
    public V1beta2SynapseSparkStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta2SynapseSparkStatusConditions>? Conditions { get; set; }
...
public partial class V1beta2SynapseSpark : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta2SynapseSparkSpec>, IStatus<V1beta2SynapseSparkStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "SynapseSpark";
    ...
    public required V1beta2SynapseSparkSpec Spec { get; set; }

    /// <summary>SynapseSparkStatus defines the observed state of SynapseSpark.</summary>
    [JsonPropertyName("status")]
    public V1beta2SynapseSparkStatus? Status { get; set; }
}