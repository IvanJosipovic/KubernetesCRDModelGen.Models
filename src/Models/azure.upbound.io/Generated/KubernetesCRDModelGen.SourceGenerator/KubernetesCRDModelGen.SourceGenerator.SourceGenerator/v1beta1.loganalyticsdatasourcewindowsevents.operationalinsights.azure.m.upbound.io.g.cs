...
public partial class V1beta1LogAnalyticsDataSourceWindowsEventList : IKubernetesObject<V1ListMeta>, IItems<V1beta1LogAnalyticsDataSourceWindowsEvent>
{
    ...
    public string Kind { get; set; } = "LogAnalyticsDataSourceWindowsEventList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1LogAnalyticsDataSourceWindowsEvent objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1LogAnalyticsDataSourceWindowsEvent> Items { get; set; }
}
...
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpec
{
    ...
    public required V1beta1LogAnalyticsDataSourceWindowsEventSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1LogAnalyticsDataSourceWindowsEvent : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1LogAnalyticsDataSourceWindowsEventSpec>, IStatus<V1beta1LogAnalyticsDataSourceWindowsEventStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "LogAnalyticsDataSourceWindowsEvent";
    ...
    public required V1beta1LogAnalyticsDataSourceWindowsEventSpec Spec { get; set; }
