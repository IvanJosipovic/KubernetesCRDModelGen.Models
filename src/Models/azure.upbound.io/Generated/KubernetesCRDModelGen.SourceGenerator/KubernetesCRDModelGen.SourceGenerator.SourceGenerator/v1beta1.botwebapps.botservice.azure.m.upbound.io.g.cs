...
public partial class V1beta1BotWebAppList : IKubernetesObject<V1ListMeta>, IItems<V1beta1BotWebApp>
{
    ...
    public string Kind { get; set; } = "BotWebAppList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1BotWebApp objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1BotWebApp> Items { get; set; }
}
...
public partial class V1beta1BotWebAppSpecForProvider
{
    ...
    /// <summary>The Microsoft Application Type for the Bot Channels Registration. Possible values are MultiTenant, SingleTenant and UserAssignedMSI. Defaults to MultiTenant. Changing this forces a new resource to be created.</summary>
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1BotWebAppSpecManagementPoliciesEnum>))]
...
public partial class V1beta1BotWebAppSpec
{
    ...
    public required V1beta1BotWebAppSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1BotWebApp : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1BotWebAppSpec>, IStatus<V1beta1BotWebAppStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "BotWebApp";
    ...
    public required V1beta1BotWebAppSpec Spec { get; set; }
