...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointList : IKubernetesObject<V1ListMeta>, IItems<V1beta1WorkspaceOutboundRulePrivateEndpoint>
{
    ...
    public const string KubeKind = "WorkspaceOutboundRulePrivateEndpointList";
    public const string KubeGroup = "machinelearningservices.azure.upbound.io";
    public const string KubePluralName = "workspaceoutboundruleprivateendpoints";
    ...
    public string Kind { get; set; } = "WorkspaceOutboundRulePrivateEndpointList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1WorkspaceOutboundRulePrivateEndpointSpecDeletionPolicyEnum>))]
public enum V1beta1WorkspaceOutboundRulePrivateEndpointSpecDeletionPolicyEnum
{
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdRefPolicy
{
    ...
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdRef
{
    ...
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderWorkspaceIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderWorkspaceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderWorkspaceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderWorkspaceIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderWorkspaceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderWorkspaceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderWorkspaceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderWorkspaceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>Specifies the Service Resource ID to connect. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("serviceResourceId")]
    public string? ServiceResourceId { get; set; }

    /// <summary>Reference to a Account in storage to populate serviceResourceId.</summary>
    [JsonPropertyName("serviceResourceIdRef")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdRef? ServiceResourceIdRef { get; set; }

    /// <summary>Selector for a Account in storage to populate serviceResourceId.</summary>
    [JsonPropertyName("serviceResourceIdSelector")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderServiceResourceIdSelector? ServiceResourceIdSelector { get; set; }

    /// <summary>Whether to enable an additional private endpoint to be used by jobs running on Spark. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("sparkEnabled")]
    public bool? SparkEnabled { get; set; }

    /// <summary>Specifies the Sub Resource of the service resource to connect to. Possible values are vault,amlworkspace,blob,table,queue,file,web,dfs, redisCache. Changing this forces a new resource to be created.</summary>
    ...
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderWorkspaceIdRef? WorkspaceIdRef { get; set; }

    /// <summary>Selector for a Workspace in machinelearningservices to populate workspaceId.</summary>
    [JsonPropertyName("workspaceIdSelector")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProviderWorkspaceIdSelector? WorkspaceIdSelector { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProvider
{
    ...
    /// <summary>Reference to a Account in storage to populate serviceResourceId.</summary>
    [JsonPropertyName("serviceResourceIdRef")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdRef? ServiceResourceIdRef { get; set; }

    /// <summary>Selector for a Account in storage to populate serviceResourceId.</summary>
    [JsonPropertyName("serviceResourceIdSelector")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProviderServiceResourceIdSelector? ServiceResourceIdSelector { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1WorkspaceOutboundRulePrivateEndpointSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1WorkspaceOutboundRulePrivateEndpointSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1WorkspaceOutboundRulePrivateEndpointSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1WorkspaceOutboundRulePrivateEndpointSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointSpec
{
    ...
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1WorkspaceOutboundRulePrivateEndpointSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1WorkspaceOutboundRulePrivateEndpointSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1WorkspaceOutboundRulePrivateEndpointSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
{
    /// <summary>The ID of the Machine Learning Workspace Network Outbound Rule Private Endpoint.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1WorkspaceOutboundRulePrivateEndpointStatus
{
    ...
    public V1beta1WorkspaceOutboundRulePrivateEndpointStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1WorkspaceOutboundRulePrivateEndpointStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "WorkspaceOutboundRulePrivateEndpoint";
    public const string KubeGroup = "machinelearningservices.azure.upbound.io";
    public const string KubePluralName = "workspaceoutboundruleprivateendpoints";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "WorkspaceOutboundRulePrivateEndpoint";
    ...
    public required V1beta1WorkspaceOutboundRulePrivateEndpointSpec Spec { get; set; }

    /// <summary>WorkspaceOutboundRulePrivateEndpointStatus defines the observed state of WorkspaceOutboundRulePrivateEndpoint.</summary>
    [JsonPropertyName("status")]
    public V1beta1WorkspaceOutboundRulePrivateEndpointStatus? Status { get; set; }
}