...
public partial class V1beta1BotChannelMSTeamsList : IKubernetesObject<V1ListMeta>, IItems<V1beta1BotChannelMSTeams>
{
    ...
    public string Kind { get; set; } = "BotChannelMSTeamsList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1BotChannelMSTeams objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1BotChannelMSTeams> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1BotChannelMSTeamsSpecManagementPoliciesEnum>))]
...
public partial class V1beta1BotChannelMSTeamsSpec
{
    ...
    public required V1beta1BotChannelMSTeamsSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1BotChannelMSTeams : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1BotChannelMSTeamsSpec>, IStatus<V1beta1BotChannelMSTeamsStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "BotChannelMSTeams";
    ...
    public required V1beta1BotChannelMSTeamsSpec Spec { get; set; }
