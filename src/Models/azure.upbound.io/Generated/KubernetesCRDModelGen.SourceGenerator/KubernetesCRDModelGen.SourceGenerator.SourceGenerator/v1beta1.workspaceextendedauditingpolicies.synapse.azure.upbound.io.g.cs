...
public partial class V1beta1WorkspaceExtendedAuditingPolicyList : IKubernetesObject<V1ListMeta>, IItems<V1beta1WorkspaceExtendedAuditingPolicy>
{
    ...
    public string Kind { get; set; } = "WorkspaceExtendedAuditingPolicyList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1WorkspaceExtendedAuditingPolicy objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1WorkspaceExtendedAuditingPolicy> Items { get; set; }
}
...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpec
{
    ...
    public required V1beta1WorkspaceExtendedAuditingPolicySpecForProvider ForProvider { get; set; }
...
public partial class V1beta1WorkspaceExtendedAuditingPolicy : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1WorkspaceExtendedAuditingPolicySpec>, IStatus<V1beta1WorkspaceExtendedAuditingPolicyStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "WorkspaceExtendedAuditingPolicy";
    ...
    public required V1beta1WorkspaceExtendedAuditingPolicySpec Spec { get; set; }
