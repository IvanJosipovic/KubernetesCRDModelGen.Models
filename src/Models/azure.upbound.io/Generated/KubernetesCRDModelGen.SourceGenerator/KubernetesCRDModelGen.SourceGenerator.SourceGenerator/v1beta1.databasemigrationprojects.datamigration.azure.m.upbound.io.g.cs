...
public partial class V1beta1DatabaseMigrationProjectList : IKubernetesObject<V1ListMeta>, IItems<V1beta1DatabaseMigrationProject>
{
    ...
    public string ApiVersion { get; set; } = "datamigration.azure.m.upbound.io/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DatabaseMigrationProjectList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1DatabaseMigrationProject objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1DatabaseMigrationProject> Items { get; set; }
}
...
public partial class V1beta1DatabaseMigrationProjectSpecForProvider
{
    ...
    /// <summary>The platform type of the migration source. Possible values are MongoDb, MySQL, PostgreSql, SQL and Unknown. Changing this forces a new resource to be created.</summary>
    ...
    /// <summary>The platform type of the migration target. Possible values are AzureDbForMySql, AzureDbForPostgreSql, MongoDb, SQLDB, SQLMI and Unknown. Changing this forces a new resource to be created.</summary>
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1DatabaseMigrationProjectSpecManagementPoliciesEnum>))]
...
public partial class V1beta1DatabaseMigrationProjectSpec
{
    ...
    public required V1beta1DatabaseMigrationProjectSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1DatabaseMigrationProject : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1DatabaseMigrationProjectSpec>, IStatus<V1beta1DatabaseMigrationProjectStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DatabaseMigrationProject";
    ...
    public required V1beta1DatabaseMigrationProjectSpec Spec { get; set; }
