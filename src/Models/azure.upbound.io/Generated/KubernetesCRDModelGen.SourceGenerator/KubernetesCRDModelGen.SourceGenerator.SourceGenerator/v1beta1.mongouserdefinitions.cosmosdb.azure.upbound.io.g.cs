...
public partial class V1beta1MongoUserDefinitionList : IKubernetesObject<V1ListMeta>, IItems<V1beta1MongoUserDefinition>
{
    ...
    public string Kind { get; set; } = "MongoUserDefinitionList";
...
public partial class V1beta1MongoUserDefinitionSpecForProviderCosmosMongoDatabaseIdRefPolicy
{
    ...
    public V1beta1MongoUserDefinitionSpecForProviderCosmosMongoDatabaseIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1MongoUserDefinitionSpecForProviderCosmosMongoDatabaseIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1MongoUserDefinitionSpecForProviderCosmosMongoDatabaseIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1MongoUserDefinitionSpecForProviderCosmosMongoDatabaseIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1MongoUserDefinitionSpecForProviderCosmosMongoDatabaseIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1MongoUserDefinitionSpecInitProviderCosmosMongoDatabaseIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1MongoUserDefinitionSpecInitProviderCosmosMongoDatabaseIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1MongoUserDefinitionSpecInitProviderCosmosMongoDatabaseIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1MongoUserDefinitionSpecInitProviderCosmosMongoDatabaseIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1MongoUserDefinitionSpecInitProviderCosmosMongoDatabaseIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1MongoUserDefinitionSpecInitProviderCosmosMongoDatabaseIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1MongoUserDefinitionSpecInitProvider
{
    ...
    /// <summary>The password for the Mongo User Definition.</summary>
    [JsonPropertyName("passwordSecretRef")]
    public required V1beta1MongoUserDefinitionSpecInitProviderPasswordSecretRef PasswordSecretRef { get; set; }
}
...
public partial class V1beta1MongoUserDefinitionSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1MongoUserDefinitionSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1MongoUserDefinitionSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1MongoUserDefinitionSpec
{
    ...
    public V1beta1MongoUserDefinitionSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1MongoUserDefinitionSpecForProvider ForProvider { get; set; }
    ...
    public IList<V1beta1MongoUserDefinitionSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
...
public partial class V1beta1MongoUserDefinition : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1MongoUserDefinitionSpec>, IStatus<V1beta1MongoUserDefinitionStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "MongoUserDefinition";
    ...
    public required V1beta1MongoUserDefinitionSpec Spec { get; set; }
