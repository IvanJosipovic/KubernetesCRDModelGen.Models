...
public partial class V1beta2GlobalVMShutdownScheduleList : IKubernetesObject<V1ListMeta>, IItems<V1beta2GlobalVMShutdownSchedule>
{
    ...
    public string Kind { get; set; } = "GlobalVMShutdownScheduleList";
...
public partial class V1beta2GlobalVMShutdownScheduleSpecForProviderVirtualMachineIdRefPolicy
{
    ...
    public V1beta2GlobalVMShutdownScheduleSpecForProviderVirtualMachineIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta2GlobalVMShutdownScheduleSpecForProviderVirtualMachineIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpecForProviderVirtualMachineIdRef
{
    ...
    public V1beta2GlobalVMShutdownScheduleSpecForProviderVirtualMachineIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpecForProviderVirtualMachineIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2GlobalVMShutdownScheduleSpecForProviderVirtualMachineIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2GlobalVMShutdownScheduleSpecForProviderVirtualMachineIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpecForProvider
{
    ...
    public V1beta2GlobalVMShutdownScheduleSpecForProviderNotificationSettings? NotificationSettings { get; set; }
    ...
    public V1beta2GlobalVMShutdownScheduleSpecForProviderVirtualMachineIdRef? VirtualMachineIdRef { get; set; }

    /// <summary>Selector for a LinuxVirtualMachine in compute to populate virtualMachineId.</summary>
    [JsonPropertyName("virtualMachineIdSelector")]
    public V1beta2GlobalVMShutdownScheduleSpecForProviderVirtualMachineIdSelector? VirtualMachineIdSelector { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpecInitProvider
{
    ...
    /// <summary>The notification setting of a schedule. A notification_settings block as defined below.</summary>
    [JsonPropertyName("notificationSettings")]
    public V1beta2GlobalVMShutdownScheduleSpecInitProviderNotificationSettings? NotificationSettings { get; set; }
    ...
    /// <summary>Reference to a LinuxVirtualMachine in compute to populate virtualMachineId.</summary>
    [JsonPropertyName("virtualMachineIdRef")]
    public V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdRef? VirtualMachineIdRef { get; set; }

    /// <summary>Selector for a LinuxVirtualMachine in compute to populate virtualMachineId.</summary>
    [JsonPropertyName("virtualMachineIdSelector")]
    public V1beta2GlobalVMShutdownScheduleSpecInitProviderVirtualMachineIdSelector? VirtualMachineIdSelector { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2GlobalVMShutdownScheduleSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2GlobalVMShutdownScheduleSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2GlobalVMShutdownScheduleSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleSpec
{
    ...
    public V1beta2GlobalVMShutdownScheduleSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta2GlobalVMShutdownScheduleSpecForProvider ForProvider { get; set; }
    ...
    public V1beta2GlobalVMShutdownScheduleSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta2GlobalVMShutdownScheduleSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta2GlobalVMShutdownScheduleSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1beta2GlobalVMShutdownScheduleSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta2GlobalVMShutdownScheduleStatusAtProvider
{
    ...
    /// <summary>The notification setting of a schedule. A notification_settings block as defined below.</summary>
    [JsonPropertyName("notificationSettings")]
    public V1beta2GlobalVMShutdownScheduleStatusAtProviderNotificationSettings? NotificationSettings { get; set; }
...
public partial class V1beta2GlobalVMShutdownScheduleStatus
{
    ...
    public V1beta2GlobalVMShutdownScheduleStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta2GlobalVMShutdownScheduleStatusConditions>? Conditions { get; set; }
...
public partial class V1beta2GlobalVMShutdownSchedule : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta2GlobalVMShutdownScheduleSpec>, IStatus<V1beta2GlobalVMShutdownScheduleStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "GlobalVMShutdownSchedule";
    ...
    public required V1beta2GlobalVMShutdownScheduleSpec Spec { get; set; }

    /// <summary>GlobalVMShutdownScheduleStatus defines the observed state of GlobalVMShutdownSchedule.</summary>
    [JsonPropertyName("status")]
    public V1beta2GlobalVMShutdownScheduleStatus? Status { get; set; }
}