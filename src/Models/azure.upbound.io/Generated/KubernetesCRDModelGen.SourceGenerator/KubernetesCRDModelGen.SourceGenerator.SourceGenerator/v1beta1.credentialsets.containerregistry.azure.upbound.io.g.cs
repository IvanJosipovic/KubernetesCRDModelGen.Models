...
public partial class V1beta1CredentialSetList : IKubernetesObject<V1ListMeta>, IItems<V1beta1CredentialSet>
{
    ...
    public const string KubeKind = "CredentialSetList";
    public const string KubeGroup = "containerregistry.azure.upbound.io";
    public const string KubePluralName = "credentialsets";
    ...
    public string Kind { get; set; } = "CredentialSetList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1CredentialSet objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1CredentialSet> Items { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdRefPolicy
{
    ...
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdRef
{
    ...
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdSelectorPolicy? Policy { get; set; }
}
...
{
    /// <summary>The URI of the secret containing the password in a Key Vault.</summary>
    [JsonPropertyName("passwordSecretId")]
    public string? PasswordSecretId { get; set; }

    /// <summary>Reference to a Secret in keyvault to populate passwordSecretId.</summary>
    [JsonPropertyName("passwordSecretIdRef")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdRef? PasswordSecretIdRef { get; set; }

    /// <summary>Selector for a Secret in keyvault to populate passwordSecretId.</summary>
    [JsonPropertyName("passwordSecretIdSelector")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsPasswordSecretIdSelector? PasswordSecretIdSelector { get; set; }

    /// <summary>The URI of the secret containing the username in a Key Vault.</summary>
    [JsonPropertyName("usernameSecretId")]
    public string? UsernameSecretId { get; set; }

    /// <summary>Reference to a Secret in keyvault to populate usernameSecretId.</summary>
    [JsonPropertyName("usernameSecretIdRef")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdRef? UsernameSecretIdRef { get; set; }

    /// <summary>Selector for a Secret in keyvault to populate usernameSecretId.</summary>
    [JsonPropertyName("usernameSecretIdSelector")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentialsUsernameSecretIdSelector? UsernameSecretIdSelector { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderContainerRegistryIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1CredentialSetSpecForProviderContainerRegistryIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1CredentialSetSpecForProviderContainerRegistryIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderContainerRegistryIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CredentialSetSpecForProviderContainerRegistryIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderContainerRegistryIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1CredentialSetSpecForProviderContainerRegistryIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1CredentialSetSpecForProviderContainerRegistryIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecForProviderContainerRegistryIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CredentialSetSpecForProviderContainerRegistryIdSelectorPolicy? Policy { get; set; }
}
...
{
    /// <summary>The type of Managed Service Identity that is configured on for the Container Registry Credential Set. Currently the only possible value is SystemAssigned.</summary>
...
{
    /// <summary>A authentication_credentials block as defined below.</summary>
    [JsonPropertyName("authenticationCredentials")]
    public V1beta1CredentialSetSpecForProviderAuthenticationCredentials? AuthenticationCredentials { get; set; }

    /// <summary>The ID of the Container Registry. Changing this forces a new Container Registry Credential Set to be created.</summary>
    [JsonPropertyName("containerRegistryId")]
    public string? ContainerRegistryId { get; set; }

    /// <summary>Reference to a Registry in containerregistry to populate containerRegistryId.</summary>
    [JsonPropertyName("containerRegistryIdRef")]
    public V1beta1CredentialSetSpecForProviderContainerRegistryIdRef? ContainerRegistryIdRef { get; set; }

    /// <summary>Selector for a Registry in containerregistry to populate containerRegistryId.</summary>
    [JsonPropertyName("containerRegistryIdSelector")]
    public V1beta1CredentialSetSpecForProviderContainerRegistryIdSelector? ContainerRegistryIdSelector { get; set; }

    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1CredentialSetSpecForProviderIdentity? Identity { get; set; }

    /// <summary>The login server for the Credential Set. Changing this forces a new Container Registry Credential Set to be created.</summary>
...
public partial class V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1CredentialSetSpecInitProviderAuthenticationCredentials
{
    ...
    /// <summary>Reference to a Secret in keyvault to populate passwordSecretId.</summary>
    [JsonPropertyName("passwordSecretIdRef")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdRef? PasswordSecretIdRef { get; set; }

    /// <summary>Selector for a Secret in keyvault to populate passwordSecretId.</summary>
    [JsonPropertyName("passwordSecretIdSelector")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsPasswordSecretIdSelector? PasswordSecretIdSelector { get; set; }
    ...
    /// <summary>Reference to a Secret in keyvault to populate usernameSecretId.</summary>
    [JsonPropertyName("usernameSecretIdRef")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdRef? UsernameSecretIdRef { get; set; }

    /// <summary>Selector for a Secret in keyvault to populate usernameSecretId.</summary>
    [JsonPropertyName("usernameSecretIdSelector")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentialsUsernameSecretIdSelector? UsernameSecretIdSelector { get; set; }
}
...
public partial class V1beta1CredentialSetSpecInitProvider
{
    /// <summary>A authentication_credentials block as defined below.</summary>
    [JsonPropertyName("authenticationCredentials")]
    public V1beta1CredentialSetSpecInitProviderAuthenticationCredentials? AuthenticationCredentials { get; set; }

    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1CredentialSetSpecInitProviderIdentity? Identity { get; set; }
...
public partial class V1beta1CredentialSetSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1CredentialSetSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1CredentialSetSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CredentialSetSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CredentialSetSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1CredentialSetSpec
{
    ...
    public V1beta1CredentialSetSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1CredentialSetSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1CredentialSetSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1CredentialSetSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1CredentialSetSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1beta1CredentialSetSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta1CredentialSetStatusAtProvider
{
    /// <summary>A authentication_credentials block as defined below.</summary>
    [JsonPropertyName("authenticationCredentials")]
    public V1beta1CredentialSetStatusAtProviderAuthenticationCredentials? AuthenticationCredentials { get; set; }

    /// <summary>The ID of the Container Registry. Changing this forces a new Container Registry Credential Set to be created.</summary>
    [JsonPropertyName("containerRegistryId")]
    public string? ContainerRegistryId { get; set; }

    /// <summary>The ID of the Container Registry Credential Set.</summary>
    [JsonPropertyName("id")]
    public string? Id { get; set; }

    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1CredentialSetStatusAtProviderIdentity? Identity { get; set; }
...
public partial class V1beta1CredentialSetStatus
{
    ...
    public V1beta1CredentialSetStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1CredentialSetStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "CredentialSet";
    public const string KubeGroup = "containerregistry.azure.upbound.io";
    public const string KubePluralName = "credentialsets";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CredentialSet";
    ...
    public required V1beta1CredentialSetSpec Spec { get; set; }

    /// <summary>CredentialSetStatus defines the observed state of CredentialSet.</summary>
    [JsonPropertyName("status")]
    public V1beta1CredentialSetStatus? Status { get; set; }
}