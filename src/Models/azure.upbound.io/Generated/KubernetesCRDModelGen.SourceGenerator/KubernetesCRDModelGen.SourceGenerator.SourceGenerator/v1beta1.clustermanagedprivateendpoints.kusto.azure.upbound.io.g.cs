...
public partial class V1beta1ClusterManagedPrivateEndpointList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ClusterManagedPrivateEndpoint>
{
    ...
    public string Kind { get; set; } = "ClusterManagedPrivateEndpointList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ClusterManagedPrivateEndpoint objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ClusterManagedPrivateEndpoint> Items { get; set; }
}
...
public partial class V1beta1ClusterManagedPrivateEndpointSpec
{
    ...
    public required V1beta1ClusterManagedPrivateEndpointSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1ClusterManagedPrivateEndpointStatusAtProvider
{
    ...
    /// <summary>The ID of the Managed Private Endpoint for a Kusto Cluster.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1ClusterManagedPrivateEndpoint : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ClusterManagedPrivateEndpointSpec>, IStatus<V1beta1ClusterManagedPrivateEndpointStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ClusterManagedPrivateEndpoint";
    ...
    public required V1beta1ClusterManagedPrivateEndpointSpec Spec { get; set; }
