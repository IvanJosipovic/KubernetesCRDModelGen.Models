...
public partial class V1beta1BackupInstanceDiskList : IKubernetesObject<V1ListMeta>, IItems<V1beta1BackupInstanceDisk>
{
    ...
    public string Kind { get; set; } = "BackupInstanceDiskList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1BackupInstanceDisk objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1BackupInstanceDisk> Items { get; set; }
}
...
public partial class V1beta1BackupInstanceDiskSpecForProvider
{
    ...
    /// <summary>The subscription ID of the Resource Group where snapshots are stored. The default value is the subscription ID of the Backup Vault. Changing this forces a new Backup Instance Disk to be created.</summary>
    [JsonPropertyName("snapshotSubscriptionId")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1BackupInstanceDiskSpecManagementPoliciesEnum>))]
...
public partial class V1beta1BackupInstanceDiskSpec
{
    ...
    public required V1beta1BackupInstanceDiskSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1BackupInstanceDiskStatusAtProvider
{
    ...
    /// <summary>The protection state of the Backup Instance Disk.</summary>
...
public partial class V1beta1BackupInstanceDisk : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1BackupInstanceDiskSpec>, IStatus<V1beta1BackupInstanceDiskStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "BackupInstanceDisk";
    ...
    public required V1beta1BackupInstanceDiskSpec Spec { get; set; }
