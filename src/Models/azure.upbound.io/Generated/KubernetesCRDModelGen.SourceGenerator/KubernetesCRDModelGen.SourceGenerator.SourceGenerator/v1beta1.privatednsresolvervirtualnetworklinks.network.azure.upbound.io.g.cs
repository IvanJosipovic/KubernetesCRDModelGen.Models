...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkList : IKubernetesObject<V1ListMeta>, IItems<V1beta1PrivateDNSResolverVirtualNetworkLink>
{
    ...
    public const string KubeKind = "PrivateDNSResolverVirtualNetworkLinkList";
    public const string KubeGroup = "network.azure.upbound.io";
    public const string KubePluralName = "privatednsresolvervirtualnetworklinks";
    ...
    public string Kind { get; set; } = "PrivateDNSResolverVirtualNetworkLinkList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1PrivateDNSResolverVirtualNetworkLink objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1PrivateDNSResolverVirtualNetworkLink> Items { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdRefPolicy
{
    ...
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdRef
{
    ...
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderVirtualNetworkIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderVirtualNetworkIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderVirtualNetworkIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderVirtualNetworkIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderVirtualNetworkIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderVirtualNetworkIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderVirtualNetworkIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderVirtualNetworkIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>Specifies the ID of the Private DNS Resolver DNS Forwarding Ruleset. Changing this forces a new Private DNS Resolver Virtual Network Link to be created.</summary>
    ...
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdRef? DnsForwardingRulesetIdRef { get; set; }

    /// <summary>Selector for a PrivateDNSResolverDNSForwardingRuleset in network to populate dnsForwardingRulesetId.</summary>
    [JsonPropertyName("dnsForwardingRulesetIdSelector")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderDnsForwardingRulesetIdSelector? DnsForwardingRulesetIdSelector { get; set; }

    /// <summary>Metadata attached to the Private DNS Resolver Virtual Network Link.</summary>
    [JsonPropertyName("metadata")]
    public IDictionary<string, string>? Metadata { get; set; }

    /// <summary>The ID of the Virtual Network that is linked to the Private DNS Resolver Virtual Network Link. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("virtualNetworkId")]
    public string? VirtualNetworkId { get; set; }

    /// <summary>Reference to a VirtualNetwork in network to populate virtualNetworkId.</summary>
    [JsonPropertyName("virtualNetworkIdRef")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderVirtualNetworkIdRef? VirtualNetworkIdRef { get; set; }

    /// <summary>Selector for a VirtualNetwork in network to populate virtualNetworkId.</summary>
    [JsonPropertyName("virtualNetworkIdSelector")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProviderVirtualNetworkIdSelector? VirtualNetworkIdSelector { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProvider
{
    ...
    /// <summary>Reference to a VirtualNetwork in network to populate virtualNetworkId.</summary>
    [JsonPropertyName("virtualNetworkIdRef")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdRef? VirtualNetworkIdRef { get; set; }

    /// <summary>Selector for a VirtualNetwork in network to populate virtualNetworkId.</summary>
    [JsonPropertyName("virtualNetworkIdSelector")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProviderVirtualNetworkIdSelector? VirtualNetworkIdSelector { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkSpec
{
    ...
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1PrivateDNSResolverVirtualNetworkLinkSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1PrivateDNSResolverVirtualNetworkLinkSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1PrivateDNSResolverVirtualNetworkLinkSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkStatusAtProvider
{
    ...
    /// <summary>The ID of the Private DNS Resolver Virtual Network Link.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1PrivateDNSResolverVirtualNetworkLinkStatus
{
    ...
    public V1beta1PrivateDNSResolverVirtualNetworkLinkStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1PrivateDNSResolverVirtualNetworkLinkStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "PrivateDNSResolverVirtualNetworkLink";
    public const string KubeGroup = "network.azure.upbound.io";
    public const string KubePluralName = "privatednsresolvervirtualnetworklinks";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PrivateDNSResolverVirtualNetworkLink";
    ...
    public required V1beta1PrivateDNSResolverVirtualNetworkLinkSpec Spec { get; set; }

    /// <summary>PrivateDNSResolverVirtualNetworkLinkStatus defines the observed state of PrivateDNSResolverVirtualNetworkLink.</summary>
    [JsonPropertyName("status")]
    public V1beta1PrivateDNSResolverVirtualNetworkLinkStatus? Status { get; set; }
}