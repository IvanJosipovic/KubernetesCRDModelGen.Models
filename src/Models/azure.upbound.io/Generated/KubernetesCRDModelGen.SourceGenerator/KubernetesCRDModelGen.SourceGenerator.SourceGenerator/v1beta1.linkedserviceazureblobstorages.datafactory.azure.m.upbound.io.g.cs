...
public partial class V1beta1LinkedServiceAzureBlobStorageSpecForProvider
{
    ...
    public V1beta1LinkedServiceAzureBlobStorageSpecForProviderSasTokenLinkedKeyVaultKey? SasTokenLinkedKeyVaultKey { get; set; }
...
public partial class V1beta1LinkedServiceAzureBlobStorageSpecInitProvider
{
    ...
    /// <summary>A sas_token_linked_key_vault_key block as defined below. Use this argument to store SAS Token in an existing Key Vault. It needs an existing Key Vault Data Factory Linked Service. A sas_uri is required.</summary>
    [JsonPropertyName("sasTokenLinkedKeyVaultKey")]
    public V1beta1LinkedServiceAzureBlobStorageSpecInitProviderSasTokenLinkedKeyVaultKey? SasTokenLinkedKeyVaultKey { get; set; }
...
public partial class V1beta1LinkedServiceAzureBlobStorageStatusAtProvider
{
    ...
    /// <summary>A sas_token_linked_key_vault_key block as defined below. Use this argument to store SAS Token in an existing Key Vault. It needs an existing Key Vault Data Factory Linked Service. A sas_uri is required.</summary>
    [JsonPropertyName("sasTokenLinkedKeyVaultKey")]
    public V1beta1LinkedServiceAzureBlobStorageStatusAtProviderSasTokenLinkedKeyVaultKey? SasTokenLinkedKeyVaultKey { get; set; }
