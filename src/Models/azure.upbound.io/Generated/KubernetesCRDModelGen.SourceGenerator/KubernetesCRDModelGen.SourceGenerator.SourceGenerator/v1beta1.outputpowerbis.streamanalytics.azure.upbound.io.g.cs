...
public partial class V1beta1OutputPowerBIList : IKubernetesObject<V1ListMeta>, IItems<V1beta1OutputPowerBI>
{
    ...
    public string Kind { get; set; } = "OutputPowerBIList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1OutputPowerBI objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1OutputPowerBI> Items { get; set; }
}
...
public partial class V1beta1OutputPowerBISpec
{
    ...
    public required V1beta1OutputPowerBISpecForProvider ForProvider { get; set; }
...
public partial class V1beta1OutputPowerBIStatusAtProvider
{
    ...
    /// <summary>The ID of the Stream Analytics Output to Power BI resource.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1OutputPowerBI : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1OutputPowerBISpec>, IStatus<V1beta1OutputPowerBIStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "OutputPowerBI";
    ...
    public required V1beta1OutputPowerBISpec Spec { get; set; }
