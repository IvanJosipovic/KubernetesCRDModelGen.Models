...
public partial class V1beta1IOTHubFallbackRouteList : IKubernetesObject<V1ListMeta>, IItems<V1beta1IOTHubFallbackRoute>
{
    ...
    public string Kind { get; set; } = "IOTHubFallbackRouteList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1IOTHubFallbackRoute objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1IOTHubFallbackRoute> Items { get; set; }
}
...
public partial class V1beta1IOTHubFallbackRouteSpec
{
    ...
    public required V1beta1IOTHubFallbackRouteSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1IOTHubFallbackRoute : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1IOTHubFallbackRouteSpec>, IStatus<V1beta1IOTHubFallbackRouteStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "IOTHubFallbackRoute";
    ...
    public required V1beta1IOTHubFallbackRouteSpec Spec { get; set; }
