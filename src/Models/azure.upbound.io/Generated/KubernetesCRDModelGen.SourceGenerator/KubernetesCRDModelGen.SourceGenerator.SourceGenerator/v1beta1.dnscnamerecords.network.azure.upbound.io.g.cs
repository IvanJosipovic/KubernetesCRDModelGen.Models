...
public partial class V1beta1DNSCNAMERecordList : IKubernetesObject<V1ListMeta>, IItems<V1beta1DNSCNAMERecord>
{
    ...
    public string Kind { get; set; } = "DNSCNAMERecordList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1DNSCNAMERecord objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1DNSCNAMERecord> Items { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpec
{
    ...
    public required V1beta1DNSCNAMERecordSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1DNSCNAMERecord : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1DNSCNAMERecordSpec>, IStatus<V1beta1DNSCNAMERecordStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DNSCNAMERecord";
    ...
    public required V1beta1DNSCNAMERecordSpec Spec { get; set; }
