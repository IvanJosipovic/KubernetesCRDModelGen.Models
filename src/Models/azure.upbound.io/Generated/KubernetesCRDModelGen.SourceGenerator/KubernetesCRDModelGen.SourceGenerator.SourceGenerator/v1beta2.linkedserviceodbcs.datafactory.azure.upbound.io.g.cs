...
public partial class V1beta2LinkedServiceOdbcList : IKubernetesObject<V1ListMeta>, IItems<V1beta2LinkedServiceOdbc>
{
    ...
    public string Kind { get; set; } = "LinkedServiceOdbcList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta2LinkedServiceOdbc objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta2LinkedServiceOdbc> Items { get; set; }
}
...
public partial class V1beta2LinkedServiceOdbcSpecForProviderBasicAuthentication
{
    ...
    public V1beta2LinkedServiceOdbcSpecForProviderBasicAuthenticationPasswordSecretRef? PasswordSecretRef { get; set; }
...
public partial class V1beta2LinkedServiceOdbcSpecForProviderDataFactoryIdRefPolicy
{
    ...
    public V1beta2LinkedServiceOdbcSpecForProviderDataFactoryIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta2LinkedServiceOdbcSpecForProviderDataFactoryIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2LinkedServiceOdbcSpecForProviderDataFactoryIdRef
{
    ...
    public V1beta2LinkedServiceOdbcSpecForProviderDataFactoryIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2LinkedServiceOdbcSpecForProviderDataFactoryIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2LinkedServiceOdbcSpecForProviderDataFactoryIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2LinkedServiceOdbcSpecForProviderDataFactoryIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2LinkedServiceOdbcSpecForProvider
{
    ...
    public V1beta2LinkedServiceOdbcSpecForProviderBasicAuthentication? BasicAuthentication { get; set; }
    ...
    public V1beta2LinkedServiceOdbcSpecForProviderDataFactoryIdRef? DataFactoryIdRef { get; set; }

    /// <summary>Selector for a Factory in datafactory to populate dataFactoryId.</summary>
    [JsonPropertyName("dataFactoryIdSelector")]
    public V1beta2LinkedServiceOdbcSpecForProviderDataFactoryIdSelector? DataFactoryIdSelector { get; set; }
...
public partial class V1beta2LinkedServiceOdbcSpecInitProviderBasicAuthentication
{
    /// <summary>The password associated with the username, which can be used to authenticate to the ODBC endpoint.</summary>
    [JsonPropertyName("passwordSecretRef")]
    public required V1beta2LinkedServiceOdbcSpecInitProviderBasicAuthenticationPasswordSecretRef PasswordSecretRef { get; set; }
...
public partial class V1beta2LinkedServiceOdbcSpecInitProvider
{
    ...
    /// <summary>A basic_authentication block as defined below.</summary>
    [JsonPropertyName("basicAuthentication")]
    public V1beta2LinkedServiceOdbcSpecInitProviderBasicAuthentication? BasicAuthentication { get; set; }
...
public partial class V1beta2LinkedServiceOdbcSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2LinkedServiceOdbcSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2LinkedServiceOdbcSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2LinkedServiceOdbcSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2LinkedServiceOdbcSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2LinkedServiceOdbcSpec
{
    ...
    public V1beta2LinkedServiceOdbcSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta2LinkedServiceOdbcSpecForProvider ForProvider { get; set; }
    ...
    public V1beta2LinkedServiceOdbcSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta2LinkedServiceOdbcSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta2LinkedServiceOdbcSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1beta2LinkedServiceOdbcSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta2LinkedServiceOdbcStatusAtProvider
{
    ...
    /// <summary>A basic_authentication block as defined below.</summary>
    [JsonPropertyName("basicAuthentication")]
    public V1beta2LinkedServiceOdbcStatusAtProviderBasicAuthentication? BasicAuthentication { get; set; }
...
public partial class V1beta2LinkedServiceOdbcStatus
{
    ...
    public V1beta2LinkedServiceOdbcStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta2LinkedServiceOdbcStatusConditions>? Conditions { get; set; }
...
public partial class V1beta2LinkedServiceOdbc : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta2LinkedServiceOdbcSpec>, IStatus<V1beta2LinkedServiceOdbcStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "LinkedServiceOdbc";
    ...
    public required V1beta2LinkedServiceOdbcSpec Spec { get; set; }

    /// <summary>LinkedServiceOdbcStatus defines the observed state of LinkedServiceOdbc.</summary>
    [JsonPropertyName("status")]
    public V1beta2LinkedServiceOdbcStatus? Status { get; set; }
}