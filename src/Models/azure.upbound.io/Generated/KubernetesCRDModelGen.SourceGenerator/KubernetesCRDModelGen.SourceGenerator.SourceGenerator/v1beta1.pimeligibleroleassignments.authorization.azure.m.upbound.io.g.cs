...
public partial class V1beta1PimEligibleRoleAssignmentList : IKubernetesObject<V1ListMeta>, IItems<V1beta1PimEligibleRoleAssignment>
{
    ...
    public string Kind { get; set; } = "PimEligibleRoleAssignmentList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1PimEligibleRoleAssignment objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1PimEligibleRoleAssignment> Items { get; set; }
}
...
public partial class V1beta1PimEligibleRoleAssignmentSpec
{
    ...
    public required V1beta1PimEligibleRoleAssignmentSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1PimEligibleRoleAssignment : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1PimEligibleRoleAssignmentSpec>, IStatus<V1beta1PimEligibleRoleAssignmentStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PimEligibleRoleAssignment";
    ...
    public required V1beta1PimEligibleRoleAssignmentSpec Spec { get; set; }
