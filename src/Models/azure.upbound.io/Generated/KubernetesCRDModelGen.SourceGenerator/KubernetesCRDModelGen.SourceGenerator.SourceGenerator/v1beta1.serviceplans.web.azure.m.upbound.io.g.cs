...
public partial class V1beta1ServicePlanList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ServicePlan>
{
    ...
    public string Kind { get; set; } = "ServicePlanList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ServicePlan objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ServicePlan> Items { get; set; }
}
...
public partial class V1beta1ServicePlanSpecForProvider
{
    ...
    /// <summary>The SKU for the plan. Possible values include B1, B2, B3, D1, F1, I1, I2, I3, I1v2, I1mv2, I2v2, I2mv2, I3v2, I3mv2, I4v2, I4mv2, I5v2, I5mv2, I6v2, P1v2, P2v2, P3v2, P0v3, P1v3, P2v3, P3v3, P1mv3, P2mv3, P3mv3, P4mv3, P5mv3, P0v4, P1v4, P2v4, P3v4, P1mv4, P2mv4, P3mv4, P4mv4, P5mv4, S1, S2, S3, SHARED, EP1, EP2, EP3, FC1, WS1, WS2, WS3, and Y1.</summary>
    ...
    /// <summary>Should the Service Plan balance across Availability Zones in the region.</summary>
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServicePlanSpecManagementPoliciesEnum>))]
...
public partial class V1beta1ServicePlanSpec
{
    ...
    public required V1beta1ServicePlanSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1ServicePlan : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ServicePlanSpec>, IStatus<V1beta1ServicePlanStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ServicePlan";
    ...
    public required V1beta1ServicePlanSpec Spec { get; set; }
