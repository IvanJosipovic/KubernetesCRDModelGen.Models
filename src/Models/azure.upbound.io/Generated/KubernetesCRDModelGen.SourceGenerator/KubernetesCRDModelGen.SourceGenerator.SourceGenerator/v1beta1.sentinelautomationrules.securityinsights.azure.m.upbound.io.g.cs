...
public partial class V1beta1SentinelAutomationRuleList : IKubernetesObject<V1ListMeta>, IItems<V1beta1SentinelAutomationRule>
{
    ...
    public string Kind { get; set; } = "SentinelAutomationRuleList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1SentinelAutomationRule objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1SentinelAutomationRule> Items { get; set; }
}
...
{
    /// <summary>The description of the incident task.</summary>
    ...
    /// <summary>The title of the incident task.</summary>
...
public partial class V1beta1SentinelAutomationRuleSpecForProvider
{
    ...
    /// <summary>One or more action_incident_task blocks as defined below.</summary>
    [JsonPropertyName("actionIncidentTask")]
    public IList<V1beta1SentinelAutomationRuleSpecForProviderActionIncidentTask>? ActionIncidentTask { get; set; }
...
public partial class V1beta1SentinelAutomationRuleSpecInitProvider
{
    ...
    /// <summary>One or more action_incident_task blocks as defined below.</summary>
    [JsonPropertyName("actionIncidentTask")]
    public IList<V1beta1SentinelAutomationRuleSpecInitProviderActionIncidentTask>? ActionIncidentTask { get; set; }
...
public partial class V1beta1SentinelAutomationRuleSpec
{
    ...
    public required V1beta1SentinelAutomationRuleSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1SentinelAutomationRuleStatusAtProvider
{
    ...
    /// <summary>One or more action_incident_task blocks as defined below.</summary>
    [JsonPropertyName("actionIncidentTask")]
    public IList<V1beta1SentinelAutomationRuleStatusAtProviderActionIncidentTask>? ActionIncidentTask { get; set; }
...
public partial class V1beta1SentinelAutomationRule : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1SentinelAutomationRuleSpec>, IStatus<V1beta1SentinelAutomationRuleStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "SentinelAutomationRule";
    ...
    public required V1beta1SentinelAutomationRuleSpec Spec { get; set; }
