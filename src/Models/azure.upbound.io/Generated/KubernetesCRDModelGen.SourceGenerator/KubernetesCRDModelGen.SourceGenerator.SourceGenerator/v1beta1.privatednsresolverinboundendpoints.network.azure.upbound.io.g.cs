...
public partial class V1beta1PrivateDNSResolverInboundEndpointList : IKubernetesObject<V1ListMeta>, IItems<V1beta1PrivateDNSResolverInboundEndpoint>
{
    ...
    public string Kind { get; set; } = "PrivateDNSResolverInboundEndpointList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1PrivateDNSResolverInboundEndpoint objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1PrivateDNSResolverInboundEndpoint> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1PrivateDNSResolverInboundEndpointSpecDeletionPolicyEnum>))]
public enum V1beta1PrivateDNSResolverInboundEndpointSpecDeletionPolicyEnum
{
...
public partial class V1beta1PrivateDNSResolverInboundEndpointSpecForProviderIpConfigurationsSubnetIdRefPolicy
{
    ...
    public V1beta1PrivateDNSResolverInboundEndpointSpecForProviderIpConfigurationsSubnetIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1PrivateDNSResolverInboundEndpointSpecForProviderIpConfigurationsSubnetIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverInboundEndpointSpecForProviderIpConfigurationsSubnetIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecForProviderIpConfigurationsSubnetIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecForProviderIpConfigurationsSubnetIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverInboundEndpointSpecForProviderPrivateDnsResolverIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecForProviderPrivateDnsResolverIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecForProviderPrivateDnsResolverIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverInboundEndpointSpecForProviderPrivateDnsResolverIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecForProviderPrivateDnsResolverIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecForProviderPrivateDnsResolverIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverInboundEndpointSpecInitProviderIpConfigurationsSubnetIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecInitProviderIpConfigurationsSubnetIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecInitProviderIpConfigurationsSubnetIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverInboundEndpointSpecInitProviderIpConfigurationsSubnetIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecInitProviderIpConfigurationsSubnetIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecInitProviderIpConfigurationsSubnetIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1PrivateDNSResolverInboundEndpointSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1PrivateDNSResolverInboundEndpointSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1PrivateDNSResolverInboundEndpointSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1PrivateDNSResolverInboundEndpointSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
public partial class V1beta1PrivateDNSResolverInboundEndpointSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1PrivateDNSResolverInboundEndpointSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1PrivateDNSResolverInboundEndpointSpec
{
    ...
    public V1beta1PrivateDNSResolverInboundEndpointSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1PrivateDNSResolverInboundEndpointSpecForProvider ForProvider { get; set; }
    ...
    public IList<V1beta1PrivateDNSResolverInboundEndpointSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
...
public partial class V1beta1PrivateDNSResolverInboundEndpoint : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1PrivateDNSResolverInboundEndpointSpec>, IStatus<V1beta1PrivateDNSResolverInboundEndpointStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PrivateDNSResolverInboundEndpoint";
    ...
    public required V1beta1PrivateDNSResolverInboundEndpointSpec Spec { get; set; }
