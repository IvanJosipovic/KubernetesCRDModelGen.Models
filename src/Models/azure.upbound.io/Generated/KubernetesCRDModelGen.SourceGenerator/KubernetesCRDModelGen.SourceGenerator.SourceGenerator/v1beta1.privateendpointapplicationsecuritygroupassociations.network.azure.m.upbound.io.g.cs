...
public partial class V1beta1PrivateEndpointApplicationSecurityGroupAssociationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1PrivateEndpointApplicationSecurityGroupAssociation>
{
    ...
    public string Kind { get; set; } = "PrivateEndpointApplicationSecurityGroupAssociationList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1PrivateEndpointApplicationSecurityGroupAssociation objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1PrivateEndpointApplicationSecurityGroupAssociation> Items { get; set; }
}
...
public partial class V1beta1PrivateEndpointApplicationSecurityGroupAssociationSpec
{
    ...
    public required V1beta1PrivateEndpointApplicationSecurityGroupAssociationSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1PrivateEndpointApplicationSecurityGroupAssociation : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1PrivateEndpointApplicationSecurityGroupAssociationSpec>, IStatus<V1beta1PrivateEndpointApplicationSecurityGroupAssociationStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PrivateEndpointApplicationSecurityGroupAssociation";
    ...
    public required V1beta1PrivateEndpointApplicationSecurityGroupAssociationSpec Spec { get; set; }
