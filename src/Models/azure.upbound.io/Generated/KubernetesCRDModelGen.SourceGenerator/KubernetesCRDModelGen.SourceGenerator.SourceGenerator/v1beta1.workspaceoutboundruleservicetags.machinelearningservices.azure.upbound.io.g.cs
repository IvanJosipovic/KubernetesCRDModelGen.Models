...
public partial class V1beta1WorkspaceOutboundRuleServiceTagList : IKubernetesObject<V1ListMeta>, IItems<V1beta1WorkspaceOutboundRuleServiceTag>
{
    ...
    public const string KubeKind = "WorkspaceOutboundRuleServiceTagList";
    public const string KubeGroup = "machinelearningservices.azure.upbound.io";
    public const string KubePluralName = "workspaceoutboundruleservicetags";
    ...
    public string Kind { get; set; } = "WorkspaceOutboundRuleServiceTagList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1WorkspaceOutboundRuleServiceTag objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1WorkspaceOutboundRuleServiceTag> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1WorkspaceOutboundRuleServiceTagSpecDeletionPolicyEnum>))]
public enum V1beta1WorkspaceOutboundRuleServiceTagSpecDeletionPolicyEnum
{
...
public partial class V1beta1WorkspaceOutboundRuleServiceTagSpecForProviderWorkspaceIdRefPolicy
{
    ...
    public V1beta1WorkspaceOutboundRuleServiceTagSpecForProviderWorkspaceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1WorkspaceOutboundRuleServiceTagSpecForProviderWorkspaceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRuleServiceTagSpecForProviderWorkspaceIdRef
{
    ...
    public V1beta1WorkspaceOutboundRuleServiceTagSpecForProviderWorkspaceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRuleServiceTagSpecForProviderWorkspaceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1WorkspaceOutboundRuleServiceTagSpecForProviderWorkspaceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1WorkspaceOutboundRuleServiceTagSpecForProviderWorkspaceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRuleServiceTagSpecForProvider
{
    ...
    public V1beta1WorkspaceOutboundRuleServiceTagSpecForProviderWorkspaceIdRef? WorkspaceIdRef { get; set; }

    /// <summary>Selector for a Workspace in machinelearningservices to populate workspaceId.</summary>
    [JsonPropertyName("workspaceIdSelector")]
    public V1beta1WorkspaceOutboundRuleServiceTagSpecForProviderWorkspaceIdSelector? WorkspaceIdSelector { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1WorkspaceOutboundRuleServiceTagSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1WorkspaceOutboundRuleServiceTagSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1WorkspaceOutboundRuleServiceTagSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1WorkspaceOutboundRuleServiceTagSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1WorkspaceOutboundRuleServiceTagSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1WorkspaceOutboundRuleServiceTagSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1WorkspaceOutboundRuleServiceTagSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRuleServiceTagSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1WorkspaceOutboundRuleServiceTagSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1WorkspaceOutboundRuleServiceTagSpec
{
    ...
    public V1beta1WorkspaceOutboundRuleServiceTagSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1WorkspaceOutboundRuleServiceTagSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1WorkspaceOutboundRuleServiceTagSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1WorkspaceOutboundRuleServiceTagSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1WorkspaceOutboundRuleServiceTagSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
{
    /// <summary>The ID of the Machine Learning Workspace Network Outbound Rule Service Tag .</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1WorkspaceOutboundRuleServiceTagStatus
{
    ...
    public V1beta1WorkspaceOutboundRuleServiceTagStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1WorkspaceOutboundRuleServiceTagStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "WorkspaceOutboundRuleServiceTag";
    public const string KubeGroup = "machinelearningservices.azure.upbound.io";
    public const string KubePluralName = "workspaceoutboundruleservicetags";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "WorkspaceOutboundRuleServiceTag";
    ...
    public required V1beta1WorkspaceOutboundRuleServiceTagSpec Spec { get; set; }

    /// <summary>WorkspaceOutboundRuleServiceTagStatus defines the observed state of WorkspaceOutboundRuleServiceTag.</summary>
    [JsonPropertyName("status")]
    public V1beta1WorkspaceOutboundRuleServiceTagStatus? Status { get; set; }
}