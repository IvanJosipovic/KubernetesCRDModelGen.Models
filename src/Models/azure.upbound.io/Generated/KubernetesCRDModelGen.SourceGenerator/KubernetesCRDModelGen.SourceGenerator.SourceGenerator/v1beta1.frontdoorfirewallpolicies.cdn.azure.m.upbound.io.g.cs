...
public partial class V1beta1FrontdoorFirewallPolicyList : IKubernetesObject<V1ListMeta>, IItems<V1beta1FrontdoorFirewallPolicy>
{
    ...
    public string Kind { get; set; } = "FrontdoorFirewallPolicyList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1FrontdoorFirewallPolicy objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1FrontdoorFirewallPolicy> Items { get; set; }
}
...
{
    /// <summary>The action to perform when the rule is matched. Possible values are Allow, Block, Log, Redirect, JSChallenge, or CAPTCHA.</summary>
...
{
    /// <summary>The action to be applied when the managed rule matches or when the anomaly score is 5 or greater. Possible values are Allow, CAPTCHA, Log, Block, Redirect, AnomalyScoring and JSChallenge.</summary>
    [JsonPropertyName("action")]
    public string? Action { get; set; }
...
{
    /// <summary>Specifies the Captcha cookie lifetime in minutes. Possible values are between 5 and 1440. Defaults to30 minutes.</summary>
    [JsonPropertyName("captchaCookieExpirationInMinutes")]
    public double? CaptchaCookieExpirationInMinutes { get; set; }
    ...
    /// <summary>If a custom_rule block&apos;s action type is block, this is the response status code. Possible values are 200, 403, 405, 406, 429, 990, 991, 992, 993, 994, 995, 996, 997, 998, or 999.</summary>
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1FrontdoorFirewallPolicySpecManagementPoliciesEnum>))]
...
public partial class V1beta1FrontdoorFirewallPolicySpec
{
    ...
    public required V1beta1FrontdoorFirewallPolicySpecForProvider ForProvider { get; set; }
...
public partial class V1beta1FrontdoorFirewallPolicy : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1FrontdoorFirewallPolicySpec>, IStatus<V1beta1FrontdoorFirewallPolicyStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "FrontdoorFirewallPolicy";
    ...
    public required V1beta1FrontdoorFirewallPolicySpec Spec { get; set; }
