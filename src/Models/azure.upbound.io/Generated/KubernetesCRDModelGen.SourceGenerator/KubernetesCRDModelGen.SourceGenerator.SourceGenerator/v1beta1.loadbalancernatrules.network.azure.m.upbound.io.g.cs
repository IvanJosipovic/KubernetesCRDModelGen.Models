...
public partial class V1beta1LoadBalancerNatRuleList : IKubernetesObject<V1ListMeta>, IItems<V1beta1LoadBalancerNatRule>
{
    ...
    public string Kind { get; set; } = "LoadBalancerNatRuleList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1LoadBalancerNatRule objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1LoadBalancerNatRule> Items { get; set; }
}
...
public partial class V1beta1LoadBalancerNatRuleSpec
{
    ...
    public required V1beta1LoadBalancerNatRuleSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1LoadBalancerNatRule : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1LoadBalancerNatRuleSpec>, IStatus<V1beta1LoadBalancerNatRuleStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "LoadBalancerNatRule";
    ...
    public required V1beta1LoadBalancerNatRuleSpec Spec { get; set; }
