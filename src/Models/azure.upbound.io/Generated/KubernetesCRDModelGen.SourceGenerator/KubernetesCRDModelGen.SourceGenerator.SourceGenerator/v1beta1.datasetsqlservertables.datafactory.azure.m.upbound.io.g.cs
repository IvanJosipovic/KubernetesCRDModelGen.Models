...
public partial class V1beta1DataSetSQLServerTableList : IKubernetesObject<V1ListMeta>, IItems<V1beta1DataSetSQLServerTable>
{
    ...
    public string Kind { get; set; } = "DataSetSQLServerTableList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1DataSetSQLServerTable objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1DataSetSQLServerTable> Items { get; set; }
}
...
public partial class V1beta1DataSetSQLServerTableSpec
{
    ...
    public required V1beta1DataSetSQLServerTableSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1DataSetSQLServerTable : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1DataSetSQLServerTableSpec>, IStatus<V1beta1DataSetSQLServerTableStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DataSetSQLServerTable";
    ...
    public required V1beta1DataSetSQLServerTableSpec Spec { get; set; }
