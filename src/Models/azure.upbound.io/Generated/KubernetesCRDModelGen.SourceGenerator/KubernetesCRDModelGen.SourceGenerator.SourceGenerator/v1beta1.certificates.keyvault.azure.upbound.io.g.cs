...
public partial class V1beta1CertificateSpecForProviderCertificate
{
    ...
    public required V1beta1CertificateSpecForProviderCertificateContentsSecretRef ContentsSecretRef { get; set; }
...
public partial class V1beta1CertificateSpecInitProviderCertificate
{
    /// <summary>The base64-encoded certificate contents.</summary>
    [JsonPropertyName("contentsSecretRef")]
    public required V1beta1CertificateSpecInitProviderCertificateContentsSecretRef ContentsSecretRef { get; set; }
...
public partial class V1beta1CertificateStatusAtProviderCertificate
{
    /// <summary>The base64-encoded certificate contents.</summary>
    [JsonPropertyName("contentsSecretRef")]
    public required V1beta1CertificateStatusAtProviderCertificateContentsSecretRef ContentsSecretRef { get; set; }
