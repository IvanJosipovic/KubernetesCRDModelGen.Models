...
public partial class V1beta1BackupPolicyBlobStorageList : IKubernetesObject<V1ListMeta>, IItems<V1beta1BackupPolicyBlobStorage>
{
    ...
    public string Kind { get; set; } = "BackupPolicyBlobStorageList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1BackupPolicyBlobStorage objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1BackupPolicyBlobStorage> Items { get; set; }
}
...
public partial class V1beta1BackupPolicyBlobStorageSpecForProviderRetentionRuleCriteria
{
    ...
    /// <summary>Possible values are January, February, March, April, May, June, July, August, September, October, November and December. Changing this forces a new Backup Policy Blob Storage to be created. When this property is specified, exactly one of the following must also be set: days_of_month, days_of_week</summary>
    ...
    /// <summary>Possible values are First, Second, Third, Fourth and Last. Changing this forces a new Backup Policy Blob Storage to be created. When this property is specified, exactly one of the following must also be set: days_of_month, days_of_week</summary>
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1BackupPolicyBlobStorageSpecManagementPoliciesEnum>))]
...
public partial class V1beta1BackupPolicyBlobStorageSpec
{
    ...
    public required V1beta1BackupPolicyBlobStorageSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1BackupPolicyBlobStorage : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1BackupPolicyBlobStorageSpec>, IStatus<V1beta1BackupPolicyBlobStorageStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "BackupPolicyBlobStorage";
    ...
    public required V1beta1BackupPolicyBlobStorageSpec Spec { get; set; }
