...
public partial class V1beta2MSSQLManagedDatabaseList : IKubernetesObject<V1ListMeta>, IItems<V1beta2MSSQLManagedDatabase>
{
    ...
    public string Kind { get; set; } = "MSSQLManagedDatabaseList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta2MSSQLManagedDatabase objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta2MSSQLManagedDatabase> Items { get; set; }
}
...
public partial class V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdRefPolicy
{
    ...
    public V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdRef
{
    ...
    public V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta2MSSQLManagedDatabaseSpecForProvider
{
    ...
    public V1beta2MSSQLManagedDatabaseSpecForProviderLongTermRetentionPolicy? LongTermRetentionPolicy { get; set; }
    ...
    public V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdRef? ManagedInstanceIdRef { get; set; }

    /// <summary>Selector for a MSSQLManagedInstance in sql to populate managedInstanceId.</summary>
    [JsonPropertyName("managedInstanceIdSelector")]
    public V1beta2MSSQLManagedDatabaseSpecForProviderManagedInstanceIdSelector? ManagedInstanceIdSelector { get; set; }

    /// <summary>A point_in_time_restore block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("pointInTimeRestore")]
    public V1beta2MSSQLManagedDatabaseSpecForProviderPointInTimeRestore? PointInTimeRestore { get; set; }
...
public partial class V1beta2MSSQLManagedDatabaseSpecInitProvider
{
    /// <summary>A long_term_retention_policy block as defined below.</summary>
    [JsonPropertyName("longTermRetentionPolicy")]
    public V1beta2MSSQLManagedDatabaseSpecInitProviderLongTermRetentionPolicy? LongTermRetentionPolicy { get; set; }

    /// <summary>A point_in_time_restore block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("pointInTimeRestore")]
    public V1beta2MSSQLManagedDatabaseSpecInitProviderPointInTimeRestore? PointInTimeRestore { get; set; }
...
public partial class V1beta2MSSQLManagedDatabaseSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2MSSQLManagedDatabaseSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2MSSQLManagedDatabaseSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2MSSQLManagedDatabaseSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2MSSQLManagedDatabaseSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2MSSQLManagedDatabaseSpec
{
    ...
    public V1beta2MSSQLManagedDatabaseSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta2MSSQLManagedDatabaseSpecForProvider ForProvider { get; set; }
    ...
    public V1beta2MSSQLManagedDatabaseSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta2MSSQLManagedDatabaseSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta2MSSQLManagedDatabaseSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1beta2MSSQLManagedDatabaseSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta2MSSQLManagedDatabaseStatusAtProvider
{
    ...
    /// <summary>A long_term_retention_policy block as defined below.</summary>
    [JsonPropertyName("longTermRetentionPolicy")]
    public V1beta2MSSQLManagedDatabaseStatusAtProviderLongTermRetentionPolicy? LongTermRetentionPolicy { get; set; }
    ...
    /// <summary>A point_in_time_restore block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("pointInTimeRestore")]
    public V1beta2MSSQLManagedDatabaseStatusAtProviderPointInTimeRestore? PointInTimeRestore { get; set; }
...
public partial class V1beta2MSSQLManagedDatabaseStatus
{
    ...
    public V1beta2MSSQLManagedDatabaseStatusAtProvider? AtProvider { get; set; }
...
public partial class V1beta2MSSQLManagedDatabase : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta2MSSQLManagedDatabaseSpec>, IStatus<V1beta2MSSQLManagedDatabaseStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "MSSQLManagedDatabase";
    ...
    public required V1beta2MSSQLManagedDatabaseSpec Spec { get; set; }

    /// <summary>MSSQLManagedDatabaseStatus defines the observed state of MSSQLManagedDatabase.</summary>
    [JsonPropertyName("status")]
    public V1beta2MSSQLManagedDatabaseStatus? Status { get; set; }
}