...
public partial class V1beta1GrafanaManagedPrivateEndpointList : IKubernetesObject<V1ListMeta>, IItems<V1beta1GrafanaManagedPrivateEndpoint>
{
    ...
    public const string KubeKind = "GrafanaManagedPrivateEndpointList";
    public const string KubeGroup = "dashboard.azure.upbound.io";
    public const string KubePluralName = "grafanamanagedprivateendpoints";
    ...
    public string Kind { get; set; } = "GrafanaManagedPrivateEndpointList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1GrafanaManagedPrivateEndpoint objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1GrafanaManagedPrivateEndpoint> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1GrafanaManagedPrivateEndpointSpecDeletionPolicyEnum>))]
public enum V1beta1GrafanaManagedPrivateEndpointSpecDeletionPolicyEnum
{
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdRefPolicy
{
    ...
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdRef
{
    ...
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceRegionRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceRegionRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceRegionRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceRegionRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceRegionRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceRegionSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceRegionSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceRegionSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>The id of the associated managed Grafana. Changing this forces a new Dashboard Grafana Managed Private Endpoint to be created.</summary>
    [JsonPropertyName("grafanaId")]
    public string? GrafanaId { get; set; }

    /// <summary>Reference to a Grafana in dashboard to populate grafanaId.</summary>
    [JsonPropertyName("grafanaIdRef")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdRef? GrafanaIdRef { get; set; }

    /// <summary>Selector for a Grafana in dashboard to populate grafanaId.</summary>
    [JsonPropertyName("grafanaIdSelector")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderGrafanaIdSelector? GrafanaIdSelector { get; set; }

    /// <summary>Specifies a list of private link group IDs. The value of this will depend on the private link resource to which you are connecting. Changing this forces a new Dashboard Grafana Managed Private Endpoint to be created.</summary>
    [JsonPropertyName("groupIds")]
    public IList<string>? GroupIds { get; set; }

    /// <summary>The Azure Region where the Dashboard Grafana Managed Private Endpoint should exist. Changing this forces a new Dashboard Grafana Managed Private Endpoint to be created.</summary>
    [JsonPropertyName("location")]
    public string? Location { get; set; }

    /// <summary>The ID of the resource to which this Dashboard Grafana Managed Private Endpoint will connect. Changing this forces a new Dashboard Grafana Managed Private Endpoint to be created.</summary>
    [JsonPropertyName("privateLinkResourceId")]
    public string? PrivateLinkResourceId { get; set; }

    /// <summary>Reference to a MonitorWorkspace in insights to populate privateLinkResourceId.</summary>
    [JsonPropertyName("privateLinkResourceIdRef")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdRef? PrivateLinkResourceIdRef { get; set; }

    /// <summary>Selector for a MonitorWorkspace in insights to populate privateLinkResourceId.</summary>
    [JsonPropertyName("privateLinkResourceIdSelector")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceIdSelector? PrivateLinkResourceIdSelector { get; set; }

    /// <summary>The region in which to create the private link. Changing this forces a new Dashboard Grafana Managed Private Endpoint to be created.</summary>
    ...
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceRegionRef? PrivateLinkResourceRegionRef { get; set; }

    /// <summary>Selector for a Grafana in dashboard to populate privateLinkResourceRegion.</summary>
    [JsonPropertyName("privateLinkResourceRegionSelector")]
    public V1beta1GrafanaManagedPrivateEndpointSpecForProviderPrivateLinkResourceRegionSelector? PrivateLinkResourceRegionSelector { get; set; }

    /// <summary>A domain name for this endpoint to be used within Grafana. Must be just a domain, without schema, and with at least three parts.</summary>
    [JsonPropertyName("privateLinkServiceUrl")]
    public string? PrivateLinkServiceUrl { get; set; }

    /// <summary>A message to provide in the request which will be seen by approvers.</summary>
    [JsonPropertyName("requestMessage")]
    public string? RequestMessage { get; set; }

    /// <summary>A mapping of tags which should be assigned to the Dashboard Grafana Managed Private Endpoint.</summary>
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecInitProvider
{
    ...
    /// <summary>Reference to a MonitorWorkspace in insights to populate privateLinkResourceId.</summary>
    [JsonPropertyName("privateLinkResourceIdRef")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdRef? PrivateLinkResourceIdRef { get; set; }

    /// <summary>Selector for a MonitorWorkspace in insights to populate privateLinkResourceId.</summary>
    [JsonPropertyName("privateLinkResourceIdSelector")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceIdSelector? PrivateLinkResourceIdSelector { get; set; }
    ...
    /// <summary>Reference to a Grafana in dashboard to populate privateLinkResourceRegion.</summary>
    [JsonPropertyName("privateLinkResourceRegionRef")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionRef? PrivateLinkResourceRegionRef { get; set; }

    /// <summary>Selector for a Grafana in dashboard to populate privateLinkResourceRegion.</summary>
    [JsonPropertyName("privateLinkResourceRegionSelector")]
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProviderPrivateLinkResourceRegionSelector? PrivateLinkResourceRegionSelector { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1GrafanaManagedPrivateEndpointSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1GrafanaManagedPrivateEndpointSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1GrafanaManagedPrivateEndpointSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1GrafanaManagedPrivateEndpointSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1GrafanaManagedPrivateEndpointSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GrafanaManagedPrivateEndpointSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GrafanaManagedPrivateEndpointSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GrafanaManagedPrivateEndpointSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1GrafanaManagedPrivateEndpointSpec
{
    ...
    public V1beta1GrafanaManagedPrivateEndpointSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1GrafanaManagedPrivateEndpointSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1GrafanaManagedPrivateEndpointSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1GrafanaManagedPrivateEndpointSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1GrafanaManagedPrivateEndpointSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1GrafanaManagedPrivateEndpointStatusAtProvider
{
    ...
    /// <summary>The ID of the Dashboard Grafana Managed Private Endpoint.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1GrafanaManagedPrivateEndpointStatus
{
    ...
    public V1beta1GrafanaManagedPrivateEndpointStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1GrafanaManagedPrivateEndpointStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "GrafanaManagedPrivateEndpoint";
    public const string KubeGroup = "dashboard.azure.upbound.io";
    public const string KubePluralName = "grafanamanagedprivateendpoints";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "GrafanaManagedPrivateEndpoint";
    ...
    public required V1beta1GrafanaManagedPrivateEndpointSpec Spec { get; set; }

    /// <summary>GrafanaManagedPrivateEndpointStatus defines the observed state of GrafanaManagedPrivateEndpoint.</summary>
    [JsonPropertyName("status")]
    public V1beta1GrafanaManagedPrivateEndpointStatus? Status { get; set; }
}