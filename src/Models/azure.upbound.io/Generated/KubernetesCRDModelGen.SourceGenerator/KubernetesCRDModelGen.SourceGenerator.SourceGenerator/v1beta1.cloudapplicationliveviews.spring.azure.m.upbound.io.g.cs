...
public partial class V1beta1CloudApplicationLiveViewList : IKubernetesObject<V1ListMeta>, IItems<V1beta1CloudApplicationLiveView>
{
    ...
    public string ApiVersion { get; set; } = "spring.azure.m.upbound.io/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CloudApplicationLiveViewList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1CloudApplicationLiveView objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1CloudApplicationLiveView> Items { get; set; }
}
...
public partial class V1beta1CloudApplicationLiveViewSpec
{
    ...
    public required V1beta1CloudApplicationLiveViewSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1CloudApplicationLiveView : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1CloudApplicationLiveViewSpec>, IStatus<V1beta1CloudApplicationLiveViewStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CloudApplicationLiveView";
    ...
    public required V1beta1CloudApplicationLiveViewSpec Spec { get; set; }
