...
public partial class V1beta1AuthorizationServerList : IKubernetesObject<V1ListMeta>, IItems<V1beta1AuthorizationServer>
{
    ...
    public string Kind { get; set; } = "AuthorizationServerList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1AuthorizationServer objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1AuthorizationServer> Items { get; set; }
}
...
public partial class V1beta1AuthorizationServerSpec
{
    ...
    public required V1beta1AuthorizationServerSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1AuthorizationServer : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1AuthorizationServerSpec>, IStatus<V1beta1AuthorizationServerStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "AuthorizationServer";
    ...
    public required V1beta1AuthorizationServerSpec Spec { get; set; }
