...
/// <summary>Cluster is the Schema for the Clusters API. Manages an EventHub Cluster</summary>
...
public partial class V1beta1ClusterSpecForProvider
{
    ...
    /// <summary>The name of the resource group in which the EventHub Cluster exists. Changing this forces a new resource to be created.</summary>
    ...
    /// <summary>The SKU name of the EventHub Cluster. The only supported value at this time is Dedicated_1.</summary>
...
{
    /// <summary>The EventHub Cluster ID.</summary>
    [JsonPropertyName("id")]
