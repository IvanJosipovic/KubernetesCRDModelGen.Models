...
public partial class V1beta1SecurityRuleList : IKubernetesObject<V1ListMeta>, IItems<V1beta1SecurityRule>
{
    ...
    public string Kind { get; set; } = "SecurityRuleList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1SecurityRule objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1SecurityRule> Items { get; set; }
}
...
public partial class V1beta1SecurityRuleSpecForProvider
{
    ...
    /// <summary>CIDR or destination IP range or * to match any IP. Tags such as VirtualNetwork, AzureLoadBalancer and Internet can also be used. Besides, it also supports all available Service Tags like ‘Sql.WestEurope‘, ‘Storage.EastUS‘, etc. You can list the available service tags with the CLI: shell az network list-service-tags --location westcentralus. For further information please see Azure CLI - az network list-service-tags.</summary>
    [JsonPropertyName("destinationAddressPrefix")]
    public string? DestinationAddressPrefix { get; set; }

    /// <summary>List of destination address prefixes. Tags may not be used.</summary>
    ...
    /// <summary>CIDR or source IP range or * to match any IP. Tags such as VirtualNetwork, AzureLoadBalancer and Internet can also be used.</summary>
    [JsonPropertyName("sourceAddressPrefix")]
    public string? SourceAddressPrefix { get; set; }

    /// <summary>List of source address prefixes. Tags may not be used.</summary>
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1SecurityRuleSpecManagementPoliciesEnum>))]
...
public partial class V1beta1SecurityRuleSpec
{
    ...
    public required V1beta1SecurityRuleSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1SecurityRule : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1SecurityRuleSpec>, IStatus<V1beta1SecurityRuleStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "SecurityRule";
    ...
    public required V1beta1SecurityRuleSpec Spec { get; set; }
