...
public partial class V1beta1BackupInstanceBlobStorageList : IKubernetesObject<V1ListMeta>, IItems<V1beta1BackupInstanceBlobStorage>
{
    ...
    public string Kind { get; set; } = "BackupInstanceBlobStorageList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1BackupInstanceBlobStorage objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1BackupInstanceBlobStorage> Items { get; set; }
}
...
public partial class V1beta1BackupInstanceBlobStorageSpec
{
    ...
    public required V1beta1BackupInstanceBlobStorageSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1BackupInstanceBlobStorageStatusAtProvider
{
    ...
    /// <summary>The protection state of the Backup Instance Blob Storage.</summary>
...
public partial class V1beta1BackupInstanceBlobStorage : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1BackupInstanceBlobStorageSpec>, IStatus<V1beta1BackupInstanceBlobStorageStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "BackupInstanceBlobStorage";
    ...
    public required V1beta1BackupInstanceBlobStorageSpec Spec { get; set; }
