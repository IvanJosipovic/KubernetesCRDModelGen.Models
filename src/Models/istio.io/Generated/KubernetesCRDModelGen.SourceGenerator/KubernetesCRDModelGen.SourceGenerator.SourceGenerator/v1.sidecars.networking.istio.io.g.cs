...
public partial class V1SidecarSpecEgress
{
    ...
    public V1SidecarSpecEgressCaptureModeEnum? CaptureMode { get; set; }
...
public partial class V1SidecarSpecInboundConnectionPoolHttp
{
    ...
    public V1SidecarSpecInboundConnectionPoolHttpH2UpgradePolicyEnum? H2UpgradePolicy { get; set; }
...
public partial class V1SidecarSpecIngressConnectionPoolHttp
{
    ...
    /// </summary>
    [JsonPropertyName("h2UpgradePolicy")]
    public V1SidecarSpecIngressConnectionPoolHttpH2UpgradePolicyEnum? H2UpgradePolicy { get; set; }
...
public partial class V1SidecarSpecIngressTls
{
    ...
    public V1SidecarSpecIngressTlsMaxProtocolVersionEnum? MaxProtocolVersion { get; set; }
    ...
    public V1SidecarSpecIngressTlsMinProtocolVersionEnum? MinProtocolVersion { get; set; }
    ...
    public V1SidecarSpecIngressTlsModeEnum? Mode { get; set; }
...
public partial class V1SidecarSpecIngress
{
    ...
    /// </summary>
    [JsonPropertyName("captureMode")]
    public V1SidecarSpecIngressCaptureModeEnum? CaptureMode { get; set; }
    ...
    /// <summary>The port associated with the listener.</summary>
    [JsonPropertyName("port")]
    public required V1SidecarSpecIngressPort Port { get; set; }
...
public partial class V1SidecarSpecOutboundTrafficPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("mode")]
    public V1SidecarSpecOutboundTrafficPolicyModeEnum? Mode { get; set; }
}
