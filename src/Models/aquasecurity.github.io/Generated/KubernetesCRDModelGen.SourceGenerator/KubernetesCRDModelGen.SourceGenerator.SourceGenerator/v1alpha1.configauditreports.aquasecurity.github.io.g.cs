...
public partial class V1alpha1ConfigAuditReportList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ConfigAuditReport>
{
    ...
    public string Kind { get; set; } = "ConfigAuditReportList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ConfigAuditReport objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1ConfigAuditReport> Items { get; set; }
}
...
public partial class V1alpha1ConfigAuditReportReport
{
    ...
    public required IList<V1alpha1ConfigAuditReportReportChecks> Checks { get; set; }
...
public partial class V1alpha1ConfigAuditReport : IKubernetesObject<V1ObjectMeta>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ConfigAuditReport";
    ...
    public required V1alpha1ConfigAuditReportReport Report { get; set; }
}