...
public partial class V1FelixConfigurationList : IKubernetesObject<V1ListMeta>, IItems<V1FelixConfiguration>
{
    ...
    public string Kind { get; set; } = "FelixConfigurationList";
...
public enum V1FelixConfigurationSpecBpfConntrackModeEnum
{
    ...
    Auto,
    [EnumMember(Value = "Userspace"), JsonStringEnumMemberName("Userspace")]
    Userspace,
    [EnumMember(Value = "BPFProgram"), JsonStringEnumMemberName("BPFProgram")]
    BPFProgram
}
...
public enum V1FelixConfigurationSpecIptablesBackendEnum
{
    ...
    Legacy,
    [EnumMember(Value = "NFT"), JsonStringEnumMemberName("NFT")]
    NFT,
    [EnumMember(Value = "Auto"), JsonStringEnumMemberName("Auto")]
    Auto
}
...
{
    [EnumMember(Value = "IPPoolsOnly"), JsonStringEnumMemberName("IPPoolsOnly")]
    IPPoolsOnly,
    [EnumMember(Value = "IPPoolsAndHostIPs"), JsonStringEnumMemberName("IPPoolsAndHostIPs")]
    IPPoolsAndHostIPs
}
...
public partial class V1FelixConfigurationSpec
{
    ...
    public V1FelixConfigurationSpecBpfConntrackLogLevelEnum? BpfConntrackLogLevel { get; set; }
    ...
    public V1FelixConfigurationSpecBpfConntrackModeEnum? BpfConntrackMode { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("bpfKubeProxyHealthzPort")]
    public int? BpfKubeProxyHealthzPort { get; set; }
    ...
    /// [Default: 100]
    /// </summary>
    [JsonPropertyName("bpfMaglevMaxEndpointsPerService")]
    public int? BpfMaglevMaxEndpointsPerService { get; set; }
    ...
    /// [Default: 100]
    /// </summary>
    [JsonPropertyName("bpfMaglevMaxServices")]
    public int? BpfMaglevMaxServices { get; set; }
    ...
    public IntOrString? BpfPSNATPorts { get; set; }
    ...
    public V1FelixConfigurationSpecBpfProfilingEnum? BpfProfiling { get; set; }
    ...
    public V1FelixConfigurationSpecBpfRedirectToPeerEnum? BpfRedirectToPeer { get; set; }

    /// <summary>CgroupV2Path overrides the default location where to find the cgroup hierarchy.</summary>
    [JsonPropertyName("cgroupV2Path")]
    public string? CgroupV2Path { get; set; }
    ...
    public V1FelixConfigurationSpecFlowLogsLocalReporterEnum? FlowLogsLocalReporter { get; set; }
    ...
    public V1FelixConfigurationSpecFlowLogsPolicyEvaluationModeEnum? FlowLogsPolicyEvaluationMode { get; set; }
    ...
    public V1FelixConfigurationSpecIpForwardingEnum? IpForwarding { get; set; }
    ...
    public V1FelixConfigurationSpecIptablesBackendEnum? IptablesBackend { get; set; }
    ...
    /// [Default: 512]
    /// </summary>
    [JsonPropertyName("ipv4ElevatedRoutePriority")]
    public int? Ipv4ElevatedRoutePriority { get; set; }
    ...
    /// [Default: 512]
    /// </summary>
    [JsonPropertyName("ipv6ElevatedRoutePriority")]
    public int? Ipv6ElevatedRoutePriority { get; set; }
    ...
    /// [Default: Disabled]
    /// </summary>
    [JsonPropertyName("istioAmbientMode")]
    public V1FelixConfigurationSpecIstioAmbientModeEnum? IstioAmbientMode { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("istioDSCPMark")]
    public IntOrString? IstioDSCPMark { get; set; }
    ...
    public IList<IntOrString>? KubeNodePortRanges { get; set; }
    ...
    public V1FelixConfigurationSpecNatOutgoingExclusionsEnum? NatOutgoingExclusions { get; set; }
    ...
    public IntOrString? NatPortRange { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("prometheusMetricsCAFile")]
    public string? PrometheusMetricsCAFile { get; set; }

    /// <summary>
    /// PrometheusMetricsCertFile defines the absolute path to the TLS certificate file used for securing the /metrics endpoint.
    /// This certificate must be valid and accessible by the calico-node process.
    /// </summary>
    [JsonPropertyName("prometheusMetricsCertFile")]
    public string? PrometheusMetricsCertFile { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("prometheusMetricsKeyFile")]
    public string? PrometheusMetricsKeyFile { get; set; }
...
public partial class V1FelixConfiguration : IKubernetesObject<V1ObjectMeta>, ISpec<V1FelixConfigurationSpec?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "FelixConfiguration";
