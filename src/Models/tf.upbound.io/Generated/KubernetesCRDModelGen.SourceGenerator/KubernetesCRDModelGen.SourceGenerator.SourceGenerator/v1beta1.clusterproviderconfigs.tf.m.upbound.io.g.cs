...
namespace KubernetesCRDModelGen.Models.tf.m.upbound.io;
/// <summary>A ClusterProviderConfig configures a Terraform provider.</summary>
...
public partial class V1beta1ClusterProviderConfigList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ClusterProviderConfig>
{
    ...
    public const string KubeGroup = "tf.m.upbound.io";
    ...
    public string ApiVersion { get; set; } = "tf.m.upbound.io/v1beta1";
