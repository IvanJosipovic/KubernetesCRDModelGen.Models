...
public partial class V1api20180501DnsZonesTXTRecordList : IKubernetesObject<V1ListMeta>, IItems<V1api20180501DnsZonesTXTRecord>
{
    ...
    /// <summary>List of V1api20180501DnsZonesTXTRecord objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1api20180501DnsZonesTXTRecord> Items { get; set; }
}
...
public partial class V1api20180501DnsZonesTXTRecordSpecOperatorSpec
{
    ...
    public IList<V1api20180501DnsZonesTXTRecordSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary>SecretExpressions: configures where to place operator written dynamic secrets (created with CEL expressions).</summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20180501DnsZonesTXTRecordSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V1api20180501DnsZonesTXTRecordSpec
{
    ...
    public IList<V1api20180501DnsZonesTXTRecordSpecAAAARecords>? AAAARecords { get; set; }

    /// <summary>ARecords: The list of A records in the record set.</summary>
    [JsonPropertyName("ARecords")]
    public IList<V1api20180501DnsZonesTXTRecordSpecARecords>? ARecords { get; set; }

    /// <summary>CNAMERecord: The CNAME record in the  record set.</summary>
    [JsonPropertyName("CNAMERecord")]
    public V1api20180501DnsZonesTXTRecordSpecCNAMERecord? CNAMERecord { get; set; }

    /// <summary>MXRecords: The list of MX records in the record set.</summary>
    [JsonPropertyName("MXRecords")]
    public IList<V1api20180501DnsZonesTXTRecordSpecMXRecords>? MXRecords { get; set; }

    /// <summary>NSRecords: The list of NS records in the record set.</summary>
    [JsonPropertyName("NSRecords")]
    public IList<V1api20180501DnsZonesTXTRecordSpecNSRecords>? NSRecords { get; set; }

    /// <summary>PTRRecords: The list of PTR records in the record set.</summary>
    [JsonPropertyName("PTRRecords")]
    public IList<V1api20180501DnsZonesTXTRecordSpecPTRRecords>? PTRRecords { get; set; }

    /// <summary>SOARecord: The SOA record in the record set.</summary>
    [JsonPropertyName("SOARecord")]
    public V1api20180501DnsZonesTXTRecordSpecSOARecord? SOARecord { get; set; }

    /// <summary>SRVRecords: The list of SRV records in the record set.</summary>
    [JsonPropertyName("SRVRecords")]
    public IList<V1api20180501DnsZonesTXTRecordSpecSRVRecords>? SRVRecords { get; set; }
    ...
    public IList<V1api20180501DnsZonesTXTRecordSpecTXTRecords>? TXTRecords { get; set; }
    ...
    public IList<V1api20180501DnsZonesTXTRecordSpecCaaRecords>? CaaRecords { get; set; }
    ...
    public V1api20180501DnsZonesTXTRecordSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V1api20180501DnsZonesTXTRecordSpecOwner Owner { get; set; }

    /// <summary>TargetResource: A reference to an azure resource from where the dns resource value is taken.</summary>
    [JsonPropertyName("targetResource")]
    public V1api20180501DnsZonesTXTRecordSpecTargetResource? TargetResource { get; set; }
}
...
public partial class V1api20180501DnsZonesTXTRecordStatus
{
    /// <summary>AAAARecords: The list of AAAA records in the record set.</summary>
    [JsonPropertyName("AAAARecords")]
    public IList<V1api20180501DnsZonesTXTRecordStatusAAAARecords>? AAAARecords { get; set; }

    /// <summary>ARecords: The list of A records in the record set.</summary>
    [JsonPropertyName("ARecords")]
    public IList<V1api20180501DnsZonesTXTRecordStatusARecords>? ARecords { get; set; }

    /// <summary>CNAMERecord: The CNAME record in the  record set.</summary>
    [JsonPropertyName("CNAMERecord")]
    public V1api20180501DnsZonesTXTRecordStatusCNAMERecord? CNAMERecord { get; set; }

    /// <summary>MXRecords: The list of MX records in the record set.</summary>
    [JsonPropertyName("MXRecords")]
    public IList<V1api20180501DnsZonesTXTRecordStatusMXRecords>? MXRecords { get; set; }

    /// <summary>NSRecords: The list of NS records in the record set.</summary>
    [JsonPropertyName("NSRecords")]
    public IList<V1api20180501DnsZonesTXTRecordStatusNSRecords>? NSRecords { get; set; }

    /// <summary>PTRRecords: The list of PTR records in the record set.</summary>
    [JsonPropertyName("PTRRecords")]
    public IList<V1api20180501DnsZonesTXTRecordStatusPTRRecords>? PTRRecords { get; set; }

    /// <summary>SOARecord: The SOA record in the record set.</summary>
    [JsonPropertyName("SOARecord")]
    public V1api20180501DnsZonesTXTRecordStatusSOARecord? SOARecord { get; set; }

    /// <summary>SRVRecords: The list of SRV records in the record set.</summary>
    [JsonPropertyName("SRVRecords")]
    public IList<V1api20180501DnsZonesTXTRecordStatusSRVRecords>? SRVRecords { get; set; }
    ...
    /// <summary>TXTRecords: The list of TXT records in the record set.</summary>
    [JsonPropertyName("TXTRecords")]
    public IList<V1api20180501DnsZonesTXTRecordStatusTXTRecords>? TXTRecords { get; set; }

    /// <summary>CaaRecords: The list of CAA records in the record set.</summary>
    [JsonPropertyName("caaRecords")]
    public IList<V1api20180501DnsZonesTXTRecordStatusCaaRecords>? CaaRecords { get; set; }

    /// <summary>Conditions: The observed state of the resource</summary>
    [JsonPropertyName("conditions")]
    public IList<V1api20180501DnsZonesTXTRecordStatusConditions>? Conditions { get; set; }
    ...
    /// <summary>TargetResource: A reference to an azure resource from where the dns resource value is taken.</summary>
    [JsonPropertyName("targetResource")]
    public V1api20180501DnsZonesTXTRecordStatusTargetResource? TargetResource { get; set; }
...
public partial class V1api20180501DnsZonesTXTRecord : IKubernetesObject<V1ObjectMeta>, ISpec<V1api20180501DnsZonesTXTRecordSpec?>, IStatus<V1api20180501DnsZonesTXTRecordStatus?>
{
    ...
    public V1api20180501DnsZonesTXTRecordSpec? Spec { get; set; }

    [JsonPropertyName("status")]
    public V1api20180501DnsZonesTXTRecordStatus? Status { get; set; }
}