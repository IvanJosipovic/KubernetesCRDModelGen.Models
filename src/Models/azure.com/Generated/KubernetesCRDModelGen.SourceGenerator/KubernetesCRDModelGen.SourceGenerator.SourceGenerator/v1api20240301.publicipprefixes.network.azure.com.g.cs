...
public partial class V1api20240301PublicIPPrefixList : IKubernetesObject<V1ListMeta>, IItems<V1api20240301PublicIPPrefix>
{
    ...
    /// <summary>List of V1api20240301PublicIPPrefix objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1api20240301PublicIPPrefix> Items { get; set; }
}
...
public partial class V1api20240301PublicIPPrefixSpecCustomIPPrefix
{
    ...
    public V1api20240301PublicIPPrefixSpecCustomIPPrefixReference? Reference { get; set; }
}
...
public partial class V1api20240301PublicIPPrefixSpecExtendedLocation
{
    ...
    public V1api20240301PublicIPPrefixSpecExtendedLocationTypeEnum? Type { get; set; }
}
...
public partial class V1api20240301PublicIPPrefixSpecNatGateway
{
    /// <summary>Reference: Resource ID.</summary>
    [JsonPropertyName("reference")]
    public V1api20240301PublicIPPrefixSpecNatGatewayReference? Reference { get; set; }
}
...
public partial class V1api20240301PublicIPPrefixSpecOperatorSpec
{
    ...
    public IList<V1api20240301PublicIPPrefixSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary>SecretExpressions: configures where to place operator written dynamic secrets (created with CEL expressions).</summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20240301PublicIPPrefixSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V1api20240301PublicIPPrefixSpecSku
{
    /// <summary>Name: Name of a public IP prefix SKU.</summary>
    [JsonPropertyName("name")]
    public V1api20240301PublicIPPrefixSpecSkuNameEnum? Name { get; set; }
...
public partial class V1api20240301PublicIPPrefixSpec
{
    ...
    public V1api20240301PublicIPPrefixSpecCustomIPPrefix? CustomIPPrefix { get; set; }

    /// <summary>ExtendedLocation: The extended location of the public ip address.</summary>
    [JsonPropertyName("extendedLocation")]
    public V1api20240301PublicIPPrefixSpecExtendedLocation? ExtendedLocation { get; set; }

    /// <summary>IpTags: The list of tags associated with the public IP prefix.</summary>
    [JsonPropertyName("ipTags")]
    public IList<V1api20240301PublicIPPrefixSpecIpTags>? IpTags { get; set; }
    ...
    public V1api20240301PublicIPPrefixSpecNatGateway? NatGateway { get; set; }
    ...
    public V1api20240301PublicIPPrefixSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V1api20240301PublicIPPrefixSpecOwner Owner { get; set; }
    ...
    public V1api20240301PublicIPPrefixSpecPublicIPAddressVersionEnum? PublicIPAddressVersion { get; set; }

    /// <summary>Sku: The public IP prefix SKU.</summary>
    [JsonPropertyName("sku")]
    public V1api20240301PublicIPPrefixSpecSku? Sku { get; set; }
...
public partial class V1api20240301PublicIPPrefixStatus
{
    ...
    public IList<V1api20240301PublicIPPrefixStatusConditions>? Conditions { get; set; }

    /// <summary>CustomIPPrefix: The customIpPrefix that this prefix is associated with.</summary>
    [JsonPropertyName("customIPPrefix")]
    public V1api20240301PublicIPPrefixStatusCustomIPPrefix? CustomIPPrefix { get; set; }
    ...
    /// <summary>ExtendedLocation: The extended location of the public ip address.</summary>
    [JsonPropertyName("extendedLocation")]
    public V1api20240301PublicIPPrefixStatusExtendedLocation? ExtendedLocation { get; set; }
    ...
    /// <summary>IpTags: The list of tags associated with the public IP prefix.</summary>
    [JsonPropertyName("ipTags")]
    public IList<V1api20240301PublicIPPrefixStatusIpTags>? IpTags { get; set; }
    ...
    public V1api20240301PublicIPPrefixStatusLoadBalancerFrontendIpConfiguration? LoadBalancerFrontendIpConfiguration { get; set; }
    ...
    /// <summary>NatGateway: NatGateway of Public IP Prefix.</summary>
    [JsonPropertyName("natGateway")]
    public V1api20240301PublicIPPrefixStatusNatGateway? NatGateway { get; set; }
    ...
    public IList<V1api20240301PublicIPPrefixStatusPublicIPAddresses>? PublicIPAddresses { get; set; }
    ...
    /// <summary>Sku: The public IP prefix SKU.</summary>
    [JsonPropertyName("sku")]
    public V1api20240301PublicIPPrefixStatusSku? Sku { get; set; }
...
public partial class V1api20240301PublicIPPrefix : IKubernetesObject<V1ObjectMeta>, ISpec<V1api20240301PublicIPPrefixSpec?>, IStatus<V1api20240301PublicIPPrefixStatus?>
{
    ...
    public V1api20240301PublicIPPrefixSpec? Spec { get; set; }

    /// <summary>Public IP prefix resource.</summary>
    [JsonPropertyName("status")]
    public V1api20240301PublicIPPrefixStatus? Status { get; set; }
}