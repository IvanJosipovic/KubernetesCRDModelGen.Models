...
public partial class V1api20230501previewstorageApiList : IKubernetesObject<V1ListMeta>, IItems<V1api20230501previewstorageApi>
{
    ...
    /// <summary>List of V1api20230501previewstorageApi objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1api20230501previewstorageApi> Items { get; set; }
}
...
public partial class V1api20230501previewstorageApiSpecApiVersionSet
{
    ...
    public V1api20230501previewstorageApiSpecApiVersionSetReference? Reference { get; set; }
...
public partial class V1api20230501previewstorageApiSpecAuthenticationSettings
{
    ...
    public V1api20230501previewstorageApiSpecAuthenticationSettingsOAuth2? OAuth2 { get; set; }

    [JsonPropertyName("oAuth2AuthenticationSettings")]
    public IList<V1api20230501previewstorageApiSpecAuthenticationSettingsOAuth2AuthenticationSettings>? OAuth2AuthenticationSettings { get; set; }
    ...
    public V1api20230501previewstorageApiSpecAuthenticationSettingsOpenid? Openid { get; set; }

    [JsonPropertyName("openidAuthenticationSettings")]
    public IList<V1api20230501previewstorageApiSpecAuthenticationSettingsOpenidAuthenticationSettings>? OpenidAuthenticationSettings { get; set; }
}
...
public partial class V1api20230501previewstorageApiSpecOperatorSpec
{
    ...
    public IList<V1api20230501previewstorageApiSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    [JsonPropertyName("secretExpressions")]
    public IList<V1api20230501previewstorageApiSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V1api20230501previewstorageApiSpec
{
    ...
    public V1api20230501previewstorageApiSpecApiVersionSet? ApiVersionSet { get; set; }

    /// <summary>ApiVersionSetReference: A resource identifier for the related ApiVersionSet.</summary>
    [JsonPropertyName("apiVersionSetReference")]
    public V1api20230501previewstorageApiSpecApiVersionSetReference1? ApiVersionSetReference { get; set; }
    ...
    public V1api20230501previewstorageApiSpecAuthenticationSettings? AuthenticationSettings { get; set; }
    ...
    public V1api20230501previewstorageApiSpecContact? Contact { get; set; }
    ...
    public V1api20230501previewstorageApiSpecLicense? License { get; set; }
    ...
    public V1api20230501previewstorageApiSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V1api20230501previewstorageApiSpecOwner Owner { get; set; }
    ...
    public V1api20230501previewstorageApiSpecSourceApiReference? SourceApiReference { get; set; }
    ...
    public V1api20230501previewstorageApiSpecSubscriptionKeyParameterNames? SubscriptionKeyParameterNames { get; set; }
    ...
    public V1api20230501previewstorageApiSpecWsdlSelector? WsdlSelector { get; set; }
}
...
public partial class V1api20230501previewstorageApiStatusAuthenticationSettings
{
    ...
    /// </summary>
    [JsonPropertyName("oAuth2")]
    public V1api20230501previewstorageApiStatusAuthenticationSettingsOAuth2? OAuth2 { get; set; }

    [JsonPropertyName("oAuth2AuthenticationSettings")]
    public IList<V1api20230501previewstorageApiStatusAuthenticationSettingsOAuth2AuthenticationSettings>? OAuth2AuthenticationSettings { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("openid")]
    public V1api20230501previewstorageApiStatusAuthenticationSettingsOpenid? Openid { get; set; }

    [JsonPropertyName("openidAuthenticationSettings")]
    public IList<V1api20230501previewstorageApiStatusAuthenticationSettingsOpenidAuthenticationSettings>? OpenidAuthenticationSettings { get; set; }
}
...
public partial class V1api20230501previewstorageApiStatus
{
    ...
    /// </summary>
    [JsonPropertyName("apiVersionSet")]
    public V1api20230501previewstorageApiStatusApiVersionSet? ApiVersionSet { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("authenticationSettings")]
    public V1api20230501previewstorageApiStatusAuthenticationSettings? AuthenticationSettings { get; set; }

    [JsonPropertyName("conditions")]
    public IList<V1api20230501previewstorageApiStatusConditions>? Conditions { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("contact")]
    public V1api20230501previewstorageApiStatusContact? Contact { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("license")]
    public V1api20230501previewstorageApiStatusLicense? License { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("subscriptionKeyParameterNames")]
    public V1api20230501previewstorageApiStatusSubscriptionKeyParameterNames? SubscriptionKeyParameterNames { get; set; }
...
public partial class V1api20230501previewstorageApi : IKubernetesObject<V1ObjectMeta>, ISpec<V1api20230501previewstorageApiSpec?>, IStatus<V1api20230501previewstorageApiStatus?>
{
    ...
    public V1api20230501previewstorageApiSpec? Spec { get; set; }

    /// <summary>Storage version of v1api20230501preview.Api_STATUS</summary>
    [JsonPropertyName("status")]
    public V1api20230501previewstorageApiStatus? Status { get; set; }
}