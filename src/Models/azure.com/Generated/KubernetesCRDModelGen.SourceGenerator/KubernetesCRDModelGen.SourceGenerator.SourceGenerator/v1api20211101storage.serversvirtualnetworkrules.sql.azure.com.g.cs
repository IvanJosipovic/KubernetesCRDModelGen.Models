...
public partial class V1api20211101storageServersVirtualNetworkRuleList : IKubernetesObject<V1ListMeta>, IItems<V1api20211101storageServersVirtualNetworkRule>
{
    ...
    /// <summary>List of V1api20211101storageServersVirtualNetworkRule objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1api20211101storageServersVirtualNetworkRule> Items { get; set; }
}
...
public partial class V1api20211101storageServersVirtualNetworkRuleSpec
{
    ...
    public required V1api20211101storageServersVirtualNetworkRuleSpecOwner Owner { get; set; }

    /// <summary>VirtualNetworkSubnetReference: The ARM resource id of the virtual network subnet.</summary>
    [JsonPropertyName("virtualNetworkSubnetReference")]
    public required V1api20211101storageServersVirtualNetworkRuleSpecVirtualNetworkSubnetReference VirtualNetworkSubnetReference { get; set; }
}
