...
public partial class V1UserList : IKubernetesObject<V1ListMeta>, IItems<V1User>
{
    ...
    public string ApiVersion { get; set; } = "dbforpostgresql.azure.com/v1";
...
public partial class V1UserSpecLocalUser
{
    ...
    public required V1UserSpecLocalUserServerAdminPassword ServerAdminPassword { get; set; }
...
public partial class V1UserSpec
{
    ...
    public required V1UserSpecLocalUser LocalUser { get; set; }
