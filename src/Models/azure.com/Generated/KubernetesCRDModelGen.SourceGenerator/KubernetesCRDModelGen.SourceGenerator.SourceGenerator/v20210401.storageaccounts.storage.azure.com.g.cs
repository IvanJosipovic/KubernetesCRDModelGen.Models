...
public partial class V20210401StorageAccountList : IKubernetesObject<V1ListMeta>, IItems<V20210401StorageAccount>
{
    ...
    /// <summary>List of V20210401StorageAccount objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V20210401StorageAccount> Items { get; set; }
}
...
public partial class V20210401StorageAccountSpecAzureFilesIdentityBasedAuthentication
{
    ...
    public V20210401StorageAccountSpecAzureFilesIdentityBasedAuthenticationActiveDirectoryProperties? ActiveDirectoryProperties { get; set; }

    /// <summary>DefaultSharePermission: Default share permission for users using Kerberos authentication if RBAC role is not assigned.</summary>
    [JsonPropertyName("defaultSharePermission")]
    public V20210401StorageAccountSpecAzureFilesIdentityBasedAuthenticationDefaultSharePermissionEnum? DefaultSharePermission { get; set; }

    /// <summary>DirectoryServiceOptions: Indicates the directory service used.</summary>
    [JsonPropertyName("directoryServiceOptions")]
    public required V20210401StorageAccountSpecAzureFilesIdentityBasedAuthenticationDirectoryServiceOptionsEnum DirectoryServiceOptions { get; set; }
}
...
public partial class V20210401StorageAccountSpecEncryptionIdentity
{
    ...
    public V20210401StorageAccountSpecEncryptionIdentityUserAssignedIdentityReference? UserAssignedIdentityReference { get; set; }
}
...
public partial class V20210401StorageAccountSpecEncryptionServicesBlob
{
    ...
    public V20210401StorageAccountSpecEncryptionServicesBlobKeyTypeEnum? KeyType { get; set; }
}
...
public partial class V20210401StorageAccountSpecEncryptionServicesFile
{
    ...
    /// </summary>
    [JsonPropertyName("keyType")]
    public V20210401StorageAccountSpecEncryptionServicesFileKeyTypeEnum? KeyType { get; set; }
}
...
public partial class V20210401StorageAccountSpecEncryptionServicesQueue
{
    ...
    /// </summary>
    [JsonPropertyName("keyType")]
    public V20210401StorageAccountSpecEncryptionServicesQueueKeyTypeEnum? KeyType { get; set; }
}
...
public partial class V20210401StorageAccountSpecEncryptionServicesTable
{
    ...
    /// </summary>
    [JsonPropertyName("keyType")]
    public V20210401StorageAccountSpecEncryptionServicesTableKeyTypeEnum? KeyType { get; set; }
}
...
public partial class V20210401StorageAccountSpecEncryptionServices
{
    ...
    public V20210401StorageAccountSpecEncryptionServicesBlob? Blob { get; set; }

    /// <summary>File: The encryption function of the file storage service.</summary>
    [JsonPropertyName("file")]
    public V20210401StorageAccountSpecEncryptionServicesFile? File { get; set; }

    /// <summary>Queue: The encryption function of the queue storage service.</summary>
    [JsonPropertyName("queue")]
    public V20210401StorageAccountSpecEncryptionServicesQueue? Queue { get; set; }

    /// <summary>Table: The encryption function of the table storage service.</summary>
    [JsonPropertyName("table")]
    public V20210401StorageAccountSpecEncryptionServicesTable? Table { get; set; }
}
...
public partial class V20210401StorageAccountSpecEncryption
{
    ...
    public V20210401StorageAccountSpecEncryptionIdentity? Identity { get; set; }
    ...
    public required V20210401StorageAccountSpecEncryptionKeySourceEnum KeySource { get; set; }

    /// <summary>Keyvaultproperties: Properties provided by key vault.</summary>
    [JsonPropertyName("keyvaultproperties")]
    public V20210401StorageAccountSpecEncryptionKeyvaultproperties? Keyvaultproperties { get; set; }
    ...
    public V20210401StorageAccountSpecEncryptionServices? Services { get; set; }
}
...
public partial class V20210401StorageAccountSpecExtendedLocation
{
    ...
    public V20210401StorageAccountSpecExtendedLocationTypeEnum? Type { get; set; }
}
...
public partial class V20210401StorageAccountSpecIdentityUserAssignedIdentities
{
    ...
    public V20210401StorageAccountSpecIdentityUserAssignedIdentitiesReference? Reference { get; set; }
}
...
public partial class V20210401StorageAccountSpecIdentity
{
    /// <summary>Type: The identity type.</summary>
    [JsonPropertyName("type")]
    public required V20210401StorageAccountSpecIdentityTypeEnum Type { get; set; }
    ...
    public IList<V20210401StorageAccountSpecIdentityUserAssignedIdentities>? UserAssignedIdentities { get; set; }
}
...
public partial class V20210401StorageAccountSpecNetworkAclsIpRules
{
    ...
    public V20210401StorageAccountSpecNetworkAclsIpRulesActionEnum? Action { get; set; }
    ...
    public V20210401StorageAccountSpecNetworkAclsIpRulesValueFromConfig? ValueFromConfig { get; set; }
}
...
public partial class V20210401StorageAccountSpecNetworkAclsResourceAccessRules
{
    ...
    public V20210401StorageAccountSpecNetworkAclsResourceAccessRulesResourceReference? ResourceReference { get; set; }
...
public partial class V20210401StorageAccountSpecNetworkAclsVirtualNetworkRules
{
    /// <summary>Action: The action of virtual network rule.</summary>
    [JsonPropertyName("action")]
    public V20210401StorageAccountSpecNetworkAclsVirtualNetworkRulesActionEnum? Action { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("reference")]
    public required V20210401StorageAccountSpecNetworkAclsVirtualNetworkRulesReference Reference { get; set; }

    /// <summary>State: Gets the state of virtual network rule.</summary>
    [JsonPropertyName("state")]
    public V20210401StorageAccountSpecNetworkAclsVirtualNetworkRulesStateEnum? State { get; set; }
}
...
public partial class V20210401StorageAccountSpecNetworkAcls
{
    ...
    public required V20210401StorageAccountSpecNetworkAclsDefaultActionEnum DefaultAction { get; set; }

    /// <summary>IpRules: Sets the IP ACL rules</summary>
    [JsonPropertyName("ipRules")]
    public IList<V20210401StorageAccountSpecNetworkAclsIpRules>? IpRules { get; set; }

    /// <summary>ResourceAccessRules: Sets the resource access rules</summary>
    [JsonPropertyName("resourceAccessRules")]
    public IList<V20210401StorageAccountSpecNetworkAclsResourceAccessRules>? ResourceAccessRules { get; set; }

    /// <summary>VirtualNetworkRules: Sets the virtual network rules</summary>
    [JsonPropertyName("virtualNetworkRules")]
    public IList<V20210401StorageAccountSpecNetworkAclsVirtualNetworkRules>? VirtualNetworkRules { get; set; }
}
...
public partial class V20210401StorageAccountSpecOperatorSpecConfigMaps
{
    ...
    public V20210401StorageAccountSpecOperatorSpecConfigMapsBlobEndpoint? BlobEndpoint { get; set; }

    /// <summary>DfsEndpoint: indicates where the DfsEndpoint config map should be placed. If omitted, no config map will be created.</summary>
    [JsonPropertyName("dfsEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecConfigMapsDfsEndpoint? DfsEndpoint { get; set; }

    /// <summary>FileEndpoint: indicates where the FileEndpoint config map should be placed. If omitted, no config map will be created.</summary>
    [JsonPropertyName("fileEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecConfigMapsFileEndpoint? FileEndpoint { get; set; }

    /// <summary>QueueEndpoint: indicates where the QueueEndpoint config map should be placed. If omitted, no config map will be created.</summary>
    [JsonPropertyName("queueEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecConfigMapsQueueEndpoint? QueueEndpoint { get; set; }

    /// <summary>TableEndpoint: indicates where the TableEndpoint config map should be placed. If omitted, no config map will be created.</summary>
    [JsonPropertyName("tableEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecConfigMapsTableEndpoint? TableEndpoint { get; set; }

    /// <summary>WebEndpoint: indicates where the WebEndpoint config map should be placed. If omitted, no config map will be created.</summary>
    [JsonPropertyName("webEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecConfigMapsWebEndpoint? WebEndpoint { get; set; }
}
...
public partial class V20210401StorageAccountSpecOperatorSpecSecrets
{
    ...
    /// </summary>
    [JsonPropertyName("blobEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecSecretsBlobEndpoint? BlobEndpoint { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("dfsEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecSecretsDfsEndpoint? DfsEndpoint { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("fileEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecSecretsFileEndpoint? FileEndpoint { get; set; }

    /// <summary>Key1: indicates where the Key1 secret should be placed. If omitted, the secret will not be retrieved from Azure.</summary>
    [JsonPropertyName("key1")]
    public V20210401StorageAccountSpecOperatorSpecSecretsKey1? Key1 { get; set; }

    /// <summary>Key2: indicates where the Key2 secret should be placed. If omitted, the secret will not be retrieved from Azure.</summary>
    [JsonPropertyName("key2")]
    public V20210401StorageAccountSpecOperatorSpecSecretsKey2? Key2 { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("queueEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecSecretsQueueEndpoint? QueueEndpoint { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("tableEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecSecretsTableEndpoint? TableEndpoint { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("webEndpoint")]
    public V20210401StorageAccountSpecOperatorSpecSecretsWebEndpoint? WebEndpoint { get; set; }
}
...
public partial class V20210401StorageAccountSpecOperatorSpec
{
    ...
    public IList<V20210401StorageAccountSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary>ConfigMaps: configures where to place operator written ConfigMaps.</summary>
    [JsonPropertyName("configMaps")]
    public V20210401StorageAccountSpecOperatorSpecConfigMaps? ConfigMaps { get; set; }

    /// <summary>SecretExpressions: configures where to place operator written dynamic secrets (created with CEL expressions).</summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V20210401StorageAccountSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }

    /// <summary>Secrets: configures where to place Azure generated secrets.</summary>
    [JsonPropertyName("secrets")]
    public V20210401StorageAccountSpecOperatorSpecSecrets? Secrets { get; set; }
}
...
public partial class V20210401StorageAccountSpecRoutingPreference
{
    ...
    public V20210401StorageAccountSpecRoutingPreferenceRoutingChoiceEnum? RoutingChoice { get; set; }
}
...
public partial class V20210401StorageAccountSpecSasPolicy
{
    ...
    public required V20210401StorageAccountSpecSasPolicyExpirationActionEnum ExpirationAction { get; set; }
...
public partial class V20210401StorageAccountSpecSku
{
    ...
    /// </summary>
    [JsonPropertyName("name")]
    public required V20210401StorageAccountSpecSkuNameEnum Name { get; set; }
...
public partial class V20210401StorageAccountSpec
{
    ...
    public V20210401StorageAccountSpecAccessTierEnum? AccessTier { get; set; }
    ...
    public V20210401StorageAccountSpecAzureFilesIdentityBasedAuthentication? AzureFilesIdentityBasedAuthentication { get; set; }
    ...
    public V20210401StorageAccountSpecCustomDomain? CustomDomain { get; set; }

    /// <summary>Encryption: Not applicable. Azure Storage encryption is enabled for all storage accounts and cannot be disabled.</summary>
    [JsonPropertyName("encryption")]
    public V20210401StorageAccountSpecEncryption? Encryption { get; set; }
    ...
    public V20210401StorageAccountSpecExtendedLocation? ExtendedLocation { get; set; }

    /// <summary>Identity: The identity of the resource.</summary>
    [JsonPropertyName("identity")]
    public V20210401StorageAccountSpecIdentity? Identity { get; set; }
    ...
    public V20210401StorageAccountSpecKeyPolicy? KeyPolicy { get; set; }

    /// <summary>Kind: Required. Indicates the type of storage account.</summary>
    [JsonPropertyName("kind")]
    public required V20210401StorageAccountSpecKindEnum Kind { get; set; }

    /// <summary>LargeFileSharesState: Allow large file shares if sets to Enabled. It cannot be disabled once it is enabled.</summary>
    [JsonPropertyName("largeFileSharesState")]
    public V20210401StorageAccountSpecLargeFileSharesStateEnum? LargeFileSharesState { get; set; }
    ...
    public V20210401StorageAccountSpecMinimumTlsVersionEnum? MinimumTlsVersion { get; set; }

    /// <summary>NetworkAcls: Network rule set</summary>
    [JsonPropertyName("networkAcls")]
    public V20210401StorageAccountSpecNetworkAcls? NetworkAcls { get; set; }
    ...
    public V20210401StorageAccountSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V20210401StorageAccountSpecOwner Owner { get; set; }

    /// <summary>RoutingPreference: Maintains information about the network routing choice opted by the user for data transfer</summary>
    [JsonPropertyName("routingPreference")]
    public V20210401StorageAccountSpecRoutingPreference? RoutingPreference { get; set; }

    /// <summary>SasPolicy: SasPolicy assigned to the storage account.</summary>
    [JsonPropertyName("sasPolicy")]
    public V20210401StorageAccountSpecSasPolicy? SasPolicy { get; set; }

    /// <summary>Sku: Required. Gets or sets the SKU name.</summary>
    [JsonPropertyName("sku")]
    public required V20210401StorageAccountSpecSku Sku { get; set; }
...
public partial class V20210401StorageAccountStatusAzureFilesIdentityBasedAuthentication
{
    /// <summary>ActiveDirectoryProperties: Required if choose AD.</summary>
    [JsonPropertyName("activeDirectoryProperties")]
    public V20210401StorageAccountStatusAzureFilesIdentityBasedAuthenticationActiveDirectoryProperties? ActiveDirectoryProperties { get; set; }
...
public partial class V20210401StorageAccountStatusBlobRestoreStatusParameters
{
    ...
    public IList<V20210401StorageAccountStatusBlobRestoreStatusParametersBlobRanges>? BlobRanges { get; set; }
...
public partial class V20210401StorageAccountStatusBlobRestoreStatus
{
    ...
    public V20210401StorageAccountStatusBlobRestoreStatusParameters? Parameters { get; set; }
...
public partial class V20210401StorageAccountStatusEncryptionServices
{
    /// <summary>Blob: The encryption function of the blob storage service.</summary>
    [JsonPropertyName("blob")]
    public V20210401StorageAccountStatusEncryptionServicesBlob? Blob { get; set; }

    /// <summary>File: The encryption function of the file storage service.</summary>
    [JsonPropertyName("file")]
    public V20210401StorageAccountStatusEncryptionServicesFile? File { get; set; }

    /// <summary>Queue: The encryption function of the queue storage service.</summary>
    [JsonPropertyName("queue")]
    public V20210401StorageAccountStatusEncryptionServicesQueue? Queue { get; set; }

    /// <summary>Table: The encryption function of the table storage service.</summary>
    [JsonPropertyName("table")]
    public V20210401StorageAccountStatusEncryptionServicesTable? Table { get; set; }
}
...
public partial class V20210401StorageAccountStatusEncryption
{
    /// <summary>Identity: The identity to be used with service-side encryption at rest.</summary>
    [JsonPropertyName("identity")]
    public V20210401StorageAccountStatusEncryptionIdentity? Identity { get; set; }
    ...
    /// <summary>Keyvaultproperties: Properties provided by key vault.</summary>
    [JsonPropertyName("keyvaultproperties")]
    public V20210401StorageAccountStatusEncryptionKeyvaultproperties? Keyvaultproperties { get; set; }
    ...
    /// <summary>Services: List of services which support encryption.</summary>
    [JsonPropertyName("services")]
    public V20210401StorageAccountStatusEncryptionServices? Services { get; set; }
}
...
public partial class V20210401StorageAccountStatusIdentity
{
    ...
    /// </summary>
    [JsonPropertyName("userAssignedIdentities")]
    public IDictionary<string, V20210401StorageAccountStatusIdentityUserAssignedIdentities>? UserAssignedIdentities { get; set; }
}
...
public partial class V20210401StorageAccountStatusNetworkAcls
{
    ...
    /// <summary>IpRules: Sets the IP ACL rules</summary>
    [JsonPropertyName("ipRules")]
    public IList<V20210401StorageAccountStatusNetworkAclsIpRules>? IpRules { get; set; }

    /// <summary>ResourceAccessRules: Sets the resource access rules</summary>
    [JsonPropertyName("resourceAccessRules")]
    public IList<V20210401StorageAccountStatusNetworkAclsResourceAccessRules>? ResourceAccessRules { get; set; }

    /// <summary>VirtualNetworkRules: Sets the virtual network rules</summary>
    [JsonPropertyName("virtualNetworkRules")]
    public IList<V20210401StorageAccountStatusNetworkAclsVirtualNetworkRules>? VirtualNetworkRules { get; set; }
}
...
public partial class V20210401StorageAccountStatusPrimaryEndpoints
{
    ...
    public V20210401StorageAccountStatusPrimaryEndpointsInternetEndpoints? InternetEndpoints { get; set; }

    /// <summary>MicrosoftEndpoints: Gets the microsoft routing storage endpoints.</summary>
    [JsonPropertyName("microsoftEndpoints")]
    public V20210401StorageAccountStatusPrimaryEndpointsMicrosoftEndpoints? MicrosoftEndpoints { get; set; }
...
public partial class V20210401StorageAccountStatusSecondaryEndpoints
{
    ...
    /// <summary>InternetEndpoints: Gets the internet routing storage endpoints</summary>
    [JsonPropertyName("internetEndpoints")]
    public V20210401StorageAccountStatusSecondaryEndpointsInternetEndpoints? InternetEndpoints { get; set; }

    /// <summary>MicrosoftEndpoints: Gets the microsoft routing storage endpoints.</summary>
    [JsonPropertyName("microsoftEndpoints")]
    public V20210401StorageAccountStatusSecondaryEndpointsMicrosoftEndpoints? MicrosoftEndpoints { get; set; }
...
public partial class V20210401StorageAccountStatus
{
    ...
    /// <summary>AzureFilesIdentityBasedAuthentication: Provides the identity based authentication settings for Azure Files.</summary>
    [JsonPropertyName("azureFilesIdentityBasedAuthentication")]
    public V20210401StorageAccountStatusAzureFilesIdentityBasedAuthentication? AzureFilesIdentityBasedAuthentication { get; set; }

    /// <summary>BlobRestoreStatus: Blob restore status</summary>
    [JsonPropertyName("blobRestoreStatus")]
    public V20210401StorageAccountStatusBlobRestoreStatus? BlobRestoreStatus { get; set; }

    /// <summary>Conditions: The observed state of the resource</summary>
    [JsonPropertyName("conditions")]
    public IList<V20210401StorageAccountStatusConditions>? Conditions { get; set; }
    ...
    /// <summary>CustomDomain: Gets the custom domain the user assigned to this storage account.</summary>
    [JsonPropertyName("customDomain")]
    public V20210401StorageAccountStatusCustomDomain? CustomDomain { get; set; }

    /// <summary>Encryption: Gets the encryption settings on the account. If unspecified, the account is unencrypted.</summary>
    [JsonPropertyName("encryption")]
    public V20210401StorageAccountStatusEncryption? Encryption { get; set; }

    /// <summary>ExtendedLocation: The extendedLocation of the resource.</summary>
    [JsonPropertyName("extendedLocation")]
    public V20210401StorageAccountStatusExtendedLocation? ExtendedLocation { get; set; }
    ...
    public V20210401StorageAccountStatusGeoReplicationStats? GeoReplicationStats { get; set; }
    ...
    /// <summary>Identity: The identity of the resource.</summary>
    [JsonPropertyName("identity")]
    public V20210401StorageAccountStatusIdentity? Identity { get; set; }
    ...
    public V20210401StorageAccountStatusKeyCreationTime? KeyCreationTime { get; set; }

    /// <summary>KeyPolicy: KeyPolicy assigned to the storage account.</summary>
    [JsonPropertyName("keyPolicy")]
    public V20210401StorageAccountStatusKeyPolicy? KeyPolicy { get; set; }
    ...
    /// <summary>NetworkAcls: Network rule set</summary>
    [JsonPropertyName("networkAcls")]
    public V20210401StorageAccountStatusNetworkAcls? NetworkAcls { get; set; }
    ...
    public V20210401StorageAccountStatusPrimaryEndpoints? PrimaryEndpoints { get; set; }
    ...
    public IList<V20210401StorageAccountStatusPrivateEndpointConnections>? PrivateEndpointConnections { get; set; }
    ...
    /// <summary>RoutingPreference: Maintains information about the network routing choice opted by the user for data transfer</summary>
    [JsonPropertyName("routingPreference")]
    public V20210401StorageAccountStatusRoutingPreference? RoutingPreference { get; set; }

    /// <summary>SasPolicy: SasPolicy assigned to the storage account.</summary>
    [JsonPropertyName("sasPolicy")]
    public V20210401StorageAccountStatusSasPolicy? SasPolicy { get; set; }
    ...
    public V20210401StorageAccountStatusSecondaryEndpoints? SecondaryEndpoints { get; set; }
    ...
    /// <summary>Sku: Gets the SKU.</summary>
    [JsonPropertyName("sku")]
    public V20210401StorageAccountStatusSku? Sku { get; set; }
...
public partial class V20210401StorageAccount : IKubernetesObject<V1ObjectMeta>, ISpec<V20210401StorageAccountSpec?>, IStatus<V20210401StorageAccountStatus?>
{
    ...
    public V20210401StorageAccountSpec? Spec { get; set; }

    /// <summary>The storage account.</summary>
    [JsonPropertyName("status")]
    public V20210401StorageAccountStatus? Status { get; set; }
}