...
public partial class V1api20240801FlexibleServersVirtualEndpointList : IKubernetesObject<V1ListMeta>, IItems<V1api20240801FlexibleServersVirtualEndpoint>
{
    ...
    /// <summary>List of V1api20240801FlexibleServersVirtualEndpoint objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1api20240801FlexibleServersVirtualEndpoint> Items { get; set; }
}
...
public partial class V1api20240801FlexibleServersVirtualEndpointSpecOperatorSpec
{
    ...
    public IList<V1api20240801FlexibleServersVirtualEndpointSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary>SecretExpressions: configures where to place operator written dynamic secrets (created with CEL expressions).</summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20240801FlexibleServersVirtualEndpointSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V1api20240801FlexibleServersVirtualEndpointSpec
{
    ...
    public V1api20240801FlexibleServersVirtualEndpointSpecEndpointTypeEnum? EndpointType { get; set; }

    /// <summary>Members: List of flexible servers that one of the virtual endpoints can refer to.</summary>
    ...
    public V1api20240801FlexibleServersVirtualEndpointSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V1api20240801FlexibleServersVirtualEndpointSpecOwner Owner { get; set; }
}
...
public partial class V1api20240801FlexibleServersVirtualEndpointStatus
{
    ...
    public IList<V1api20240801FlexibleServersVirtualEndpointStatusConditions>? Conditions { get; set; }
    ...
    public V1api20240801FlexibleServersVirtualEndpointStatusSystemData? SystemData { get; set; }

    /// <summary>Type: The type of the resource. E.g. &quot;Microsoft.Compute/virtualMachines&quot; or &quot;Microsoft.Storage/storageAccounts&quot;</summary>
    [JsonPropertyName("type")]
    public string? Type { get; set; }

    /// <summary>VirtualEndpoints: List of virtual endpoints for a flexible server.</summary>
...
public partial class V1api20240801FlexibleServersVirtualEndpoint : IKubernetesObject<V1ObjectMeta>, ISpec<V1api20240801FlexibleServersVirtualEndpointSpec?>, IStatus<V1api20240801FlexibleServersVirtualEndpointStatus?>
{
    ...
    public V1api20240801FlexibleServersVirtualEndpointSpec? Spec { get; set; }

    [JsonPropertyName("status")]
    public V1api20240801FlexibleServersVirtualEndpointStatus? Status { get; set; }
}