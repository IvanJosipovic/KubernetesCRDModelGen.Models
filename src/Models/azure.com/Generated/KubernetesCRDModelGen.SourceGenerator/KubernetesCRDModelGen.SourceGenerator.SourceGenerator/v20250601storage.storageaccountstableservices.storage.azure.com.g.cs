...
public partial class V20250601storageStorageAccountsTableServiceList : IKubernetesObject<V1ListMeta>, IItems<V20250601storageStorageAccountsTableService>
{
    ...
    /// <summary>List of V20250601storageStorageAccountsTableService objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V20250601storageStorageAccountsTableService> Items { get; set; }
}
...
public partial class V20250601storageStorageAccountsTableServiceSpecCors
{
    ...
    public IList<V20250601storageStorageAccountsTableServiceSpecCorsCorsRules>? CorsRules { get; set; }
}
...
public partial class V20250601storageStorageAccountsTableServiceSpecOperatorSpec
{
    ...
    public IList<V20250601storageStorageAccountsTableServiceSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    [JsonPropertyName("secretExpressions")]
    public IList<V20250601storageStorageAccountsTableServiceSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V20250601storageStorageAccountsTableServiceSpec
{
    ...
    public V20250601storageStorageAccountsTableServiceSpecCors? Cors { get; set; }
    ...
    public V20250601storageStorageAccountsTableServiceSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V20250601storageStorageAccountsTableServiceSpecOwner Owner { get; set; }
}
...
public partial class V20250601storageStorageAccountsTableServiceStatusCors
{
    ...
    [JsonPropertyName("corsRules")]
    public IList<V20250601storageStorageAccountsTableServiceStatusCorsCorsRules>? CorsRules { get; set; }
}
...
public partial class V20250601storageStorageAccountsTableServiceStatus
{
    ...
    public IList<V20250601storageStorageAccountsTableServiceStatusConditions>? Conditions { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("cors")]
    public V20250601storageStorageAccountsTableServiceStatusCors? Cors { get; set; }
    ...
    public V20250601storageStorageAccountsTableServiceStatusSystemData? SystemData { get; set; }
...
public partial class V20250601storageStorageAccountsTableService : IKubernetesObject<V1ObjectMeta>, ISpec<V20250601storageStorageAccountsTableServiceSpec?>, IStatus<V20250601storageStorageAccountsTableServiceStatus?>
{
    ...
    public V20250601storageStorageAccountsTableServiceSpec? Spec { get; set; }

    /// <summary>Storage version of v20250601.StorageAccountsTableService_STATUS</summary>
    [JsonPropertyName("status")]
    public V20250601storageStorageAccountsTableServiceStatus? Status { get; set; }
}