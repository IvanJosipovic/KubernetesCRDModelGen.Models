...
public partial class V1api20221001previewNamespacesTopicsSubscriptionsRuleList : IKubernetesObject<V1ListMeta>, IItems<V1api20221001previewNamespacesTopicsSubscriptionsRule>
{
    ...
    /// <summary>List of V1api20221001previewNamespacesTopicsSubscriptionsRule objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1api20221001previewNamespacesTopicsSubscriptionsRule> Items { get; set; }
}
...
public partial class V1api20221001previewNamespacesTopicsSubscriptionsRuleSpecOperatorSpec
{
    ...
    public IList<V1api20221001previewNamespacesTopicsSubscriptionsRuleSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary>SecretExpressions: configures where to place operator written dynamic secrets (created with CEL expressions).</summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20221001previewNamespacesTopicsSubscriptionsRuleSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V1api20221001previewNamespacesTopicsSubscriptionsRuleSpec
{
    ...
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleSpecAction? Action { get; set; }
    ...
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleSpecCorrelationFilter? CorrelationFilter { get; set; }

    /// <summary>FilterType: Filter type that is evaluated against a BrokeredMessage.</summary>
    [JsonPropertyName("filterType")]
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleSpecFilterTypeEnum? FilterType { get; set; }
    ...
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V1api20221001previewNamespacesTopicsSubscriptionsRuleSpecOwner Owner { get; set; }

    /// <summary>SqlFilter: Properties of sqlFilter</summary>
    [JsonPropertyName("sqlFilter")]
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleSpecSqlFilter? SqlFilter { get; set; }
}
...
public partial class V1api20221001previewNamespacesTopicsSubscriptionsRuleStatus
{
    ...
    /// </summary>
    [JsonPropertyName("action")]
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleStatusAction? Action { get; set; }

    /// <summary>Conditions: The observed state of the resource</summary>
    [JsonPropertyName("conditions")]
    public IList<V1api20221001previewNamespacesTopicsSubscriptionsRuleStatusConditions>? Conditions { get; set; }

    /// <summary>CorrelationFilter: Properties of correlationFilter</summary>
    [JsonPropertyName("correlationFilter")]
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleStatusCorrelationFilter? CorrelationFilter { get; set; }
    ...
    /// <summary>SqlFilter: Properties of sqlFilter</summary>
    [JsonPropertyName("sqlFilter")]
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleStatusSqlFilter? SqlFilter { get; set; }

    /// <summary>SystemData: The system meta data relating to this resource.</summary>
    [JsonPropertyName("systemData")]
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleStatusSystemData? SystemData { get; set; }
...
public partial class V1api20221001previewNamespacesTopicsSubscriptionsRule : IKubernetesObject<V1ObjectMeta>, ISpec<V1api20221001previewNamespacesTopicsSubscriptionsRuleSpec?>, IStatus<V1api20221001previewNamespacesTopicsSubscriptionsRuleStatus?>
{
    ...
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleSpec? Spec { get; set; }

    [JsonPropertyName("status")]
    public V1api20221001previewNamespacesTopicsSubscriptionsRuleStatus? Status { get; set; }
}