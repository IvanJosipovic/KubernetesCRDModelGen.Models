...
public partial class V1api20230101StorageAccountsFileServicesShareList : IKubernetesObject<V1ListMeta>, IItems<V1api20230101StorageAccountsFileServicesShare>
{
    ...
    /// <summary>List of V1api20230101StorageAccountsFileServicesShare objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1api20230101StorageAccountsFileServicesShare> Items { get; set; }
}
...
public partial class V1api20230101StorageAccountsFileServicesShareSpecOperatorSpec
{
    ...
    public IList<V1api20230101StorageAccountsFileServicesShareSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary>SecretExpressions: configures where to place operator written dynamic secrets (created with CEL expressions).</summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20230101StorageAccountsFileServicesShareSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V1api20230101StorageAccountsFileServicesShareSpecSignedIdentifiers
{
    ...
    public V1api20230101StorageAccountsFileServicesShareSpecSignedIdentifiersAccessPolicy? AccessPolicy { get; set; }
...
public partial class V1api20230101StorageAccountsFileServicesShareSpec
{
    ...
    public V1api20230101StorageAccountsFileServicesShareSpecAccessTierEnum? AccessTier { get; set; }
    ...
    public V1api20230101StorageAccountsFileServicesShareSpecEnabledProtocolsEnum? EnabledProtocols { get; set; }
    ...
    public V1api20230101StorageAccountsFileServicesShareSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V1api20230101StorageAccountsFileServicesShareSpecOwner Owner { get; set; }

    /// <summary>RootSquash: The property is for NFS share only. The default is NoRootSquash.</summary>
    [JsonPropertyName("rootSquash")]
    public V1api20230101StorageAccountsFileServicesShareSpecRootSquashEnum? RootSquash { get; set; }
    ...
    public IList<V1api20230101StorageAccountsFileServicesShareSpecSignedIdentifiers>? SignedIdentifiers { get; set; }
}
...
public partial class V1api20230101StorageAccountsFileServicesShareStatusSignedIdentifiers
{
    /// <summary>AccessPolicy: Access policy</summary>
    [JsonPropertyName("accessPolicy")]
    public V1api20230101StorageAccountsFileServicesShareStatusSignedIdentifiersAccessPolicy? AccessPolicy { get; set; }
...
public partial class V1api20230101StorageAccountsFileServicesShareStatus
{
    ...
    public IList<V1api20230101StorageAccountsFileServicesShareStatusConditions>? Conditions { get; set; }
    ...
    /// <summary>SignedIdentifiers: List of stored access policies specified on the share.</summary>
    [JsonPropertyName("signedIdentifiers")]
    public IList<V1api20230101StorageAccountsFileServicesShareStatusSignedIdentifiers>? SignedIdentifiers { get; set; }
...
public partial class V1api20230101StorageAccountsFileServicesShare : IKubernetesObject<V1ObjectMeta>, ISpec<V1api20230101StorageAccountsFileServicesShareSpec?>, IStatus<V1api20230101StorageAccountsFileServicesShareStatus?>
{
    ...
    public V1api20230101StorageAccountsFileServicesShareSpec? Spec { get; set; }

    [JsonPropertyName("status")]
    public V1api20230101StorageAccountsFileServicesShareStatus? Status { get; set; }
}