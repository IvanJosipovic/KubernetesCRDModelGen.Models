...
public partial class V1api20210601WorkspacesBigDataPoolList : IKubernetesObject<V1ListMeta>, IItems<V1api20210601WorkspacesBigDataPool>
{
    ...
    /// <summary>List of V1api20210601WorkspacesBigDataPool objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1api20210601WorkspacesBigDataPool> Items { get; set; }
}
...
public partial class V1api20210601WorkspacesBigDataPoolSpecOperatorSpec
{
    ...
    public IList<V1api20210601WorkspacesBigDataPoolSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary>SecretExpressions: configures where to place operator written dynamic secrets (created with CEL expressions).</summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20210601WorkspacesBigDataPoolSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V1api20210601WorkspacesBigDataPoolSpecSparkConfigProperties
{
    ...
    public V1api20210601WorkspacesBigDataPoolSpecSparkConfigPropertiesConfigurationTypeEnum? ConfigurationType { get; set; }
...
public partial class V1api20210601WorkspacesBigDataPoolSpec
{
    ...
    public V1api20210601WorkspacesBigDataPoolSpecAutoPause? AutoPause { get; set; }

    /// <summary>AutoScale: Auto-scaling properties</summary>
    [JsonPropertyName("autoScale")]
    public V1api20210601WorkspacesBigDataPoolSpecAutoScale? AutoScale { get; set; }
    ...
    public IList<V1api20210601WorkspacesBigDataPoolSpecCustomLibraries>? CustomLibraries { get; set; }
    ...
    public V1api20210601WorkspacesBigDataPoolSpecDynamicExecutorAllocation? DynamicExecutorAllocation { get; set; }
    ...
    public V1api20210601WorkspacesBigDataPoolSpecLibraryRequirements? LibraryRequirements { get; set; }
    ...
    public V1api20210601WorkspacesBigDataPoolSpecNodeSizeEnum? NodeSize { get; set; }

    /// <summary>NodeSizeFamily: The kind of nodes that the Big Data pool provides.</summary>
    [JsonPropertyName("nodeSizeFamily")]
    public V1api20210601WorkspacesBigDataPoolSpecNodeSizeFamilyEnum? NodeSizeFamily { get; set; }
    ...
    public V1api20210601WorkspacesBigDataPoolSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V1api20210601WorkspacesBigDataPoolSpecOwner Owner { get; set; }
    ...
    public V1api20210601WorkspacesBigDataPoolSpecSparkConfigProperties? SparkConfigProperties { get; set; }
...
public partial class V1api20210601WorkspacesBigDataPoolStatus
{
    /// <summary>AutoPause: Auto-pausing properties</summary>
    [JsonPropertyName("autoPause")]
    public V1api20210601WorkspacesBigDataPoolStatusAutoPause? AutoPause { get; set; }

    /// <summary>AutoScale: Auto-scaling properties</summary>
    [JsonPropertyName("autoScale")]
    public V1api20210601WorkspacesBigDataPoolStatusAutoScale? AutoScale { get; set; }
    ...
    public IList<V1api20210601WorkspacesBigDataPoolStatusConditions>? Conditions { get; set; }
    ...
    /// <summary>CustomLibraries: List of custom libraries/packages associated with the spark pool.</summary>
    [JsonPropertyName("customLibraries")]
    public IList<V1api20210601WorkspacesBigDataPoolStatusCustomLibraries>? CustomLibraries { get; set; }
    ...
    /// <summary>DynamicExecutorAllocation: Dynamic Executor Allocation</summary>
    [JsonPropertyName("dynamicExecutorAllocation")]
    public V1api20210601WorkspacesBigDataPoolStatusDynamicExecutorAllocation? DynamicExecutorAllocation { get; set; }
    ...
    /// <summary>LibraryRequirements: Library version requirements</summary>
    [JsonPropertyName("libraryRequirements")]
    public V1api20210601WorkspacesBigDataPoolStatusLibraryRequirements? LibraryRequirements { get; set; }
    ...
    /// <summary>SparkConfigProperties: Spark configuration file to specify additional properties</summary>
    [JsonPropertyName("sparkConfigProperties")]
    public V1api20210601WorkspacesBigDataPoolStatusSparkConfigProperties? SparkConfigProperties { get; set; }
...
public partial class V1api20210601WorkspacesBigDataPool : IKubernetesObject<V1ObjectMeta>, ISpec<V1api20210601WorkspacesBigDataPoolSpec?>, IStatus<V1api20210601WorkspacesBigDataPoolStatus?>
{
    ...
    public V1api20210601WorkspacesBigDataPoolSpec? Spec { get; set; }

    [JsonPropertyName("status")]
    public V1api20210601WorkspacesBigDataPoolStatus? Status { get; set; }
}