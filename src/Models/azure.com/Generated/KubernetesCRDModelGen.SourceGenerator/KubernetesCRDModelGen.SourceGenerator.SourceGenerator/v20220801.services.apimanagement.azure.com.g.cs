...
public partial class V20220801ServiceSpecAdditionalLocationsSku
{
    ...
    /// <summary>Name: Name of the Sku.</summary>
    [JsonPropertyName("name")]
    public required V20220801ServiceSpecAdditionalLocationsSkuNameEnum Name { get; set; }
}
...
public partial class V20220801ServiceSpecAdditionalLocationsVirtualNetworkConfiguration
{
    ...
    public V20220801ServiceSpecAdditionalLocationsVirtualNetworkConfigurationSubnetResourceReference? SubnetResourceReference { get; set; }
}
...
public partial class V20220801ServiceSpecAdditionalLocations
{
    ...
    public V20220801ServiceSpecAdditionalLocationsNatGatewayStateEnum? NatGatewayState { get; set; }
    ...
    public V20220801ServiceSpecAdditionalLocationsPublicIpAddressReference? PublicIpAddressReference { get; set; }

    /// <summary>Sku: SKU properties of the API Management service.</summary>
    [JsonPropertyName("sku")]
    public required V20220801ServiceSpecAdditionalLocationsSku Sku { get; set; }

    /// <summary>VirtualNetworkConfiguration: Virtual network configuration for the location.</summary>
    [JsonPropertyName("virtualNetworkConfiguration")]
    public V20220801ServiceSpecAdditionalLocationsVirtualNetworkConfiguration? VirtualNetworkConfiguration { get; set; }
...
public partial class V20220801ServiceSpecCertificatesCertificate
{
    ...
    public V20220801ServiceSpecCertificatesCertificateExpiryFromConfig? ExpiryFromConfig { get; set; }
    ...
    public V20220801ServiceSpecCertificatesCertificateSubjectFromConfig? SubjectFromConfig { get; set; }
    ...
    public V20220801ServiceSpecCertificatesCertificateThumbprintFromConfig? ThumbprintFromConfig { get; set; }
}
...
public partial class V20220801ServiceSpecCertificates
{
    ...
    public V20220801ServiceSpecCertificatesCertificate? Certificate { get; set; }

    /// <summary>CertificatePassword: Certificate Password.</summary>
    [JsonPropertyName("certificatePassword")]
    public V20220801ServiceSpecCertificatesCertificatePassword? CertificatePassword { get; set; }
    ...
    public required V20220801ServiceSpecCertificatesStoreNameEnum StoreName { get; set; }
}
...
public partial class V20220801ServiceSpecHostnameConfigurationsCertificate
{
    ...
    /// </summary>
    [JsonPropertyName("expiryFromConfig")]
    public V20220801ServiceSpecHostnameConfigurationsCertificateExpiryFromConfig? ExpiryFromConfig { get; set; }
    ...
    /// <summary>SubjectFromConfig: Subject of the certificate.</summary>
    [JsonPropertyName("subjectFromConfig")]
    public V20220801ServiceSpecHostnameConfigurationsCertificateSubjectFromConfig? SubjectFromConfig { get; set; }
    ...
    /// <summary>ThumbprintFromConfig: Thumbprint of the certificate.</summary>
    [JsonPropertyName("thumbprintFromConfig")]
    public V20220801ServiceSpecHostnameConfigurationsCertificateThumbprintFromConfig? ThumbprintFromConfig { get; set; }
}
...
public partial class V20220801ServiceSpecHostnameConfigurations
{
    /// <summary>Certificate: Certificate information.</summary>
    [JsonPropertyName("certificate")]
    public V20220801ServiceSpecHostnameConfigurationsCertificate? Certificate { get; set; }

    /// <summary>CertificatePassword: Certificate Password.</summary>
    [JsonPropertyName("certificatePassword")]
    public V20220801ServiceSpecHostnameConfigurationsCertificatePassword? CertificatePassword { get; set; }

    /// <summary>CertificateSource: Certificate Source.</summary>
    [JsonPropertyName("certificateSource")]
    public V20220801ServiceSpecHostnameConfigurationsCertificateSourceEnum? CertificateSource { get; set; }

    /// <summary>CertificateStatus: Certificate Status.</summary>
    [JsonPropertyName("certificateStatus")]
    public V20220801ServiceSpecHostnameConfigurationsCertificateStatusEnum? CertificateStatus { get; set; }
    ...
    public V20220801ServiceSpecHostnameConfigurationsIdentityClientIdFromConfig? IdentityClientIdFromConfig { get; set; }
    ...
    public required V20220801ServiceSpecHostnameConfigurationsTypeEnum Type { get; set; }
}
...
public partial class V20220801ServiceSpecIdentityUserAssignedIdentities
{
    ...
    public V20220801ServiceSpecIdentityUserAssignedIdentitiesReference? Reference { get; set; }
}
...
public partial class V20220801ServiceSpecIdentity
{
    ...
    /// </summary>
    [JsonPropertyName("type")]
    public required V20220801ServiceSpecIdentityTypeEnum Type { get; set; }
    ...
    public IList<V20220801ServiceSpecIdentityUserAssignedIdentities>? UserAssignedIdentities { get; set; }
}
...
public partial class V20220801ServiceSpecOperatorSpec
{
    ...
    public IList<V20220801ServiceSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary>SecretExpressions: configures where to place operator written dynamic secrets (created with CEL expressions).</summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V20220801ServiceSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V20220801ServiceSpecSku
{
    ...
    /// <summary>Name: Name of the Sku.</summary>
    [JsonPropertyName("name")]
    public required V20220801ServiceSpecSkuNameEnum Name { get; set; }
}
...
public partial class V20220801ServiceSpecVirtualNetworkConfiguration
{
    /// <summary>SubnetResourceReference: The full resource ID of a subnet in a virtual network to deploy the API Management service in.</summary>
    [JsonPropertyName("subnetResourceReference")]
    public V20220801ServiceSpecVirtualNetworkConfigurationSubnetResourceReference? SubnetResourceReference { get; set; }
}
...
public partial class V20220801ServiceSpec
{
    ...
    public IList<V20220801ServiceSpecAdditionalLocations>? AdditionalLocations { get; set; }

    /// <summary>ApiVersionConstraint: Control Plane Apis version constraint for the API Management service.</summary>
    [JsonPropertyName("apiVersionConstraint")]
    public V20220801ServiceSpecApiVersionConstraint? ApiVersionConstraint { get; set; }
    ...
    public IList<V20220801ServiceSpecCertificates>? Certificates { get; set; }
    ...
    public IList<V20220801ServiceSpecHostnameConfigurations>? HostnameConfigurations { get; set; }

    /// <summary>Identity: Managed service identity of the Api Management service.</summary>
    [JsonPropertyName("identity")]
    public V20220801ServiceSpecIdentity? Identity { get; set; }
    ...
    /// <summary>NatGatewayState: Property can be used to enable NAT Gateway for this API Management service.</summary>
    [JsonPropertyName("natGatewayState")]
    public V20220801ServiceSpecNatGatewayStateEnum? NatGatewayState { get; set; }
    ...
    public V20220801ServiceSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V20220801ServiceSpecOwner Owner { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("publicIpAddressReference")]
    public V20220801ServiceSpecPublicIpAddressReference? PublicIpAddressReference { get; set; }
    ...
    public V20220801ServiceSpecPublicNetworkAccessEnum? PublicNetworkAccess { get; set; }
    ...
    /// <summary>Sku: SKU properties of the API Management service.</summary>
    [JsonPropertyName("sku")]
    public required V20220801ServiceSpecSku Sku { get; set; }
    ...
    /// <summary>VirtualNetworkConfiguration: Virtual network configuration of the API Management service.</summary>
    [JsonPropertyName("virtualNetworkConfiguration")]
    public V20220801ServiceSpecVirtualNetworkConfiguration? VirtualNetworkConfiguration { get; set; }
    ...
    public V20220801ServiceSpecVirtualNetworkTypeEnum? VirtualNetworkType { get; set; }
...
public partial class V20220801ServiceStatusAdditionalLocations
{
    ...
    /// <summary>Sku: SKU properties of the API Management service.</summary>
    [JsonPropertyName("sku")]
    public V20220801ServiceStatusAdditionalLocationsSku? Sku { get; set; }

    /// <summary>VirtualNetworkConfiguration: Virtual network configuration for the location.</summary>
    [JsonPropertyName("virtualNetworkConfiguration")]
    public V20220801ServiceStatusAdditionalLocationsVirtualNetworkConfiguration? VirtualNetworkConfiguration { get; set; }
...
public partial class V20220801ServiceStatusCertificates
{
    /// <summary>Certificate: Certificate information.</summary>
    [JsonPropertyName("certificate")]
    public V20220801ServiceStatusCertificatesCertificate? Certificate { get; set; }
...
public partial class V20220801ServiceStatusHostnameConfigurations
{
    /// <summary>Certificate: Certificate information.</summary>
    [JsonPropertyName("certificate")]
    public V20220801ServiceStatusHostnameConfigurationsCertificate? Certificate { get; set; }
...
public partial class V20220801ServiceStatusIdentity
{
    ...
    /// </summary>
    [JsonPropertyName("userAssignedIdentities")]
    public IDictionary<string, V20220801ServiceStatusIdentityUserAssignedIdentities>? UserAssignedIdentities { get; set; }
}
...
public partial class V20220801ServiceStatusPrivateEndpointConnections
{
    ...
    public V20220801ServiceStatusPrivateEndpointConnectionsPrivateEndpoint? PrivateEndpoint { get; set; }
    ...
    public V20220801ServiceStatusPrivateEndpointConnectionsPrivateLinkServiceConnectionState? PrivateLinkServiceConnectionState { get; set; }
...
public partial class V20220801ServiceStatus
{
    /// <summary>AdditionalLocations: Additional datacenter locations of the API Management service.</summary>
    [JsonPropertyName("additionalLocations")]
    public IList<V20220801ServiceStatusAdditionalLocations>? AdditionalLocations { get; set; }

    /// <summary>ApiVersionConstraint: Control Plane Apis version constraint for the API Management service.</summary>
    [JsonPropertyName("apiVersionConstraint")]
    public V20220801ServiceStatusApiVersionConstraint? ApiVersionConstraint { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("certificates")]
    public IList<V20220801ServiceStatusCertificates>? Certificates { get; set; }

    /// <summary>Conditions: The observed state of the resource</summary>
    [JsonPropertyName("conditions")]
    public IList<V20220801ServiceStatusConditions>? Conditions { get; set; }
    ...
    /// <summary>HostnameConfigurations: Custom hostname configuration of the API Management service.</summary>
    [JsonPropertyName("hostnameConfigurations")]
    public IList<V20220801ServiceStatusHostnameConfigurations>? HostnameConfigurations { get; set; }
    ...
    /// <summary>Identity: Managed service identity of the Api Management service.</summary>
    [JsonPropertyName("identity")]
    public V20220801ServiceStatusIdentity? Identity { get; set; }
    ...
    public IList<V20220801ServiceStatusPrivateEndpointConnections>? PrivateEndpointConnections { get; set; }
    ...
    /// <summary>Sku: SKU properties of the API Management service.</summary>
    [JsonPropertyName("sku")]
    public V20220801ServiceStatusSku? Sku { get; set; }

    /// <summary>SystemData: Metadata pertaining to creation and last modification of the resource.</summary>
    [JsonPropertyName("systemData")]
    public V20220801ServiceStatusSystemData? SystemData { get; set; }
    ...
    /// <summary>VirtualNetworkConfiguration: Virtual network configuration of the API Management service.</summary>
    [JsonPropertyName("virtualNetworkConfiguration")]
    public V20220801ServiceStatusVirtualNetworkConfiguration? VirtualNetworkConfiguration { get; set; }
...
public partial class V20220801Service : IKubernetesObject<V1ObjectMeta>, ISpec<V20220801ServiceSpec?>, IStatus<V20220801ServiceStatus?>
{
    ...
    public V20220801ServiceSpec? Spec { get; set; }

    [JsonPropertyName("status")]
    public V20220801ServiceStatus? Status { get; set; }
}