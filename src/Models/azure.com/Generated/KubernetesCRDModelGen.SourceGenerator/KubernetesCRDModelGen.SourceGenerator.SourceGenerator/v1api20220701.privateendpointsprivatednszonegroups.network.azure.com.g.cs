...
public partial class V1api20220701PrivateEndpointsPrivateDnsZoneGroupList : IKubernetesObject<V1ListMeta>, IItems<V1api20220701PrivateEndpointsPrivateDnsZoneGroup>
{
    ...
    /// <summary>List of V1api20220701PrivateEndpointsPrivateDnsZoneGroup objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1api20220701PrivateEndpointsPrivateDnsZoneGroup> Items { get; set; }
}
...
public partial class V1api20220701PrivateEndpointsPrivateDnsZoneGroupSpecOperatorSpec
{
    ...
    public IList<V1api20220701PrivateEndpointsPrivateDnsZoneGroupSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary>SecretExpressions: configures where to place operator written dynamic secrets (created with CEL expressions).</summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20220701PrivateEndpointsPrivateDnsZoneGroupSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V1api20220701PrivateEndpointsPrivateDnsZoneGroupSpec
{
    ...
    public V1api20220701PrivateEndpointsPrivateDnsZoneGroupSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public required V1api20220701PrivateEndpointsPrivateDnsZoneGroupSpecOwner Owner { get; set; }
    ...
    public IList<V1api20220701PrivateEndpointsPrivateDnsZoneGroupSpecPrivateDnsZoneConfigs>? PrivateDnsZoneConfigs { get; set; }
}
...
public partial class V1api20220701PrivateEndpointsPrivateDnsZoneGroupStatus
{
    ...
    public IList<V1api20220701PrivateEndpointsPrivateDnsZoneGroupStatusConditions>? Conditions { get; set; }
    ...
    /// <summary>PrivateDnsZoneConfigs: A collection of private dns zone configurations of the private dns zone group.</summary>
    [JsonPropertyName("privateDnsZoneConfigs")]
    public IList<V1api20220701PrivateEndpointsPrivateDnsZoneGroupStatusPrivateDnsZoneConfigs>? PrivateDnsZoneConfigs { get; set; }
...
public partial class V1api20220701PrivateEndpointsPrivateDnsZoneGroup : IKubernetesObject<V1ObjectMeta>, ISpec<V1api20220701PrivateEndpointsPrivateDnsZoneGroupSpec?>, IStatus<V1api20220701PrivateEndpointsPrivateDnsZoneGroupStatus?>
{
    ...
    public V1api20220701PrivateEndpointsPrivateDnsZoneGroupSpec? Spec { get; set; }

    [JsonPropertyName("status")]
    public V1api20220701PrivateEndpointsPrivateDnsZoneGroupStatus? Status { get; set; }
}