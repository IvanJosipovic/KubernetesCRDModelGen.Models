...
namespace KubernetesCRDModelGen.Models.iam.upbound.io;
...
public partial class V1alpha1RobotTeamMembershipList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1RobotTeamMembership>
{
    ...
    public const string KubeKind = "RobotTeamMembershipList";
    public const string KubeGroup = "iam.upbound.io";
    public const string KubePluralName = "robotteammemberships";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    public string ApiVersion { get; set; } = "iam.upbound.io/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "RobotTeamMembershipList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1RobotTeamMembership objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1RobotTeamMembership> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1RobotTeamMembershipSpecDeletionPolicyEnum>))]
public enum V1alpha1RobotTeamMembershipSpecDeletionPolicyEnum
{
...
public partial class V1alpha1RobotTeamMembershipSpecForProviderRobotIdRefPolicy
{
    ...
    public V1alpha1RobotTeamMembershipSpecForProviderRobotIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1RobotTeamMembershipSpecForProviderRobotIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipSpecForProviderRobotIdRef
{
    ...
    public V1alpha1RobotTeamMembershipSpecForProviderRobotIdRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipSpecForProviderRobotIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RobotTeamMembershipSpecForProviderRobotIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RobotTeamMembershipSpecForProviderRobotIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipSpecForProviderRobotIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1RobotTeamMembershipSpecForProviderRobotIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipSpecForProviderTeamIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RobotTeamMembershipSpecForProviderTeamIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RobotTeamMembershipSpecForProviderTeamIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipSpecForProviderTeamIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1RobotTeamMembershipSpecForProviderTeamIdRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipSpecForProviderTeamIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RobotTeamMembershipSpecForProviderTeamIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RobotTeamMembershipSpecForProviderTeamIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipSpecForProviderTeamIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1RobotTeamMembershipSpecForProviderTeamIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipSpecForProvider
{
    ...
    /// <summary>RobotIDRef references a Robot to and retrieves its robotId.</summary>
    [JsonPropertyName("robotIdRef")]
    public V1alpha1RobotTeamMembershipSpecForProviderRobotIdRef? RobotIdRef { get; set; }

    /// <summary>
    /// RobotIDSelector selects a reference to a Robot in order to retrieve its
    /// robotId.
    /// </summary>
    [JsonPropertyName("robotIdSelector")]
    public V1alpha1RobotTeamMembershipSpecForProviderRobotIdSelector? RobotIdSelector { get; set; }
    ...
    public V1alpha1RobotTeamMembershipSpecForProviderTeamIdRef? TeamIdRef { get; set; }
    ...
    public V1alpha1RobotTeamMembershipSpecForProviderTeamIdSelector? TeamIdSelector { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1RobotTeamMembershipSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1alpha1RobotTeamMembershipSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1RobotTeamMembershipSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1alpha1RobotTeamMembershipSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1alpha1RobotTeamMembershipSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RobotTeamMembershipSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RobotTeamMembershipSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1RobotTeamMembershipSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipSpec
{
    ...
    public V1alpha1RobotTeamMembershipSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary>RobotTeamMembershipParameters are the configurable fields of a RobotTeamMembership.</summary>
    [JsonPropertyName("forProvider")]
    public required V1alpha1RobotTeamMembershipSpecForProvider ForProvider { get; set; }
    ...
    public IList<V1alpha1RobotTeamMembershipSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1RobotTeamMembershipSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1alpha1RobotTeamMembershipSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1alpha1RobotTeamMembershipStatus
{
    ...
    public V1alpha1RobotTeamMembershipStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1RobotTeamMembershipStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "RobotTeamMembership";
    public const string KubeGroup = "iam.upbound.io";
    public const string KubePluralName = "robotteammemberships";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "RobotTeamMembership";
    ...
    public required V1alpha1RobotTeamMembershipSpec Spec { get; set; }

    /// <summary>A RobotTeamMembershipStatus represents the observed state of a RobotTeamMembership.</summary>
    [JsonPropertyName("status")]
    public V1alpha1RobotTeamMembershipStatus? Status { get; set; }
}