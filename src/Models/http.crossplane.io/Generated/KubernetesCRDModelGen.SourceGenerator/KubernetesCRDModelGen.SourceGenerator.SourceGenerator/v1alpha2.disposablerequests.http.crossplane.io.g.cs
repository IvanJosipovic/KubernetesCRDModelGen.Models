...
public partial class V1alpha2DisposableRequestSpecProviderConfigRefPolicy
{
    ...
    public V1alpha2DisposableRequestSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha2DisposableRequestSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha2DisposableRequestSpecProviderConfigRef
{
    ...
    public V1alpha2DisposableRequestSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha2DisposableRequestSpec
{
    ...
    public V1alpha2DisposableRequestSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
