...
public partial class V1alpha1GroupMemberGroupIdsList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1GroupMemberGroupIds>
{
    ...
    public const string KubeKind = "GroupMemberGroupIdsList";
    public const string KubeGroup = "identity.vault.upbound.io";
    public const string KubePluralName = "groupmembergroupidsidses";
    ...
    public string Kind { get; set; } = "GroupMemberGroupIdsList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1GroupMemberGroupIds objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1GroupMemberGroupIds> Items { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdRefPolicy
{
    ...
    public V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdRef
{
    ...
    public V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecForProviderMemberGroupIdsRefsPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1GroupMemberGroupIdsSpecForProviderMemberGroupIdsRefsPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1GroupMemberGroupIdsSpecForProviderMemberGroupIdsRefsPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecForProviderMemberGroupIdsRefs
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1GroupMemberGroupIdsSpecForProviderMemberGroupIdsRefsPolicy? Policy { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecForProviderMemberGroupIdsSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1GroupMemberGroupIdsSpecForProviderMemberGroupIdsSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1GroupMemberGroupIdsSpecForProviderMemberGroupIdsSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecForProvider
{
    ...
    public V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdRef? GroupIdRef { get; set; }

    /// <summary>Selector for a Group in identity to populate groupId.</summary>
    [JsonPropertyName("groupIdSelector")]
    public V1alpha1GroupMemberGroupIdsSpecForProviderGroupIdSelector? GroupIdSelector { get; set; }
    ...
    /// <summary>References to Group in identity to populate memberGroupIds.</summary>
    [JsonPropertyName("memberGroupIdsRefs")]
    public IList<V1alpha1GroupMemberGroupIdsSpecForProviderMemberGroupIdsRefs>? MemberGroupIdsRefs { get; set; }

    /// <summary>Selector for a list of Group in identity to populate memberGroupIds.</summary>
    [JsonPropertyName("memberGroupIdsSelector")]
    public V1alpha1GroupMemberGroupIdsSpecForProviderMemberGroupIdsSelector? MemberGroupIdsSelector { get; set; }
...
public partial class V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsRefsPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsRefsPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsRefsPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsRefs
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsRefsPolicy? Policy { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecInitProvider
{
    ...
    /// <summary>Reference to a Group in identity to populate groupId.</summary>
    [JsonPropertyName("groupIdRef")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdRef? GroupIdRef { get; set; }

    /// <summary>Selector for a Group in identity to populate groupId.</summary>
    [JsonPropertyName("groupIdSelector")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderGroupIdSelector? GroupIdSelector { get; set; }
    ...
    /// <summary>References to Group in identity to populate memberGroupIds.</summary>
    [JsonPropertyName("memberGroupIdsRefs")]
    public IList<V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsRefs>? MemberGroupIdsRefs { get; set; }

    /// <summary>Selector for a list of Group in identity to populate memberGroupIds.</summary>
    [JsonPropertyName("memberGroupIdsSelector")]
    public V1alpha1GroupMemberGroupIdsSpecInitProviderMemberGroupIdsSelector? MemberGroupIdsSelector { get; set; }
...
public partial class V1alpha1GroupMemberGroupIdsSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1GroupMemberGroupIdsSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1GroupMemberGroupIdsSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1GroupMemberGroupIdsSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1GroupMemberGroupIdsSpec
{
    ...
    public V1alpha1GroupMemberGroupIdsSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1GroupMemberGroupIdsSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1GroupMemberGroupIdsSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1GroupMemberGroupIdsSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1GroupMemberGroupIdsSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1GroupMemberGroupIdsStatus
{
    ...
    public V1alpha1GroupMemberGroupIdsStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1GroupMemberGroupIdsStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "GroupMemberGroupIds";
    public const string KubeGroup = "identity.vault.upbound.io";
    public const string KubePluralName = "groupmembergroupidsidses";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "GroupMemberGroupIds";
    ...
    public required V1alpha1GroupMemberGroupIdsSpec Spec { get; set; }

    /// <summary>GroupMemberGroupIdsStatus defines the observed state of GroupMemberGroupIds.</summary>
    [JsonPropertyName("status")]
    public V1alpha1GroupMemberGroupIdsStatus? Status { get; set; }
}