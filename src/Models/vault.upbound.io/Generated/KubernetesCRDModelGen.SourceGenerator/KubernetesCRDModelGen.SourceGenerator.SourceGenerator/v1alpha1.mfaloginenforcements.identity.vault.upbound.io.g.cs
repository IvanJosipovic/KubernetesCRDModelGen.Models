...
public partial class V1alpha1MfaLoginEnforcementList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1MfaLoginEnforcement>
{
    ...
    public const string KubeKind = "MfaLoginEnforcementList";
    public const string KubeGroup = "identity.vault.upbound.io";
    public const string KubePluralName = "mfaloginenforcements";
    ...
    public string Kind { get; set; } = "MfaLoginEnforcementList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1MfaLoginEnforcement objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1MfaLoginEnforcement> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1MfaLoginEnforcementSpecDeletionPolicyEnum>))]
public enum V1alpha1MfaLoginEnforcementSpecDeletionPolicyEnum
{
...
public partial class V1alpha1MfaLoginEnforcementSpecForProviderMfaMethodIdsRefsPolicy
{
    ...
    public V1alpha1MfaLoginEnforcementSpecForProviderMfaMethodIdsRefsPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1MfaLoginEnforcementSpecForProviderMfaMethodIdsRefsPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1MfaLoginEnforcementSpecForProviderMfaMethodIdsRefs
{
    ...
    public V1alpha1MfaLoginEnforcementSpecForProviderMfaMethodIdsRefsPolicy? Policy { get; set; }
}
...
public partial class V1alpha1MfaLoginEnforcementSpecForProviderMfaMethodIdsSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1MfaLoginEnforcementSpecForProviderMfaMethodIdsSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1MfaLoginEnforcementSpecForProviderMfaMethodIdsSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1MfaLoginEnforcementSpecForProvider
{
    ...
    /// Set of auth method accessor IDs.
    /// </summary>
    [JsonPropertyName("authMethodAccessors")]
    public IList<string>? AuthMethodAccessors { get; set; }
    ...
    public IList<string>? AuthMethodTypes { get; set; }

    /// <summary>
    /// Set of identity entity IDs.
    /// Set of identity entity IDs.
    /// </summary>
    [JsonPropertyName("identityEntityIds")]
    public IList<string>? IdentityEntityIds { get; set; }

    /// <summary>
    /// Set of identity group IDs.
    /// Set of identity group IDs.
    /// </summary>
    [JsonPropertyName("identityGroupIds")]
    public IList<string>? IdentityGroupIds { get; set; }

    /// <summary>
    /// Set of MFA method UUIDs.
    /// Set of MFA method UUIDs.
    /// </summary>
    [JsonPropertyName("mfaMethodIds")]
    public IList<string>? MfaMethodIds { get; set; }

    /// <summary>References to MfaDuo in identity to populate mfaMethodIds.</summary>
    [JsonPropertyName("mfaMethodIdsRefs")]
    public IList<V1alpha1MfaLoginEnforcementSpecForProviderMfaMethodIdsRefs>? MfaMethodIdsRefs { get; set; }

    /// <summary>Selector for a list of MfaDuo in identity to populate mfaMethodIds.</summary>
    [JsonPropertyName("mfaMethodIdsSelector")]
    public V1alpha1MfaLoginEnforcementSpecForProviderMfaMethodIdsSelector? MfaMethodIdsSelector { get; set; }
...
public partial class V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsRefsPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsRefsPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsRefsPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsRefs
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsRefsPolicy? Policy { get; set; }
}
...
public partial class V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1MfaLoginEnforcementSpecInitProvider
{
    ...
    /// <summary>References to MfaDuo in identity to populate mfaMethodIds.</summary>
    [JsonPropertyName("mfaMethodIdsRefs")]
    public IList<V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsRefs>? MfaMethodIdsRefs { get; set; }

    /// <summary>Selector for a list of MfaDuo in identity to populate mfaMethodIds.</summary>
    [JsonPropertyName("mfaMethodIdsSelector")]
    public V1alpha1MfaLoginEnforcementSpecInitProviderMfaMethodIdsSelector? MfaMethodIdsSelector { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1MfaLoginEnforcementSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1alpha1MfaLoginEnforcementSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1MfaLoginEnforcementSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1alpha1MfaLoginEnforcementSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1alpha1MfaLoginEnforcementSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1MfaLoginEnforcementSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1MfaLoginEnforcementSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1MfaLoginEnforcementSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1MfaLoginEnforcementSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1MfaLoginEnforcementSpec
{
    ...
    public V1alpha1MfaLoginEnforcementSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1MfaLoginEnforcementSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1MfaLoginEnforcementSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1MfaLoginEnforcementSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1MfaLoginEnforcementSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1MfaLoginEnforcementStatus
{
    ...
    public V1alpha1MfaLoginEnforcementStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1MfaLoginEnforcementStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "MfaLoginEnforcement";
    public const string KubeGroup = "identity.vault.upbound.io";
    public const string KubePluralName = "mfaloginenforcements";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "MfaLoginEnforcement";
    ...
    public required V1alpha1MfaLoginEnforcementSpec Spec { get; set; }

    /// <summary>MfaLoginEnforcementStatus defines the observed state of MfaLoginEnforcement.</summary>
    [JsonPropertyName("status")]
    public V1alpha1MfaLoginEnforcementStatus? Status { get; set; }
}