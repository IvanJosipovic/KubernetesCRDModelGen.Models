...
public partial class V1alpha1OidcKeyAllowedClientIDList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1OidcKeyAllowedClientID>
{
    ...
    public const string KubeKind = "OidcKeyAllowedClientIDList";
    public const string KubeGroup = "identity.vault.upbound.io";
    public const string KubePluralName = "oidckeyallowedclientids";
    ...
    public string Kind { get; set; } = "OidcKeyAllowedClientIDList";
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdRefPolicy
{
    ...
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdRef
{
    ...
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecForProviderKeyNameRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderKeyNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderKeyNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecForProviderKeyNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderKeyNameRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecForProviderKeyNameSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderKeyNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderKeyNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecForProvider
{
    ...
    /// </summary>
    [JsonPropertyName("allowedClientId")]
    public string? AllowedClientId { get; set; }

    /// <summary>Reference to a OidcRole in identity to populate allowedClientId.</summary>
    [JsonPropertyName("allowedClientIdRef")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdRef? AllowedClientIdRef { get; set; }

    /// <summary>Selector for a OidcRole in identity to populate allowedClientId.</summary>
    [JsonPropertyName("allowedClientIdSelector")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderAllowedClientIdSelector? AllowedClientIdSelector { get; set; }
    ...
    /// <summary>Reference to a OidcKey in identity to populate keyName.</summary>
    [JsonPropertyName("keyNameRef")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderKeyNameRef? KeyNameRef { get; set; }

    /// <summary>Selector for a OidcKey in identity to populate keyName.</summary>
    [JsonPropertyName("keyNameSelector")]
    public V1alpha1OidcKeyAllowedClientIDSpecForProviderKeyNameSelector? KeyNameSelector { get; set; }
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecInitProvider
{
    ...
    /// <summary>Reference to a OidcRole in identity to populate allowedClientId.</summary>
    [JsonPropertyName("allowedClientIdRef")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdRef? AllowedClientIdRef { get; set; }

    /// <summary>Selector for a OidcRole in identity to populate allowedClientId.</summary>
    [JsonPropertyName("allowedClientIdSelector")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderAllowedClientIdSelector? AllowedClientIdSelector { get; set; }
    ...
    /// <summary>Reference to a OidcKey in identity to populate keyName.</summary>
    [JsonPropertyName("keyNameRef")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameRef? KeyNameRef { get; set; }

    /// <summary>Selector for a OidcKey in identity to populate keyName.</summary>
    [JsonPropertyName("keyNameSelector")]
    public V1alpha1OidcKeyAllowedClientIDSpecInitProviderKeyNameSelector? KeyNameSelector { get; set; }
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1OidcKeyAllowedClientIDSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1OidcKeyAllowedClientIDSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1OidcKeyAllowedClientIDSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1OidcKeyAllowedClientIDSpec
{
    ...
    public V1alpha1OidcKeyAllowedClientIDSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1OidcKeyAllowedClientIDSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1OidcKeyAllowedClientIDSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1OidcKeyAllowedClientIDSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1OidcKeyAllowedClientIDSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1OidcKeyAllowedClientIDStatus
{
    ...
    public V1alpha1OidcKeyAllowedClientIDStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1OidcKeyAllowedClientIDStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "OidcKeyAllowedClientID";
    public const string KubeGroup = "identity.vault.upbound.io";
    public const string KubePluralName = "oidckeyallowedclientids";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "OidcKeyAllowedClientID";
    ...
    public required V1alpha1OidcKeyAllowedClientIDSpec Spec { get; set; }

    /// <summary>OidcKeyAllowedClientIDStatus defines the observed state of OidcKeyAllowedClientID.</summary>
    [JsonPropertyName("status")]
    public V1alpha1OidcKeyAllowedClientIDStatus? Status { get; set; }
}