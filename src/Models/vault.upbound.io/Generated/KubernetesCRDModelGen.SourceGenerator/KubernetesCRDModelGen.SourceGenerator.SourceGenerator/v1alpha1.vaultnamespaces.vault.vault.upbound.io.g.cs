...
public partial class V1alpha1VaultNamespaceList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1VaultNamespace>
{
    ...
    public const string KubeKind = "VaultNamespaceList";
    public const string KubeGroup = "vault.vault.upbound.io";
    public const string KubePluralName = "vaultnamespaces";
    ...
    public string Kind { get; set; } = "VaultNamespaceList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1VaultNamespaceSpecDeletionPolicyEnum>))]
public enum V1alpha1VaultNamespaceSpecDeletionPolicyEnum
{
...
public partial class V1alpha1VaultNamespaceSpecForProviderNamespaceRefPolicy
{
    ...
    public V1alpha1VaultNamespaceSpecForProviderNamespaceRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1VaultNamespaceSpecForProviderNamespaceRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1VaultNamespaceSpecForProviderNamespaceRef
{
    ...
    public V1alpha1VaultNamespaceSpecForProviderNamespaceRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1VaultNamespaceSpecForProviderNamespaceSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1VaultNamespaceSpecForProviderNamespaceSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1VaultNamespaceSpecForProviderNamespaceSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1VaultNamespaceSpecForProvider
{
    ...
    public V1alpha1VaultNamespaceSpecForProviderNamespaceRef? NamespaceRef { get; set; }

    /// <summary>Selector for a VaultNamespace in vault to populate namespace.</summary>
    [JsonPropertyName("namespaceSelector")]
    public V1alpha1VaultNamespaceSpecForProviderNamespaceSelector? NamespaceSelector { get; set; }
...
public partial class V1alpha1VaultNamespaceSpecInitProviderNamespaceRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1VaultNamespaceSpecInitProviderNamespaceRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1VaultNamespaceSpecInitProviderNamespaceRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1VaultNamespaceSpecInitProviderNamespaceRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1VaultNamespaceSpecInitProviderNamespaceRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1VaultNamespaceSpecInitProviderNamespaceSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1VaultNamespaceSpecInitProviderNamespaceSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1VaultNamespaceSpecInitProviderNamespaceSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1VaultNamespaceSpecInitProviderNamespaceSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1VaultNamespaceSpecInitProviderNamespaceSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1VaultNamespaceSpecInitProvider
{
    ...
    /// <summary>Reference to a VaultNamespace in vault to populate namespace.</summary>
    [JsonPropertyName("namespaceRef")]
    public V1alpha1VaultNamespaceSpecInitProviderNamespaceRef? NamespaceRef { get; set; }

    /// <summary>Selector for a VaultNamespace in vault to populate namespace.</summary>
    [JsonPropertyName("namespaceSelector")]
    public V1alpha1VaultNamespaceSpecInitProviderNamespaceSelector? NamespaceSelector { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1VaultNamespaceSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1alpha1VaultNamespaceSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1VaultNamespaceSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1alpha1VaultNamespaceSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1alpha1VaultNamespaceSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1VaultNamespaceSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1VaultNamespaceSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1VaultNamespaceSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1VaultNamespaceSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1VaultNamespaceSpec
{
    ...
    public V1alpha1VaultNamespaceSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1VaultNamespaceSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1VaultNamespaceSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1VaultNamespaceSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1VaultNamespaceSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1VaultNamespaceStatusAtProvider
{
    ...
    /// <summary>The fully qualified path to the namespace, including the provider namespace and a trailing slash.</summary>
    [JsonPropertyName("id")]
...
public partial class V1alpha1VaultNamespaceStatus
{
    ...
    public V1alpha1VaultNamespaceStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1VaultNamespaceStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "VaultNamespace";
    public const string KubeGroup = "vault.vault.upbound.io";
    public const string KubePluralName = "vaultnamespaces";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "VaultNamespace";
    ...
    public required V1alpha1VaultNamespaceSpec Spec { get; set; }

    /// <summary>VaultNamespaceStatus defines the observed state of VaultNamespace.</summary>
    [JsonPropertyName("status")]
    public V1alpha1VaultNamespaceStatus? Status { get; set; }
}