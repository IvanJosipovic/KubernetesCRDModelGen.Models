...
/// <summary>AuthBackendRole is the Schema for the AuthBackendRoles API. Manages AppRole auth backend roles in Vault.</summary>
...
public partial class V1alpha1AuthBackendRoleSpecForProvider
{
    ...
    /// </summary>
    [JsonPropertyName("secretIdBoundCidrs")]
    public IList<string>? SecretIdBoundCidrs { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("secretIdNumUses")]
