...
public partial class V1alpha1SecretBackendIntermediateSetSignedList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1SecretBackendIntermediateSetSigned>
{
    ...
    public const string KubeKind = "SecretBackendIntermediateSetSignedList";
    public const string KubeGroup = "pki.vault.upbound.io";
    public const string KubePluralName = "secretbackendintermediatesetsigneds";
    ...
    public string Kind { get; set; } = "SecretBackendIntermediateSetSignedList";
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendRefPolicy
{
    ...
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendRef
{
    ...
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecForProviderCertificateRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderCertificateRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderCertificateRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecForProviderCertificateRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderCertificateRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecForProviderCertificateSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderCertificateSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderCertificateSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecForProvider
{
    ...
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendRef? BackendRef { get; set; }

    /// <summary>Selector for a Mount in vault to populate backend.</summary>
    [JsonPropertyName("backendSelector")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderBackendSelector? BackendSelector { get; set; }
    ...
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderCertificateRef? CertificateRef { get; set; }

    /// <summary>Selector for a SecretBackendRootSignIntermediate in pki to populate certificate.</summary>
    [JsonPropertyName("certificateSelector")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecForProviderCertificateSelector? CertificateSelector { get; set; }
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecInitProvider
{
    ...
    /// <summary>Reference to a Mount in vault to populate backend.</summary>
    [JsonPropertyName("backendRef")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendRef? BackendRef { get; set; }

    /// <summary>Selector for a Mount in vault to populate backend.</summary>
    [JsonPropertyName("backendSelector")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderBackendSelector? BackendSelector { get; set; }
    ...
    /// <summary>Reference to a SecretBackendRootSignIntermediate in pki to populate certificate.</summary>
    [JsonPropertyName("certificateRef")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateRef? CertificateRef { get; set; }

    /// <summary>Selector for a SecretBackendRootSignIntermediate in pki to populate certificate.</summary>
    [JsonPropertyName("certificateSelector")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProviderCertificateSelector? CertificateSelector { get; set; }
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1SecretBackendIntermediateSetSignedSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1SecretBackendIntermediateSetSignedSpec
{
    ...
    public V1alpha1SecretBackendIntermediateSetSignedSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1SecretBackendIntermediateSetSignedSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1SecretBackendIntermediateSetSignedSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1SecretBackendIntermediateSetSignedSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1SecretBackendIntermediateSetSignedSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1SecretBackendIntermediateSetSignedStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("importedIssuers")]
    public IList<string>? ImportedIssuers { get; set; }

    /// <summary>
    /// The imported keys indicating which keys were created as part of this request.
    /// The imported keys.
    /// </summary>
    [JsonPropertyName("importedKeys")]
    public IList<string>? ImportedKeys { get; set; }
...
public partial class V1alpha1SecretBackendIntermediateSetSignedStatus
{
    ...
    public V1alpha1SecretBackendIntermediateSetSignedStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1SecretBackendIntermediateSetSignedStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "SecretBackendIntermediateSetSigned";
    public const string KubeGroup = "pki.vault.upbound.io";
    public const string KubePluralName = "secretbackendintermediatesetsigneds";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "SecretBackendIntermediateSetSigned";
    ...
    public required V1alpha1SecretBackendIntermediateSetSignedSpec Spec { get; set; }

    /// <summary>SecretBackendIntermediateSetSignedStatus defines the observed state of SecretBackendIntermediateSetSigned.</summary>
    [JsonPropertyName("status")]
    public V1alpha1SecretBackendIntermediateSetSignedStatus? Status { get; set; }
}