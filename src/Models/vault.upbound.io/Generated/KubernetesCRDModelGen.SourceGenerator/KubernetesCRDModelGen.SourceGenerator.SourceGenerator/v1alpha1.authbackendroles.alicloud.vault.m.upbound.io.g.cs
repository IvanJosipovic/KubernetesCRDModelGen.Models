...
namespace KubernetesCRDModelGen.Models.alicloud.vault.m.upbound.io;
/// <summary>AuthBackendRole is the Schema for the AuthBackendRoles API. Managing roles in an AliCloud auth backend in Vault</summary>
...
public partial class V1alpha1AuthBackendRoleList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1AuthBackendRole>
{
    ...
    public const string KubeGroup = "alicloud.vault.m.upbound.io";
    public const string KubePluralName = "authbackendroles";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    public string ApiVersion { get; set; } = "alicloud.vault.m.upbound.io/v1alpha1";
