...
public partial class V1beta2VolumeGroupSnapshotContentSpecSource
{
    ...
    public V1beta2VolumeGroupSnapshotContentSpecSourceGroupSnapshotHandles? GroupSnapshotHandles { get; set; }
...
public partial class V1beta2VolumeGroupSnapshotContentSpec
{
    ...
    public required V1beta2VolumeGroupSnapshotContentSpecDeletionPolicyEnum DeletionPolicy { get; set; }
    ...
    public required V1beta2VolumeGroupSnapshotContentSpecSource Source { get; set; }
    ...
    public required V1beta2VolumeGroupSnapshotContentSpecVolumeGroupSnapshotRef VolumeGroupSnapshotRef { get; set; }
}
...
public partial class V1beta2VolumeGroupSnapshotContentStatus
{
    ...
    public V1beta2VolumeGroupSnapshotContentStatusError? Error { get; set; }
    ...
    public IList<V1beta2VolumeGroupSnapshotContentStatusVolumeSnapshotInfoList>? VolumeSnapshotInfoList { get; set; }
}
...
public partial class V1beta2VolumeGroupSnapshotContent : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta2VolumeGroupSnapshotContentSpec>, IStatus<V1beta2VolumeGroupSnapshotContentStatus?>
{
    ...
    public required V1beta2VolumeGroupSnapshotContentSpec Spec { get; set; }

    /// <summary>status represents the current information of a group snapshot.</summary>
    [JsonPropertyName("status")]
    public V1beta2VolumeGroupSnapshotContentStatus? Status { get; set; }
}