...
public partial class V1VolumeSnapshotList : IKubernetesObject<V1ListMeta>, IItems<V1VolumeSnapshot>
{
    ...
    public string Kind { get; set; } = "VolumeSnapshotList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1VolumeSnapshot objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1VolumeSnapshot> Items { get; set; }
}
...
public partial class V1VolumeSnapshotSpec
{
    ...
    public required V1VolumeSnapshotSpecSource Source { get; set; }
...
public partial class V1VolumeSnapshotStatus
{
    ...
    public IntOrString? RestoreSize { get; set; }
...
public partial class V1VolumeSnapshot : IKubernetesObject<V1ObjectMeta>, ISpec<V1VolumeSnapshotSpec>, IStatus<V1VolumeSnapshotStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "VolumeSnapshot";
    ...
    public required V1VolumeSnapshotSpec Spec { get; set; }
