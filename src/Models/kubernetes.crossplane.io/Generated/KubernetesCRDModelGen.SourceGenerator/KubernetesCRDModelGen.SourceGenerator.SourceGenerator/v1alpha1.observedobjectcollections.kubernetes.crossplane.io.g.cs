...
public partial class V1alpha1ObservedObjectCollectionList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ObservedObjectCollection>
{
    ...
    public const string KubeKind = "ObservedObjectCollectionList";
    public const string KubeGroup = "kubernetes.crossplane.io";
    public const string KubePluralName = "observedobjectcollections";
    ...
    public string Kind { get; set; } = "ObservedObjectCollectionList";
...
{
    /// <summary>Annotations of an object</summary>
    [JsonPropertyName("annotations")]
    public IDictionary<string, string>? Annotations { get; set; }

    /// <summary>Labels of an object</summary>
...
public partial class V1alpha1ObservedObjectCollectionSpecObjectTemplate
{
    /// <summary>Objects metadata</summary>
    [JsonPropertyName("metadata")]
    public V1alpha1ObservedObjectCollectionSpecObjectTemplateMetadata? Metadata { get; set; }
}
...
public partial class V1alpha1ObservedObjectCollectionSpecObserveObjectsSelector
{
    ...
    public IList<V1alpha1ObservedObjectCollectionSpecObserveObjectsSelectorMatchExpressions>? MatchExpressions { get; set; }
...
{
    /// <summary>APIVersion of objects that should be matched by the selector</summary>
    [JsonPropertyName("apiVersion")]
    public required string ApiVersion { get; set; }

    /// <summary>Kind of objects that should be matched by the selector</summary>
    [JsonPropertyName("kind")]
    ...
    public required V1alpha1ObservedObjectCollectionSpecObserveObjectsSelector Selector { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1ObservedObjectCollectionSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1alpha1ObservedObjectCollectionSpecProviderConfigRefPolicyResolutionEnum
{
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1ObservedObjectCollectionSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1alpha1ObservedObjectCollectionSpecProviderConfigRefPolicyResolveEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1alpha1ObservedObjectCollectionSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    public V1alpha1ObservedObjectCollectionSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1ObservedObjectCollectionSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1ObservedObjectCollectionSpecProviderConfigRef
{
    ...
    public V1alpha1ObservedObjectCollectionSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
{
    /// <summary>Template when defined is used for creating Object instances</summary>
    [JsonPropertyName("objectTemplate")]
    public V1alpha1ObservedObjectCollectionSpecObjectTemplate? ObjectTemplate { get; set; }

    /// <summary>
    /// ObserveObjects declares what criteria object need to fulfil
    /// to become a member of this collection
    /// </summary>
    [JsonPropertyName("observeObjects")]
    public required V1alpha1ObservedObjectCollectionSpecObserveObjects ObserveObjects { get; set; }
    ...
    public V1alpha1ObservedObjectCollectionSpecProviderConfigRef? ProviderConfigRef { get; set; }
}
...
public partial class V1alpha1ObservedObjectCollectionStatus
{
    ...
    public IDictionary<string, string>? MembershipLabel { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "ObservedObjectCollection";
    public const string KubeGroup = "kubernetes.crossplane.io";
    public const string KubePluralName = "observedobjectcollections";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ObservedObjectCollection";
    ...
    public required V1alpha1ObservedObjectCollectionSpec Spec { get; set; }

    /// <summary>ObservedObjectCollectionStatus represents the observed state of a ObservedObjectCollection</summary>
    [JsonPropertyName("status")]
    public V1alpha1ObservedObjectCollectionStatus? Status { get; set; }
}