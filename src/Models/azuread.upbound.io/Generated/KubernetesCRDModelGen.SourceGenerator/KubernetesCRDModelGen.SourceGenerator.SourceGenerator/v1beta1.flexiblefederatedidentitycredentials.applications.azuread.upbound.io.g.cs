...
public partial class V1beta1FlexibleFederatedIdentityCredentialList : IKubernetesObject<V1ListMeta>, IItems<V1beta1FlexibleFederatedIdentityCredential>
{
    ...
    public const string KubeKind = "FlexibleFederatedIdentityCredentialList";
    public const string KubeGroup = "applications.azuread.upbound.io";
    public const string KubePluralName = "flexiblefederatedidentitycredentials";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    public string ApiVersion { get; set; } = "applications.azuread.upbound.io/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "FlexibleFederatedIdentityCredentialList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1FlexibleFederatedIdentityCredential objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1FlexibleFederatedIdentityCredential> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1FlexibleFederatedIdentityCredentialSpecDeletionPolicyEnum>))]
public enum V1beta1FlexibleFederatedIdentityCredentialSpecDeletionPolicyEnum
{
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecForProviderApplicationIdRefPolicy
{
    ...
    public V1beta1FlexibleFederatedIdentityCredentialSpecForProviderApplicationIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1FlexibleFederatedIdentityCredentialSpecForProviderApplicationIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecForProviderApplicationIdRef
{
    ...
    public V1beta1FlexibleFederatedIdentityCredentialSpecForProviderApplicationIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecForProviderApplicationIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecForProviderApplicationIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecForProviderApplicationIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecForProvider
{
    ...
    public V1beta1FlexibleFederatedIdentityCredentialSpecForProviderApplicationIdRef? ApplicationIdRef { get; set; }

    /// <summary>Selector for a Application in applications to populate applicationId.</summary>
    [JsonPropertyName("applicationIdSelector")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecForProviderApplicationIdSelector? ApplicationIdSelector { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("claimsMatchingExpression")]
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecInitProvider
{
    ...
    /// <summary>Reference to a Application in applications to populate applicationId.</summary>
    [JsonPropertyName("applicationIdRef")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdRef? ApplicationIdRef { get; set; }

    /// <summary>Selector for a Application in applications to populate applicationId.</summary>
    [JsonPropertyName("applicationIdSelector")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecInitProviderApplicationIdSelector? ApplicationIdSelector { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1FlexibleFederatedIdentityCredentialSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1FlexibleFederatedIdentityCredentialSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1FlexibleFederatedIdentityCredentialSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1FlexibleFederatedIdentityCredentialSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1FlexibleFederatedIdentityCredentialSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1FlexibleFederatedIdentityCredentialSpec
{
    ...
    public V1beta1FlexibleFederatedIdentityCredentialSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1FlexibleFederatedIdentityCredentialSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1FlexibleFederatedIdentityCredentialSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1FlexibleFederatedIdentityCredentialSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1FlexibleFederatedIdentityCredentialSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1FlexibleFederatedIdentityCredentialStatus
{
    ...
    public V1beta1FlexibleFederatedIdentityCredentialStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1FlexibleFederatedIdentityCredentialStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "FlexibleFederatedIdentityCredential";
    public const string KubeGroup = "applications.azuread.upbound.io";
    public const string KubePluralName = "flexiblefederatedidentitycredentials";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "FlexibleFederatedIdentityCredential";
    ...
    public required V1beta1FlexibleFederatedIdentityCredentialSpec Spec { get; set; }

    /// <summary>FlexibleFederatedIdentityCredentialStatus defines the observed state of FlexibleFederatedIdentityCredential.</summary>
    [JsonPropertyName("status")]
    public V1beta1FlexibleFederatedIdentityCredentialStatus? Status { get; set; }
}