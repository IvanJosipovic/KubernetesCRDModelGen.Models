...
public partial class V1beta1TokenSigningCertificateList : IKubernetesObject<V1ListMeta>, IItems<V1beta1TokenSigningCertificate>
{
    ...
    public string ApiVersion { get; set; } = "serviceprincipals.azuread.upbound.io/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TokenSigningCertificateList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1TokenSigningCertificate objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1TokenSigningCertificate> Items { get; set; }
}
...
public partial class V1beta1TokenSigningCertificateSpec
{
    ...
    public required V1beta1TokenSigningCertificateSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1TokenSigningCertificate : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1TokenSigningCertificateSpec>, IStatus<V1beta1TokenSigningCertificateStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TokenSigningCertificate";
    ...
    public required V1beta1TokenSigningCertificateSpec Spec { get; set; }
