...
public partial class V1beta1SecretList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Secret>
{
    ...
    public string ApiVersion { get; set; } = "synchronization.azuread.m.upbound.io/v1beta1";
...
public partial class V1beta1SecretSpecInitProviderCredential
{
    ...
    /// </summary>
    [JsonPropertyName("valueSecretRef")]
    public required V1beta1SecretSpecInitProviderCredentialValueSecretRef ValueSecretRef { get; set; }
}
