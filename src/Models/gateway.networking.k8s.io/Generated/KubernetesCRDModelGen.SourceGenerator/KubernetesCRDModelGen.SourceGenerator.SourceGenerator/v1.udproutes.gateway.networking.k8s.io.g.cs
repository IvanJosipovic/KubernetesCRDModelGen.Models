...
public partial class V1UDPRouteList : IKubernetesObject<V1ListMeta>, IItems<V1UDPRoute>
{
    ...
    public const string KubeKind = "UDPRouteList";
    ...
    public string Kind { get; set; } = "UDPRouteList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1UDPRoute objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1UDPRoute> Items { get; set; }
}
...
public partial class V1UDPRouteSpecRules
{
    ...
    public required IList<V1UDPRouteSpecRulesBackendRefs> BackendRefs { get; set; }
...
public partial class V1UDPRouteSpec
{
    ...
    public IList<V1UDPRouteSpecParentRefs>? ParentRefs { get; set; }

    /// <summary>Rules are a list of UDP matchers and actions.</summary>
    [JsonPropertyName("rules")]
    public required IList<V1UDPRouteSpecRules> Rules { get; set; }
}
...
public partial class V1UDPRouteStatusParentsConditions
{
    ...
    public required V1UDPRouteStatusParentsConditionsStatusEnum Status { get; set; }
...
public partial class V1UDPRouteStatusParents
{
    ...
    public required IList<V1UDPRouteStatusParentsConditions> Conditions { get; set; }
    ...
    public required V1UDPRouteStatusParentsParentRef ParentRef { get; set; }
}
...
public partial class V1UDPRouteStatus
{
    ...
    public required IList<V1UDPRouteStatusParents> Parents { get; set; }
}
...
public partial class V1UDPRoute : IKubernetesObject<V1ObjectMeta>, ISpec<V1UDPRouteSpec>, IStatus<V1UDPRouteStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "UDPRoute";
    ...
    public required V1UDPRouteSpec Spec { get; set; }

    /// <summary>Status defines the current state of UDPRoute.</summary>
    [JsonPropertyName("status")]
    public V1UDPRouteStatus? Status { get; set; }
}