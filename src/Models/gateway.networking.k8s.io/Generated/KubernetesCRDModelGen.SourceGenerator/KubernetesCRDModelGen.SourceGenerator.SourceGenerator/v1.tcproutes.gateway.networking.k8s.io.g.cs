...
public partial class V1TCPRouteList : IKubernetesObject<V1ListMeta>, IItems<V1TCPRoute>
{
    ...
    public const string KubeKind = "TCPRouteList";
    ...
    public string Kind { get; set; } = "TCPRouteList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1TCPRoute objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1TCPRoute> Items { get; set; }
}
...
public partial class V1TCPRouteSpecRules
{
    ...
    public required IList<V1TCPRouteSpecRulesBackendRefs> BackendRefs { get; set; }
...
public partial class V1TCPRouteSpec
{
    ...
    /// <summary>Rules are a list of TCP matchers and actions.</summary>
    [JsonPropertyName("rules")]
    public required IList<V1TCPRouteSpecRules> Rules { get; set; }
}
...
public partial class V1TCPRouteStatusParentsConditions
{
    ...
    public required V1TCPRouteStatusParentsConditionsStatusEnum Status { get; set; }
...
public partial class V1TCPRouteStatusParents
{
    ...
    public required IList<V1TCPRouteStatusParentsConditions> Conditions { get; set; }
    ...
    public required V1TCPRouteStatusParentsParentRef ParentRef { get; set; }
}
...
public partial class V1TCPRouteStatus
{
    ...
    public required IList<V1TCPRouteStatusParents> Parents { get; set; }
}
...
public partial class V1TCPRoute : IKubernetesObject<V1ObjectMeta>, ISpec<V1TCPRouteSpec>, IStatus<V1TCPRouteStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TCPRoute";
    ...
    public required V1TCPRouteSpec Spec { get; set; }

    /// <summary>Status defines the current state of TCPRoute.</summary>
    [JsonPropertyName("status")]
    public V1TCPRouteStatus? Status { get; set; }
}