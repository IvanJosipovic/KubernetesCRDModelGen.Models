...
public partial class V1alpha1ImageList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1Image>
{
    ...
    public string ApiVersion { get; set; } = "caching.internal.knative.dev/v1alpha1";
    ...
    /// <summary>List of V1alpha1Image objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1Image> Items { get; set; }
}
