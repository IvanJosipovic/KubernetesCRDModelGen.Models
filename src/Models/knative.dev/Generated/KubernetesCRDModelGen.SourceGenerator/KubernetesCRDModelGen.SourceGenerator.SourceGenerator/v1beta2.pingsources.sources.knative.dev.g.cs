...
public partial class V1beta2PingSourceList : IKubernetesObject<V1ListMeta>, IItems<V1beta2PingSource>
{
    ...
    public string ApiVersion { get; set; } = "sources.knative.dev/v1beta2";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PingSourceList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta2PingSource objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta2PingSource> Items { get; set; }
}
...
public partial class V1beta2PingSourceSpecSink
{
    ...
    public V1beta2PingSourceSpecSinkRef? Ref { get; set; }
...
public partial class V1beta2PingSourceSpec
{
    ...
    public V1beta2PingSourceSpecCeOverrides? CeOverrides { get; set; }
    ...
    public V1beta2PingSourceSpecSink? Sink { get; set; }
...
public partial class V1beta2PingSourceStatus
{
    ...
    public V1beta2PingSourceStatusAuth? Auth { get; set; }
    ...
    public IList<V1beta2PingSourceStatusCeAttributes>? CeAttributes { get; set; }

    /// <summary>Conditions the latest available observations of a resource&apos;s current state.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta2PingSourceStatusConditions>? Conditions { get; set; }
...
[global::System.Obsolete("sources.knative.dev/v1beta2 PingSource is deprecated; see https://knative.dev/docs/eventing/sources/ping-source/ for instructions to migrate to sources.knative.dev/v1 PingSource")]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1beta2PingSource : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta2PingSourceSpec?>, IStatus<V1beta2PingSourceStatus?>
{
    public const string KubeApiVersion = "v1beta2";
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PingSource";
    ...
    public V1beta2PingSourceSpec? Spec { get; set; }

    /// <summary>PingSourceStatus defines the observed state of PingSource (from the controller).</summary>
    [JsonPropertyName("status")]
    public V1beta2PingSourceStatus? Status { get; set; }
}