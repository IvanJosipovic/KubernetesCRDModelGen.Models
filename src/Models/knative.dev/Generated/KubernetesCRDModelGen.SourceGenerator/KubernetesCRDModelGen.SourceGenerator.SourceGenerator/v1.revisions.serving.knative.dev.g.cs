...
public partial class V1RevisionList : IKubernetesObject<V1ListMeta>, IItems<V1Revision>
{
    ...
    /// <summary>List of V1Revision objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1Revision> Items { get; set; }
}
...
public partial class V1RevisionSpec
{
    ...
    public required IList<V1RevisionSpecContainers> Containers { get; set; }
