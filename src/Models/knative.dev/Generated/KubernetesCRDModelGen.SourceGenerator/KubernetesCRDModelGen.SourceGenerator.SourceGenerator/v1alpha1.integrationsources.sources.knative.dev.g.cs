...
public partial class V1alpha1IntegrationSourceList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1IntegrationSource>
{
    ...
    public string ApiVersion { get; set; } = "sources.knative.dev/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "IntegrationSourceList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1IntegrationSource objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1IntegrationSource> Items { get; set; }
}
...
public partial class V1alpha1IntegrationSourceSpecAwsAuth
{
    ...
    /// <summary>Optional ServiceAccount to assign to pod. This enables the pod default credentials to be used instead of the auth secret.</summary>
...
public partial class V1alpha1IntegrationSource : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1IntegrationSourceSpec?>, IStatus<V1alpha1IntegrationSourceStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "IntegrationSource";
