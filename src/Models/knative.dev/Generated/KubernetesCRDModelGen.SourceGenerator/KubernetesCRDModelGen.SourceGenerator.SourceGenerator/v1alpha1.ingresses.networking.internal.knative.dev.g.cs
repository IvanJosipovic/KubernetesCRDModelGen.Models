...
public partial class V1alpha1IngressList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1Ingress>
{
    ...
    /// <summary>List of V1alpha1Ingress objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1Ingress> Items { get; set; }
}
...
public partial class V1alpha1IngressSpecRulesHttpPathsSplits
{
    ...
    public required IntOrString ServicePort { get; set; }
}
...
public partial class V1alpha1IngressSpecRulesHttpPaths
{
    ...
    public required IList<V1alpha1IngressSpecRulesHttpPathsSplits> Splits { get; set; }
}
...
public partial class V1alpha1IngressSpecRulesHttp
{
    ...
    public required IList<V1alpha1IngressSpecRulesHttpPaths> Paths { get; set; }
}
