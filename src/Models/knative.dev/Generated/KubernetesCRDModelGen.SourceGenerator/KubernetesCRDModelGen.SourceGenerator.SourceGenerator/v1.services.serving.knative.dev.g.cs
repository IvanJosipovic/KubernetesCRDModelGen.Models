...
public partial class V1ServiceList : IKubernetesObject<V1ListMeta>, IItems<V1Service>
{
    ...
    public string ApiVersion { get; set; } = "serving.knative.dev/v1";
    ...
    /// <summary>List of V1Service objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1Service> Items { get; set; }
}
...
public partial class V1ServiceSpecTemplateSpec
{
    ...
    public required IList<V1ServiceSpecTemplateSpecContainers> Containers { get; set; }
