...
[global::System.Obsolete("eventing.knative.dev/v1beta1 EventType is deprecated; see https://knative.dev/docs/eventing/event-registry/ for instructions to migrate to eventing.knative.dev/v1beta2 EventType")]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1beta1EventTypeList : IKubernetesObject<V1ListMeta>, IItems<V1beta1EventType>
{
    ...
    public string ApiVersion { get; set; } = "eventing.knative.dev/v1beta1";
    ...
    /// <summary>List of V1beta1EventType objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1EventType> Items { get; set; }
}
...
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[global::System.Obsolete("eventing.knative.dev/v1beta1 EventType is deprecated; see https://knative.dev/docs/eventing/event-registry/ for instructions to migrate to eventing.knative.dev/v1beta2 EventType")]
public partial class V1beta1EventTypeSpecReference
{
...
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[global::System.Obsolete("eventing.knative.dev/v1beta1 EventType is deprecated; see https://knative.dev/docs/eventing/event-registry/ for instructions to migrate to eventing.knative.dev/v1beta2 EventType")]
public partial class V1beta1EventTypeSpec
{
    ...
    public V1beta1EventTypeSpecReference? Reference { get; set; }
...
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[global::System.Obsolete("eventing.knative.dev/v1beta1 EventType is deprecated; see https://knative.dev/docs/eventing/event-registry/ for instructions to migrate to eventing.knative.dev/v1beta2 EventType")]
public partial class V1beta1EventTypeStatusConditions
{
...
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[global::System.Obsolete("eventing.knative.dev/v1beta1 EventType is deprecated; see https://knative.dev/docs/eventing/event-registry/ for instructions to migrate to eventing.knative.dev/v1beta2 EventType")]
public partial class V1beta1EventTypeStatus
{
    ...
    public IList<V1beta1EventTypeStatusConditions>? Conditions { get; set; }
...
[global::System.Obsolete("eventing.knative.dev/v1beta1 EventType is deprecated; see https://knative.dev/docs/eventing/event-registry/ for instructions to migrate to eventing.knative.dev/v1beta2 EventType")]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1beta1EventType : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1EventTypeSpec?>, IStatus<V1beta1EventTypeStatus?>
{
    public const string KubeApiVersion = "v1beta1";
    ...
    public V1beta1EventTypeSpec? Spec { get; set; }

    /// <summary>Status represents the current state of the EventType. This data may be out of date.</summary>
    [JsonPropertyName("status")]
    public V1beta1EventTypeStatus? Status { get; set; }
}