...
public partial class V1HelmRepositoryList : IKubernetesObject<V1ListMeta>, IItems<V1HelmRepository>
{
    ...
    public string Kind { get; set; } = "HelmRepositoryList";
...
public partial class V1HelmRepositorySpecAccessFrom
{
    ...
    public required IList<V1HelmRepositorySpecAccessFromNamespaceSelectors> NamespaceSelectors { get; set; }
}
...
public partial class V1HelmRepositoryStatusConditions
{
    ...
    public required V1HelmRepositoryStatusConditionsStatusEnum Status { get; set; }
