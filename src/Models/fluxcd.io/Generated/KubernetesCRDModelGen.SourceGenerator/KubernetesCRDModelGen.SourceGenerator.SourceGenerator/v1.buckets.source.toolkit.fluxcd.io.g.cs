...
public partial class V1BucketSpecSts
{
    ...
    public required V1BucketSpecStsProviderEnum Provider { get; set; }
...
public partial class V1BucketSpec
{
    ...
    /// </summary>
    [JsonPropertyName("provider")]
    public V1BucketSpecProviderEnum? Provider { get; set; }
...
public partial class V1BucketStatusConditions
{
    ...
    public required V1BucketStatusConditionsStatusEnum Status { get; set; }
