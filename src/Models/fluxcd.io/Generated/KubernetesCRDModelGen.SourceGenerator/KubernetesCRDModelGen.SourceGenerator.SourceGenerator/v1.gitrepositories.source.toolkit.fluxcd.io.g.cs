...
public partial class V1GitRepositoryList : IKubernetesObject<V1ListMeta>, IItems<V1GitRepository>
{
    ...
    public string Kind { get; set; } = "GitRepositoryList";
...
public partial class V1GitRepositorySpecInclude
{
    ...
    public required V1GitRepositorySpecIncludeRepository Repository { get; set; }
...
public partial class V1GitRepositorySpec
{
    ...
    public V1GitRepositorySpecProviderEnum? Provider { get; set; }
...
public partial class V1GitRepositoryStatusConditions
{
    ...
    public required V1GitRepositoryStatusConditionsStatusEnum Status { get; set; }
...
public partial class V1GitRepositoryStatusObservedInclude
{
    ...
    /// </summary>
    [JsonPropertyName("repository")]
    public required V1GitRepositoryStatusObservedIncludeRepository Repository { get; set; }
