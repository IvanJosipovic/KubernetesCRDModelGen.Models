...
public partial class V1alpha1PromotionTaskList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1PromotionTask>
{
    ...
    public const string KubeKind = "PromotionTaskList";
    public const string KubeGroup = "kargo.akuity.io";
    public const string KubePluralName = "promotiontasks";
    ...
    public string Kind { get; set; } = "PromotionTaskList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1PromotionTask objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1PromotionTask> Items { get; set; }
}
...
public partial class V1alpha1PromotionTaskSpecStepsTask
{
    ...
    /// </summary>
    [JsonPropertyName("kind")]
    public V1alpha1PromotionTaskSpecStepsTaskKindEnum? Kind { get; set; }
...
public partial class V1alpha1PromotionTaskSpecSteps
{
    ...
    public V1alpha1PromotionTaskSpecStepsRetry? Retry { get; set; }
    ...
    public V1alpha1PromotionTaskSpecStepsTask? Task { get; set; }
    ...
    public IList<V1alpha1PromotionTaskSpecStepsVars>? Vars { get; set; }
}
...
public partial class V1alpha1PromotionTaskSpec
{
    ...
    public required IList<V1alpha1PromotionTaskSpecSteps> Steps { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "PromotionTask";
    public const string KubeGroup = "kargo.akuity.io";
    public const string KubePluralName = "promotiontasks";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PromotionTask";
    ...
    public required V1alpha1PromotionTaskSpec Spec { get; set; }
}