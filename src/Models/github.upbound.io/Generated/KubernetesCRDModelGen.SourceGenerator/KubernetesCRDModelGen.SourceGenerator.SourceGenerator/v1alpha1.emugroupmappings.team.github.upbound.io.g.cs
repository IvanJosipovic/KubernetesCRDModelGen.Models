...
public partial class V1alpha1EmuGroupMappingList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1EmuGroupMapping>
{
    ...
    public const string KubeKind = "EmuGroupMappingList";
    public const string KubeGroup = "team.github.upbound.io";
    public const string KubePluralName = "emugroupmappings";
    ...
    public string Kind { get; set; } = "EmuGroupMappingList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1EmuGroupMappingSpecDeletionPolicyEnum>))]
public enum V1alpha1EmuGroupMappingSpecDeletionPolicyEnum
{
...
public partial class V1alpha1EmuGroupMappingSpecForProviderTeamSlugRefPolicy
{
    ...
    public V1alpha1EmuGroupMappingSpecForProviderTeamSlugRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1EmuGroupMappingSpecForProviderTeamSlugRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1EmuGroupMappingSpecForProviderTeamSlugRef
{
    ...
    public V1alpha1EmuGroupMappingSpecForProviderTeamSlugRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1EmuGroupMappingSpecForProviderTeamSlugSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1EmuGroupMappingSpecForProviderTeamSlugSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1EmuGroupMappingSpecForProviderTeamSlugSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1EmuGroupMappingSpecForProvider
{
    ...
    public V1alpha1EmuGroupMappingSpecForProviderTeamSlugRef? TeamSlugRef { get; set; }

    /// <summary>Selector for a Team in team to populate teamSlug.</summary>
    [JsonPropertyName("teamSlugSelector")]
    public V1alpha1EmuGroupMappingSpecForProviderTeamSlugSelector? TeamSlugSelector { get; set; }
}
...
public partial class V1alpha1EmuGroupMappingSpecInitProviderTeamSlugRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1EmuGroupMappingSpecInitProviderTeamSlugRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1EmuGroupMappingSpecInitProviderTeamSlugRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1EmuGroupMappingSpecInitProviderTeamSlugRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1EmuGroupMappingSpecInitProviderTeamSlugRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1EmuGroupMappingSpecInitProviderTeamSlugSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1EmuGroupMappingSpecInitProviderTeamSlugSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1EmuGroupMappingSpecInitProviderTeamSlugSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1EmuGroupMappingSpecInitProviderTeamSlugSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1EmuGroupMappingSpecInitProviderTeamSlugSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1EmuGroupMappingSpecInitProvider
{
    ...
    /// <summary>Reference to a Team in team to populate teamSlug.</summary>
    [JsonPropertyName("teamSlugRef")]
    public V1alpha1EmuGroupMappingSpecInitProviderTeamSlugRef? TeamSlugRef { get; set; }

    /// <summary>Selector for a Team in team to populate teamSlug.</summary>
    [JsonPropertyName("teamSlugSelector")]
    public V1alpha1EmuGroupMappingSpecInitProviderTeamSlugSelector? TeamSlugSelector { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1EmuGroupMappingSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1alpha1EmuGroupMappingSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1EmuGroupMappingSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1alpha1EmuGroupMappingSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1alpha1EmuGroupMappingSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1EmuGroupMappingSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1EmuGroupMappingSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1EmuGroupMappingSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1EmuGroupMappingSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1EmuGroupMappingSpec
{
    ...
    public V1alpha1EmuGroupMappingSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1EmuGroupMappingSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1EmuGroupMappingSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1EmuGroupMappingSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1EmuGroupMappingSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1EmuGroupMappingStatus
{
    ...
    public V1alpha1EmuGroupMappingStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1EmuGroupMappingStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "EmuGroupMapping";
    public const string KubeGroup = "team.github.upbound.io";
    public const string KubePluralName = "emugroupmappings";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "EmuGroupMapping";
    ...
    public required V1alpha1EmuGroupMappingSpec Spec { get; set; }

    /// <summary>EmuGroupMappingStatus defines the observed state of EmuGroupMapping.</summary>
    [JsonPropertyName("status")]
    public V1alpha1EmuGroupMappingStatus? Status { get; set; }
}