...
public partial class V1alpha1RepositoryCustomPropertyList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1RepositoryCustomProperty>
{
    ...
    public const string KubeKind = "RepositoryCustomPropertyList";
    public const string KubeGroup = "repo.github.upbound.io";
    public const string KubePluralName = "repositorycustomproperties";
    ...
    public string Kind { get; set; } = "RepositoryCustomPropertyList";
...
public partial class V1alpha1RepositoryCustomPropertySpecForProviderRepositoryRefPolicy
{
    ...
    public V1alpha1RepositoryCustomPropertySpecForProviderRepositoryRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1RepositoryCustomPropertySpecForProviderRepositoryRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpecForProviderRepositoryRef
{
    ...
    public V1alpha1RepositoryCustomPropertySpecForProviderRepositoryRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpecForProviderRepositorySelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RepositoryCustomPropertySpecForProviderRepositorySelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RepositoryCustomPropertySpecForProviderRepositorySelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpecForProvider
{
    ...
    public V1alpha1RepositoryCustomPropertySpecForProviderRepositoryRef? RepositoryRef { get; set; }

    /// <summary>Selector for a Repository in repo to populate repository.</summary>
    [JsonPropertyName("repositorySelector")]
    public V1alpha1RepositoryCustomPropertySpecForProviderRepositorySelector? RepositorySelector { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpecInitProviderRepositoryRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RepositoryCustomPropertySpecInitProviderRepositoryRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RepositoryCustomPropertySpecInitProviderRepositoryRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpecInitProviderRepositoryRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1RepositoryCustomPropertySpecInitProviderRepositoryRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpecInitProviderRepositorySelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RepositoryCustomPropertySpecInitProviderRepositorySelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RepositoryCustomPropertySpecInitProviderRepositorySelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpecInitProviderRepositorySelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1RepositoryCustomPropertySpecInitProviderRepositorySelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpecInitProvider
{
    ...
    /// <summary>Reference to a Repository in repo to populate repository.</summary>
    [JsonPropertyName("repositoryRef")]
    public V1alpha1RepositoryCustomPropertySpecInitProviderRepositoryRef? RepositoryRef { get; set; }

    /// <summary>Selector for a Repository in repo to populate repository.</summary>
    [JsonPropertyName("repositorySelector")]
    public V1alpha1RepositoryCustomPropertySpecInitProviderRepositorySelector? RepositorySelector { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RepositoryCustomPropertySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RepositoryCustomPropertySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1RepositoryCustomPropertySpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RepositoryCustomPropertySpec
{
    ...
    public V1alpha1RepositoryCustomPropertySpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1RepositoryCustomPropertySpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1RepositoryCustomPropertySpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1RepositoryCustomPropertySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1RepositoryCustomPropertySpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1RepositoryCustomPropertyStatus
{
    ...
    public V1alpha1RepositoryCustomPropertyStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1RepositoryCustomPropertyStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "RepositoryCustomProperty";
    public const string KubeGroup = "repo.github.upbound.io";
    public const string KubePluralName = "repositorycustomproperties";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "RepositoryCustomProperty";
    ...
    public required V1alpha1RepositoryCustomPropertySpec Spec { get; set; }

    /// <summary>RepositoryCustomPropertyStatus defines the observed state of RepositoryCustomProperty.</summary>
    [JsonPropertyName("status")]
    public V1alpha1RepositoryCustomPropertyStatus? Status { get; set; }
}