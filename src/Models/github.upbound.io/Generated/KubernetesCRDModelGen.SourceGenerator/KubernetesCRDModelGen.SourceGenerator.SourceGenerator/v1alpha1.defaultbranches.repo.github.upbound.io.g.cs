...
public partial class V1alpha1DefaultBranchList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1DefaultBranch>
{
    ...
    public const string KubeKind = "DefaultBranchList";
    public const string KubeGroup = "repo.github.upbound.io";
    public const string KubePluralName = "defaultbranches";
    ...
    public string Kind { get; set; } = "DefaultBranchList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1DefaultBranchSpecDeletionPolicyEnum>))]
public enum V1alpha1DefaultBranchSpecDeletionPolicyEnum
{
...
public partial class V1alpha1DefaultBranchSpecForProviderBranchRefPolicy
{
    ...
    public V1alpha1DefaultBranchSpecForProviderBranchRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1DefaultBranchSpecForProviderBranchRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1DefaultBranchSpecForProviderBranchRef
{
    ...
    public V1alpha1DefaultBranchSpecForProviderBranchRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1DefaultBranchSpecForProviderBranchSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1DefaultBranchSpecForProviderBranchSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1DefaultBranchSpecForProviderBranchSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1DefaultBranchSpecForProvider
{
    ...
    public V1alpha1DefaultBranchSpecForProviderBranchRef? BranchRef { get; set; }
...
public partial class V1alpha1DefaultBranchSpecInitProviderBranchRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1DefaultBranchSpecInitProviderBranchRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1DefaultBranchSpecInitProviderBranchRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1DefaultBranchSpecInitProviderBranchRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1DefaultBranchSpecInitProviderBranchRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1DefaultBranchSpecInitProviderBranchSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1DefaultBranchSpecInitProviderBranchSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1DefaultBranchSpecInitProviderBranchSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1DefaultBranchSpecInitProviderBranchSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1DefaultBranchSpecInitProviderBranchSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1DefaultBranchSpecInitProvider
{
    ...
    /// <summary>Reference to a Branch in repo to populate branch.</summary>
    [JsonPropertyName("branchRef")]
    public V1alpha1DefaultBranchSpecInitProviderBranchRef? BranchRef { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1DefaultBranchSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1alpha1DefaultBranchSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1DefaultBranchSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1alpha1DefaultBranchSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1alpha1DefaultBranchSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1DefaultBranchSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1DefaultBranchSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1DefaultBranchSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1DefaultBranchSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1DefaultBranchSpec
{
    ...
    public V1alpha1DefaultBranchSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1DefaultBranchSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1DefaultBranchSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1DefaultBranchSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1DefaultBranchSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1DefaultBranchStatus
{
    ...
    public V1alpha1DefaultBranchStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1DefaultBranchStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "DefaultBranch";
    public const string KubeGroup = "repo.github.upbound.io";
    public const string KubePluralName = "defaultbranches";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DefaultBranch";
    ...
    public required V1alpha1DefaultBranchSpec Spec { get; set; }

    /// <summary>DefaultBranchStatus defines the observed state of DefaultBranch.</summary>
    [JsonPropertyName("status")]
    public V1alpha1DefaultBranchStatus? Status { get; set; }
}