...
public partial class V1alpha1OrganizationActionsSecretSpecProviderConfigRefPolicy
{
    ...
    public V1alpha1OrganizationActionsSecretSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1OrganizationActionsSecretSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1OrganizationActionsSecretSpecProviderConfigRef
{
    ...
    public V1alpha1OrganizationActionsSecretSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1OrganizationActionsSecretSpec
{
    ...
    public V1alpha1OrganizationActionsSecretSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
