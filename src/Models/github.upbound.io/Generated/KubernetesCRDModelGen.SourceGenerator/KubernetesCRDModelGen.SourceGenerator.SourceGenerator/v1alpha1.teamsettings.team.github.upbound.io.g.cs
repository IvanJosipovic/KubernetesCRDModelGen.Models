...
public partial class V1alpha1TeamSettingsList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1TeamSettings>
{
    ...
    public const string KubeKind = "TeamSettingsList";
    public const string KubeGroup = "team.github.upbound.io";
    public const string KubePluralName = "teamsettings";
    ...
    public string Kind { get; set; } = "TeamSettingsList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1TeamSettingsSpecDeletionPolicyEnum>))]
public enum V1alpha1TeamSettingsSpecDeletionPolicyEnum
{
...
public partial class V1alpha1TeamSettingsSpecForProviderTeamIdRefPolicy
{
    ...
    public V1alpha1TeamSettingsSpecForProviderTeamIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1TeamSettingsSpecForProviderTeamIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1TeamSettingsSpecForProviderTeamIdRef
{
    ...
    public V1alpha1TeamSettingsSpecForProviderTeamIdRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1TeamSettingsSpecForProviderTeamIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1TeamSettingsSpecForProviderTeamIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1TeamSettingsSpecForProviderTeamIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1TeamSettingsSpecForProvider
{
    ...
    /// </summary>
    [JsonPropertyName("reviewRequestDelegation")]
    public IList<V1alpha1TeamSettingsSpecForProviderReviewRequestDelegation>? ReviewRequestDelegation { get; set; }
    ...
    public V1alpha1TeamSettingsSpecForProviderTeamIdRef? TeamIdRef { get; set; }
...
public partial class V1alpha1TeamSettingsSpecInitProviderTeamIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1TeamSettingsSpecInitProviderTeamIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1TeamSettingsSpecInitProviderTeamIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1TeamSettingsSpecInitProviderTeamIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1TeamSettingsSpecInitProviderTeamIdRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1TeamSettingsSpecInitProviderTeamIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1TeamSettingsSpecInitProviderTeamIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1TeamSettingsSpecInitProviderTeamIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1TeamSettingsSpecInitProviderTeamIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1TeamSettingsSpecInitProviderTeamIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1TeamSettingsSpecInitProvider
{
    ...
    /// </summary>
    [JsonPropertyName("reviewRequestDelegation")]
    public IList<V1alpha1TeamSettingsSpecInitProviderReviewRequestDelegation>? ReviewRequestDelegation { get; set; }
    ...
    /// <summary>Reference to a Team in team to populate teamId.</summary>
    [JsonPropertyName("teamIdRef")]
    public V1alpha1TeamSettingsSpecInitProviderTeamIdRef? TeamIdRef { get; set; }

    /// <summary>Selector for a Team in team to populate teamId.</summary>
    [JsonPropertyName("teamIdSelector")]
    public V1alpha1TeamSettingsSpecInitProviderTeamIdSelector? TeamIdSelector { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1TeamSettingsSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1alpha1TeamSettingsSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[JsonConverter(typeof(JsonStringEnumConverter<V1alpha1TeamSettingsSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1alpha1TeamSettingsSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.10+a22b941414add0bcc94c90de54d985f643c33be0")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1alpha1TeamSettingsSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1TeamSettingsSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1TeamSettingsSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1TeamSettingsSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1TeamSettingsSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1TeamSettingsSpec
{
    ...
    public V1alpha1TeamSettingsSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1TeamSettingsSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1TeamSettingsSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1TeamSettingsSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1TeamSettingsSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1TeamSettingsStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("reviewRequestDelegation")]
    public IList<V1alpha1TeamSettingsStatusAtProviderReviewRequestDelegation>? ReviewRequestDelegation { get; set; }
...
public partial class V1alpha1TeamSettingsStatus
{
    ...
    public V1alpha1TeamSettingsStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1TeamSettingsStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "TeamSettings";
    public const string KubeGroup = "team.github.upbound.io";
    public const string KubePluralName = "teamsettings";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TeamSettings";
    ...
    public required V1alpha1TeamSettingsSpec Spec { get; set; }

    /// <summary>TeamSettingsStatus defines the observed state of TeamSettings.</summary>
    [JsonPropertyName("status")]
    public V1alpha1TeamSettingsStatus? Status { get; set; }
}