...
public partial class V1alpha1RepositoryWebhookList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1RepositoryWebhook>
{
    ...
    public const string KubeKind = "RepositoryWebhookList";
    public const string KubeGroup = "repo.github.upbound.io";
    public const string KubePluralName = "repositorywebhooks";
    ...
    public string Kind { get; set; } = "RepositoryWebhookList";
...
public partial class V1alpha1RepositoryWebhookSpecForProviderConfiguration
{
    ...
    public V1alpha1RepositoryWebhookSpecForProviderConfigurationSecretSecretRef? SecretSecretRef { get; set; }
    ...
    public V1alpha1RepositoryWebhookSpecForProviderConfigurationUrlSecretRef? UrlSecretRef { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecForProviderRepositoryRefPolicy
{
    ...
    public V1alpha1RepositoryWebhookSpecForProviderRepositoryRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1alpha1RepositoryWebhookSpecForProviderRepositoryRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecForProviderRepositoryRef
{
    ...
    public V1alpha1RepositoryWebhookSpecForProviderRepositoryRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecForProviderRepositorySelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RepositoryWebhookSpecForProviderRepositorySelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RepositoryWebhookSpecForProviderRepositorySelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecForProvider
{
    ...
    public V1alpha1RepositoryWebhookSpecForProviderRepositoryRef? RepositoryRef { get; set; }

    /// <summary>Selector for a Repository to populate repository.</summary>
    [JsonPropertyName("repositorySelector")]
    public V1alpha1RepositoryWebhookSpecForProviderRepositorySelector? RepositorySelector { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecInitProviderConfiguration
{
    ...
    /// </summary>
    [JsonPropertyName("secretSecretRef")]
    public V1alpha1RepositoryWebhookSpecInitProviderConfigurationSecretSecretRef? SecretSecretRef { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("urlSecretRef")]
    public required V1alpha1RepositoryWebhookSpecInitProviderConfigurationUrlSecretRef UrlSecretRef { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecInitProviderRepositoryRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RepositoryWebhookSpecInitProviderRepositoryRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RepositoryWebhookSpecInitProviderRepositoryRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecInitProviderRepositoryRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1RepositoryWebhookSpecInitProviderRepositoryRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecInitProviderRepositorySelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RepositoryWebhookSpecInitProviderRepositorySelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RepositoryWebhookSpecInitProviderRepositorySelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecInitProviderRepositorySelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1RepositoryWebhookSpecInitProviderRepositorySelectorPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecInitProvider
{
    ...
    /// <summary>Reference to a Repository to populate repository.</summary>
    [JsonPropertyName("repositoryRef")]
    public V1alpha1RepositoryWebhookSpecInitProviderRepositoryRef? RepositoryRef { get; set; }

    /// <summary>Selector for a Repository to populate repository.</summary>
    [JsonPropertyName("repositorySelector")]
    public V1alpha1RepositoryWebhookSpecInitProviderRepositorySelector? RepositorySelector { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1alpha1RepositoryWebhookSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1alpha1RepositoryWebhookSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1alpha1RepositoryWebhookSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1alpha1RepositoryWebhookSpec
{
    ...
    public V1alpha1RepositoryWebhookSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1alpha1RepositoryWebhookSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1RepositoryWebhookSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1alpha1RepositoryWebhookSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1alpha1RepositoryWebhookSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1alpha1RepositoryWebhookStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("configuration")]
    public IList<V1alpha1RepositoryWebhookStatusAtProviderConfiguration>? Configuration { get; set; }
...
public partial class V1alpha1RepositoryWebhookStatus
{
    ...
    public V1alpha1RepositoryWebhookStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1alpha1RepositoryWebhookStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "RepositoryWebhook";
    public const string KubeGroup = "repo.github.upbound.io";
    public const string KubePluralName = "repositorywebhooks";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "RepositoryWebhook";
    ...
    public required V1alpha1RepositoryWebhookSpec Spec { get; set; }

    /// <summary>RepositoryWebhookStatus defines the observed state of RepositoryWebhook.</summary>
    [JsonPropertyName("status")]
    public V1alpha1RepositoryWebhookStatus? Status { get; set; }
}