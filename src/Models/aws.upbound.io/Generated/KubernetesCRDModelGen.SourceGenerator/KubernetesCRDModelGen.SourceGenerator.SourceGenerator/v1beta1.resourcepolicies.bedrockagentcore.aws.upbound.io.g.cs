...
/// <summary>ResourcePolicy is the Schema for the ResourcePolicys API. Manages an AWS Bedrock AgentCore Resource Policy.</summary>
...
{
    /// <summary>Resource policy definition</summary>
