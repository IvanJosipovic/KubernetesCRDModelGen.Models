...
public partial class V1OrderList : IKubernetesObject<V1ListMeta>, IItems<V1Order>
{
    ...
    public string Kind { get; set; } = "OrderList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1Order objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1Order> Items { get; set; }
}
...
public partial class V1OrderSpec
{
    ...
    public required V1OrderSpecIssuerRef IssuerRef { get; set; }
...
public partial class V1Order : IKubernetesObject<V1ObjectMeta>, ISpec<V1OrderSpec>, IStatus<V1OrderStatus?>
{
    ...
    public required V1OrderSpec Spec { get; set; }
